...
main(void) {
  ...
  15:	83 ec 28             	sub    $0x28,%esp
    ...
    pid = fork();
  18:	e8 8e 03 00 00       	call   3ab <fork>
    if (pid == 0) {
  1d:	c7 45 d0 30 00 00 00 	movl   $0x30,-0x30(%ebp)
  24:	85 c0                	test   %eax,%eax
  26:	0f 84 a0 00 00 00    	je     cc <main+0xcc>
                }
            }
        }
    }
  ...
  2c:	c7 45 d4 00 00 00 00 	movl   $0x0,-0x2c(%ebp)
        for (int j = 0; j < 10000000; j++) {
            ...
            if (j % 10000 == 0) {
                aux1 /= aux2;
                aux2 %= 25;
  33:	bf 1f 85 eb 51       	mov    $0x51eb851f,%edi
        for (int j = 0; j < 10000000; j++) {
  ...
  3f:	90                   	nop
            aux2 += 1;
  40:	69 c1 91 7e fb 3a    	imul   $0x3afb7e91,%ecx,%eax
            aux1 += 1;
  46:	83 c6 01             	add    $0x1,%esi
            aux2 += 1;
  49:	83 c3 01             	add    $0x1,%ebx
  4c:	c1 c8 04             	ror    $0x4,%eax
            if (j % 10000 == 0) {
  4f:	3d b8 8d 06 00       	cmp    $0x68db8,%eax
  54:	77 16                	ja     6c <main+0x6c>
                aux1 /= aux2;
  ...
  5f:	f7 e7                	mul    %edi
  61:	c1 ea 03             	shr    $0x3,%edx
  64:	8d 04 92             	lea    (%edx,%edx,4),%eax
  67:	8d 04 80             	lea    (%eax,%eax,4),%eax
  6a:	29 c3                	sub    %eax,%ebx
        for (int j = 0; j < 10000000; j++) {
  6c:	83 c1 01             	add    $0x1,%ecx
  6f:	81 f9 80 96 98 00    	cmp    $0x989680,%ecx
  ...
  7d:	68 98 08 00 00       	push   $0x898
  82:	6a 00                	push   $0x0
  84:	e8 a7 04 00 00       	call   530 <printf>
    for (int i = 0; i < 100; i++) {
  89:	83 45 d4 01          	addl   $0x1,-0x2c(%ebp)
  8d:	8b 45 d4             	mov    -0x2c(%ebp),%eax
  90:	83 c4 10             	add    $0x10,%esp
  93:	83 f8 64             	cmp    $0x64,%eax
  96:	75 a0                	jne    38 <main+0x38>
    }

    if (aux2 > aux1) {
  98:	39 de                	cmp    %ebx,%esi
  9a:	7c 2b                	jl     c7 <main+0xc7>
        exit();
    }
    wait2(&retime, &rutime, &stime);
  9c:	50                   	push   %eax
  9d:	8d 45 e4             	lea    -0x1c(%ebp),%eax
  a0:	50                   	push   %eax
  a1:	8d 45 e0             	lea    -0x20(%ebp),%eax
  a4:	50                   	push   %eax
  a5:	8d 45 dc             	lea    -0x24(%ebp),%eax
  a8:	50                   	push   %eax
  a9:	e8 bd 03 00 00       	call   46b <wait2>
    printf(0, "\n%d, %d, %d\n", retime, rutime, stime);
  ae:	5a                   	pop    %edx
  af:	ff 75 e4             	pushl  -0x1c(%ebp)
  b2:	ff 75 e0             	pushl  -0x20(%ebp)
  b5:	ff 75 dc             	pushl  -0x24(%ebp)
  b8:	68 9c 08 00 00       	push   $0x89c
  bd:	6a 00                	push   $0x0
  bf:	e8 6c 04 00 00       	call   530 <printf>
    exit();
  c4:	83 c4 20             	add    $0x20,%esp
  c7:	e8 e7 02 00 00       	call   3b3 <exit>
        set_tickets(1);
  cc:	83 ec 0c             	sub    $0xc,%esp
  cf:	6a 01                	push   $0x1
  d1:	e8 8d 03 00 00       	call   463 <set_tickets>
        pid = fork();
  d6:	e8 d0 02 00 00       	call   3ab <fork>
        if (pid == 0) {
  db:	c7 45 d0 31 00 00 00 	movl   $0x31,-0x30(%ebp)
  e2:	83 c4 10             	add    $0x10,%esp
  e5:	85 c0                	test   %eax,%eax
  e7:	0f 85 3f ff ff ff    	jne    2c <main+0x2c>
            set_tickets(100);
  ed:	83 ec 0c             	sub    $0xc,%esp
  f0:	6a 64                	push   $0x64
  f2:	e8 6c 03 00 00       	call   463 <set_tickets>
            pid = fork();
  f7:	e8 af 02 00 00       	call   3ab <fork>
            if (pid == 0) {
  fc:	c7 45 d0 32 00 00 00 	movl   $0x32,-0x30(%ebp)
 103:	83 c4 10             	add    $0x10,%esp
 106:	85 c0                	test   %eax,%eax
 108:	0f 85 1e ff ff ff    	jne    2c <main+0x2c>
                set_tickets(1);
 10e:	83 ec 0c             	sub    $0xc,%esp
 111:	6a 01                	push   $0x1
 113:	e8 4b 03 00 00       	call   463 <set_tickets>
                pid = fork();
 118:	e8 8e 02 00 00       	call   3ab <fork>
                if (pid == 0) {
 11d:	c7 45 d0 33 00 00 00 	movl   $0x33,-0x30(%ebp)
 124:	83 c4 10             	add    $0x10,%esp
 127:	85 c0                	test   %eax,%eax
 129:	0f 85 fd fe ff ff    	jne    2c <main+0x2c>
                    set_tickets(1);
 12f:	83 ec 0c             	sub    $0xc,%esp
 132:	6a 01                	push   $0x1
 134:	e8 2a 03 00 00       	call   463 <set_tickets>
 139:	c7 45 d0 34 00 00 00 	movl   $0x34,-0x30(%ebp)
 140:	83 c4 10             	add    $0x10,%esp
 143:	e9 e4 fe ff ff       	jmp    2c <main+0x2c>
 ...
 48c:	89 d1                	mov    %edx,%ecx
{
 ...
 4b9:	0f b6 92 b0 08 00 00 	movzbl 0x8b0(%edx),%edx
...
free(void *ap)
{
 ...
 705:	a1 64 0b 00 00       	mov    0xb64,%eax
{
 ...
 726:	73 10                	jae    738 <free+0x38>
{
 ...
 751:	5b                   	pop    %ebx
  freep = p;
 752:	a3 64 0b 00 00       	mov    %eax,0xb64
}
 757:	5e                   	pop    %esi
 758:	5f                   	pop    %edi
 759:	5d                   	pop    %ebp
...
malloc(uint nbytes)
{
 ...
 79d:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 7a0:	8b 3d 64 0b 00 00    	mov    0xb64,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7e9:	8b 3d 64 0b 00 00    	mov    0xb64,%edi
 ...
 812:	e8 e9 fe ff ff       	call   700 <free>
  return freep;
 817:	a1 64 0b 00 00       	mov    0xb64,%eax
 ...
 844:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 847:	a3 64 0b 00 00       	mov    %eax,0xb64
}
 ...
 85e:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 860:	c7 05 64 0b 00 00 68 	movl   $0xb68,0xb64
 867:	0b 00 00 
    base.s.size = 0;
 86a:	bf 68 0b 00 00       	mov    $0xb68,%edi
    base.s.ptr = freep = prevp = &base;
 86f:	c7 05 68 0b 00 00 68 	movl   $0xb68,0xb68
 876:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 879:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 87b:	c7 05 6c 0b 00 00 00 	movl   $0x0,0xb6c
 882:	00 00 00 
    if(p->s.size >= nunits){
