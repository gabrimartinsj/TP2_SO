...
main(void) {
  ...
  11:	83 ec 28             	sub    $0x28,%esp
    ...
    pid = fork();
  14:	e8 81 03 00 00       	call   39a <fork>
    if (pid == 0) {
  19:	85 c0                	test   %eax,%eax
  1b:	c7 45 d0 30 00 00 00 	movl   $0x30,-0x30(%ebp)
  22:	0f 84 b8 00 00 00    	je     e0 <main+0xe0>
                }
            }
        }
    }
    ...
    for (int i = 0; i < 100; i++) {
  28:	c7 45 d4 00 00 00 00 	movl   $0x0,-0x2c(%ebp)
        aux1 = i;
        aux2 = i;
        for (int j = 0; j < 10000000; j++) {
            ...
            aux2 += 1;
            if (j % 10000 == 0) {
  2f:	bf ad 8b db 68       	mov    $0x68db8bad,%edi
  ...
  4c:	c1 f8 1f             	sar    $0x1f,%eax
  4f:	c1 fa 0c             	sar    $0xc,%edx
  52:	29 c2                	sub    %eax,%edx
  54:	69 d2 10 27 00 00    	imul   $0x2710,%edx,%edx
  5a:	39 d1                	cmp    %edx,%ecx
  5c:	75 20                	jne    7e <main+0x7e>
                aux1 /= aux2;
  ...
  63:	89 c6                	mov    %eax,%esi
                aux2 %= 25;
  65:	b8 1f 85 eb 51       	mov    $0x51eb851f,%eax
  6a:	f7 eb                	imul   %ebx
  6c:	89 d8                	mov    %ebx,%eax
  6e:	c1 f8 1f             	sar    $0x1f,%eax
  71:	c1 fa 03             	sar    $0x3,%edx
  74:	29 c2                	sub    %eax,%edx
  76:	8d 04 92             	lea    (%edx,%edx,4),%eax
  79:	8d 04 80             	lea    (%eax,%eax,4),%eax
  ...
  81:	81 f9 80 96 98 00    	cmp    $0x989680,%ecx
  ...
  8c:	ff 75 d0             	pushl  -0x30(%ebp)
  8f:	68 40 08 00 00       	push   $0x840
  94:	6a 00                	push   $0x0
  96:	e8 85 04 00 00       	call   520 <printf>
                }
            }
        }
    }
    ...
    for (int i = 0; i < 100; i++) {
  9b:	83 45 d4 01          	addl   $0x1,-0x2c(%ebp)
  9f:	83 c4 10             	add    $0x10,%esp
  a2:	8b 45 d4             	mov    -0x2c(%ebp),%eax
  a5:	83 f8 64             	cmp    $0x64,%eax
  a8:	75 8e                	jne    38 <main+0x38>
            }
        }
        printf(0, "%c ", c);
    }
    ...
    if (aux2 > aux1) {
  aa:	39 de                	cmp    %ebx,%esi
  ac:	7c 2d                	jl     db <main+0xdb>
        exit();
    }
    wait2(&retime, &rutime, &stime);
  ae:	8d 45 e4             	lea    -0x1c(%ebp),%eax
  b1:	83 ec 04             	sub    $0x4,%esp
  b4:	50                   	push   %eax
  b5:	8d 45 e0             	lea    -0x20(%ebp),%eax
  b8:	50                   	push   %eax
  b9:	8d 45 dc             	lea    -0x24(%ebp),%eax
  bc:	50                   	push   %eax
  bd:	e8 a0 03 00 00       	call   462 <wait2>
    printf(0, "\n%d, %d, %d\n", retime, rutime, stime);
  c2:	58                   	pop    %eax
  c3:	ff 75 e4             	pushl  -0x1c(%ebp)
  c6:	ff 75 e0             	pushl  -0x20(%ebp)
  c9:	ff 75 dc             	pushl  -0x24(%ebp)
  cc:	68 44 08 00 00       	push   $0x844
  d1:	6a 00                	push   $0x0
  d3:	e8 48 04 00 00       	call   520 <printf>
    exit();
  d8:	83 c4 20             	add    $0x20,%esp
  db:	e8 c2 02 00 00       	call   3a2 <exit>
    int pid;
    int retime, rutime, stime;
  ...
  e3:	6a 01                	push   $0x1
  e5:	e8 68 03 00 00       	call   452 <set_tickets>
        c = '1';
        pid = fork();
  ea:	e8 ab 02 00 00       	call   39a <fork>
        if (pid == 0) {
  ef:	83 c4 10             	add    $0x10,%esp
  f2:	85 c0                	test   %eax,%eax
  f4:	c7 45 d0 31 00 00 00 	movl   $0x31,-0x30(%ebp)
  fb:	0f 85 27 ff ff ff    	jne    28 <main+0x28>
            set_tickets(100);
 101:	83 ec 0c             	sub    $0xc,%esp
 104:	6a 64                	push   $0x64
 106:	e8 47 03 00 00       	call   452 <set_tickets>
            c = '2';
            pid = fork();
 10b:	e8 8a 02 00 00       	call   39a <fork>
            if (pid == 0) {
 110:	83 c4 10             	add    $0x10,%esp
 113:	85 c0                	test   %eax,%eax
 115:	c7 45 d0 32 00 00 00 	movl   $0x32,-0x30(%ebp)
 11c:	0f 85 06 ff ff ff    	jne    28 <main+0x28>
                set_tickets(1);
 122:	83 ec 0c             	sub    $0xc,%esp
 125:	6a 01                	push   $0x1
 127:	e8 26 03 00 00       	call   452 <set_tickets>
                c = '3';
                pid = fork();
 12c:	e8 69 02 00 00       	call   39a <fork>
                if (pid == 0) {
 131:	83 c4 10             	add    $0x10,%esp
 134:	85 c0                	test   %eax,%eax
 136:	c7 45 d0 33 00 00 00 	movl   $0x33,-0x30(%ebp)
 13d:	0f 85 e5 fe ff ff    	jne    28 <main+0x28>
                    set_tickets(1);
 143:	83 ec 0c             	sub    $0xc,%esp
 146:	6a 01                	push   $0x1
 148:	e8 05 03 00 00       	call   452 <set_tickets>
 14d:	83 c4 10             	add    $0x10,%esp
 150:	c7 45 d0 34 00 00 00 	movl   $0x34,-0x30(%ebp)
 157:	e9 cc fe ff ff       	jmp    28 <main+0x28>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 4bf:	f7 f6                	div    %esi
 4c1:	0f b6 92 58 08 00 00 	movzbl 0x858(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 638:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 63b:	b8 51 08 00 00       	mov    $0x851,%eax
...
free(void *ap)
{
 ...
 6c1:	a1 fc 0a 00 00       	mov    0xafc,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 717:	89 08                	mov    %ecx,(%eax)
  freep = p;
 719:	a3 fc 0a 00 00       	mov    %eax,0xafc
}
 71e:	5b                   	pop    %ebx
 71f:	5e                   	pop    %esi
 720:	5f                   	pop    %edi
 ...
 73a:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 73d:	a3 fc 0a 00 00       	mov    %eax,0xafc
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 759:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 75c:	8b 15 fc 0a 00 00    	mov    0xafc,%edx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
 ...
 7af:	76 3f                	jbe    7f0 <malloc+0xa0>
    ...
    if(p == freep)
 7b1:	39 05 fc 0a 00 00    	cmp    %eax,0xafc
 ...
 7d6:	e8 e5 fe ff ff       	call   6c0 <free>
  return freep;
 7db:	8b 15 fc 0a 00 00    	mov    0xafc,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 7fc:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
 7ff:	89 15 fc 0a 00 00    	mov    %edx,0xafc
      return (void*)(p + 1);
 ...
 814:	eb e9                	jmp    7ff <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 816:	c7 05 fc 0a 00 00 00 	movl   $0xb00,0xafc
 81d:	0b 00 00 
 820:	c7 05 00 0b 00 00 00 	movl   $0xb00,0xb00
 827:	0b 00 00 
    base.s.size = 0;
 82a:	b8 00 0b 00 00       	mov    $0xb00,%eax
 82f:	c7 05 04 0b 00 00 00 	movl   $0x0,0xb04
 836:	00 00 00 
