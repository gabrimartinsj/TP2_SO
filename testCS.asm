...
int main (void){
  ...
  15:	83 ec 08             	sub    $0x8,%esp
    ...
    int cs1, cs2, cs3, cs4;
    cs1 = cs();
  18:	e8 5e 03 00 00       	call   37b <cs>
  1d:	89 c3                	mov    %eax,%ebx
    cs2 = cs();
  1f:	e8 57 03 00 00       	call   37b <cs>
    sleep(4);
  ...
  29:	89 c6                	mov    %eax,%esi
    sleep(4);
  2b:	e8 33 03 00 00       	call   363 <sleep>
    cs3 = cs();
  30:	e8 46 03 00 00       	call   37b <cs>
    sleep(6);
  35:	c7 04 24 06 00 00 00 	movl   $0x6,(%esp)
    cs3 = cs();
  3c:	89 c7                	mov    %eax,%edi
    sleep(6);
  3e:	e8 20 03 00 00       	call   363 <sleep>
    cs4 = cs();
  43:	e8 33 03 00 00       	call   37b <cs>
...
printf(int fd, const char *fmt, ...)
{
 ...
 5d4:	eb 1a                	jmp    5f0 <printf+0x1a0>
          s = "(null)";
 5d6:	bb e0 07 00 00       	mov    $0x7e0,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 625:	a1 9c 0a 00 00       	mov    0xa9c,%eax
{
...
malloc(uint nbytes)
{
 ...
 6bd:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6c0:	8b 3d 9c 0a 00 00    	mov    0xa9c,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 764:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 767:	a3 9c 0a 00 00       	mov    %eax,0xa9c
}
