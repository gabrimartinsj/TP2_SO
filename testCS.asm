...
_testCS:     file format elf32-i386
...
int main (void){
  ...
  11:	83 ec 08             	sub    $0x8,%esp
    ...
    int cs1, cs2, cs3, cs4;
    cs1 = cs();
  14:	e8 31 03 00 00       	call   34a <cs>
  19:	89 c3                	mov    %eax,%ebx
    cs2 = cs();
  1b:	e8 2a 03 00 00       	call   34a <cs>
    sleep(4);
...
int main (void){
  ...
  23:	89 c6                	mov    %eax,%esi
    sleep(4);
  25:	6a 04                	push   $0x4
  27:	e8 06 03 00 00       	call   332 <sleep>
    cs3 = cs();
  2c:	e8 19 03 00 00       	call   34a <cs>
    sleep(6);
  31:	c7 04 24 06 00 00 00 	movl   $0x6,(%esp)
  ...
  48:	56                   	push   %esi
  49:	53                   	push   %ebx
  4a:	68 20 07 00 00       	push   $0x720
  4f:	6a 01                	push   $0x1
  51:	e8 aa 03 00 00       	call   400 <printf>

    exit();
  56:	83 c4 20             	add    $0x20,%esp
  59:	e8 44 02 00 00       	call   2a2 <exit>
  5e:	66 90                	xchg   %ax,%ax
...
putc(int fd, char c)
{
 ...
 518:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 51b:	b8 48 07 00 00       	mov    $0x748,%eax
...
free(void *ap)
{
 ...
 5f7:	89 08                	mov    %ecx,(%eax)
  freep = p;
 5f9:	a3 f4 09 00 00       	mov    %eax,0x9f4
}
 5fe:	5b                   	pop    %ebx
 5ff:	5e                   	pop    %esi
 600:	5f                   	pop    %edi
 ...
 61a:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 61d:	a3 f4 09 00 00       	mov    %eax,0x9f4
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 6dc:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
 6df:	89 15 f4 09 00 00    	mov    %edx,0x9f4
      return (void*)(p + 1);
 ...
 6f4:	eb e9                	jmp    6df <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 6f6:	c7 05 f4 09 00 00 f8 	movl   $0x9f8,0x9f4
 6fd:	09 00 00 
 700:	c7 05 f8 09 00 00 f8 	movl   $0x9f8,0x9f8
 707:	09 00 00 
    base.s.size = 0;
 70a:	b8 f8 09 00 00       	mov    $0x9f8,%eax
 70f:	c7 05 fc 09 00 00 00 	movl   $0x0,0x9fc
 716:	00 00 00 
