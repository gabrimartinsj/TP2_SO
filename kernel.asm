...
80100050:	68 80 76 10 80       	push   $0x80107680
80100055:	68 20 d0 10 80       	push   $0x8010d020
8010005a:	e8 f1 47 00 00       	call   80104850 <initlock>
  bcache.head.next = &bcache.head;
...
801000e8:	e8 e3 48 00 00       	call   801049d0 <acquire>
...
801001a3:	68 8e 76 10 80       	push   $0x8010768e
...
801001c2:	e8 29 46 00 00       	call   801047f0 <holdingsleep>
...
801001e0:	68 9f 76 10 80       	push   $0x8010769f
...
80100203:	e8 e8 45 00 00       	call   801047f0 <holdingsleep>
...
80100213:	e8 98 45 00 00       	call   801047b0 <releasesleep>

  acquire(&bcache.lock);
80100218:	c7 04 24 20 d0 10 80 	movl   $0x8010d020,(%esp)
8010021f:	e8 ac 47 00 00       	call   801049d0 <acquire>
  b->refcnt--;
...
8010026f:	5d                   	pop    %ebp
  release(&bcache.lock);
80100270:	e9 1b 48 00 00       	jmp    80104a90 <release>
    panic("brelse");
80100275:	83 ec 0c             	sub    $0xc,%esp
80100278:	68 a6 76 10 80       	push   $0x801076a6
...
801002b1:	e8 1a 47 00 00       	call   801049d0 <acquire>
...
8010030e:	e8 7d 47 00 00       	call   80104a90 <release>
        ilock(ip);
80100313:	5a                   	pop    %edx
...
80100365:	e8 26 47 00 00       	call   80104a90 <release>
  ilock(ip);
8010036a:	58                   	pop    %eax
...
801003b6:	68 ad 76 10 80       	push   $0x801076ad
...
801003dc:	e8 8f 44 00 00       	call   80104870 <getcallerpcs>
  for(i=0; i<10; i++)
...
801003ec:	68 c1 76 10 80       	push   $0x801076c1
...
8010042a:	e8 41 5e 00 00       	call   80106270 <uartputc>
...
80100515:	e8 56 5d 00 00       	call   80106270 <uartputc>
8010051a:	c7 04 24 20 00 00 00 	movl   $0x20,(%esp)
80100521:	e8 4a 5d 00 00       	call   80106270 <uartputc>
80100526:	c7 04 24 08 00 00 00 	movl   $0x8,(%esp)
8010052d:	e8 3e 5d 00 00       	call   80106270 <uartputc>
...
80100561:	e8 1a 46 00 00       	call   80104b80 <memmove>
    memset(crt+pos, 0, sizeof(crt[0])*(24*80 - pos));
...
80100576:	e8 65 45 00 00       	call   80104ae0 <memset>
8010057b:	88 5d e7             	mov    %bl,-0x19(%ebp)
8010057e:	83 c4 10             	add    $0x10,%esp
80100581:	e9 22 ff ff ff       	jmp    801004a8 <consputc.part.0+0x98>
    panic("pos under/overflow");
80100586:	83 ec 0c             	sub    $0xc,%esp
80100589:	68 c5 76 10 80       	push   $0x801076c5
...
801005c9:	0f b6 92 f0 76 10 80 	movzbl -0x7fef8910(%edx),%edx
...
8010065f:	e8 6c 43 00 00       	call   801049d0 <acquire>
  for(i = 0; i < n; i++)
...
80100697:	e8 f4 43 00 00       	call   80104a90 <release>
  ilock(ip);
8010069c:	58                   	pop    %eax
...
8010077b:	75 55                	jne    801007d2 <cprintf+0x122>
        s = "(null)";
8010077d:	bb d8 76 10 80       	mov    $0x801076d8,%ebx
      for(; *s; s++)
...
801007bd:	e8 0e 42 00 00       	call   801049d0 <acquire>
...
80100828:	e8 63 42 00 00       	call   80104a90 <release>
8010082d:	83 c4 10             	add    $0x10,%esp
}
80100830:	e9 ee fe ff ff       	jmp    80100723 <cprintf+0x73>
    panic("null fmt");
80100835:	83 ec 0c             	sub    $0xc,%esp
80100838:	68 df 76 10 80       	push   $0x801076df
...
80100877:	e8 54 41 00 00       	call   801049d0 <acquire>
  while((c = getc()) >= 0){
...
801009cf:	e8 bc 40 00 00       	call   80104a90 <release>
  if(doprocdump) {
...
801009ff:	e9 5c 3a 00 00       	jmp    80104460 <procdump>
...
80100a20:	e8 3b 39 00 00       	call   80104360 <wakeup>
...
80100a3a:	68 e8 76 10 80       	push   $0x801076e8
80100a3f:	68 a0 b5 10 80       	push   $0x8010b5a0
80100a44:	e8 07 3e 00 00       	call   80104850 <initlock>
...
80100b0a:	75 ce                	jne    80100ada <exec+0x5a>
  if((pgdir = setupkvm()) == 0)
80100b0c:	e8 cf 68 00 00       	call   801073e0 <setupkvm>
...
80100b73:	e8 88 66 00 00       	call   80107200 <allocuvm>
...
80100ba9:	e8 82 65 00 00       	call   80107130 <loaduvm>
...
80100beb:	e8 70 67 00 00       	call   80107360 <freevm>
  if(ip){
...
80100c32:	e8 c9 65 00 00       	call   80107200 <allocuvm>
...
80100c51:	31 ff                	xor    %edi,%edi
  clearpteu(pgdir, (char*)(sz - 2*PGSIZE));
80100c53:	e8 28 68 00 00       	call   80107480 <clearpteu>
  for(argc = 0; argv[argc]; argc++) {
...
80100ca3:	e8 38 40 00 00       	call   80104ce0 <strlen>
...
80100cb6:	e8 25 40 00 00       	call   80104ce0 <strlen>
...
80100ce1:	e8 7a 66 00 00       	call   80107360 <freevm>
...
80100d2d:	89 8d 60 ff ff ff    	mov    %ecx,-0xa0(%ebp)
  if(copyout(pgdir, sp, ustack, (3+argc+1)*4) < 0)
80100d33:	e8 a8 68 00 00       	call   801075e0 <copyout>
...
80100d71:	e8 2a 3f 00 00       	call   80104ca0 <safestrcpy>
  curproc->pgdir = pgdir;
...
80100d9d:	e8 fe 61 00 00       	call   80106fa0 <switchuvm>
  freevm(oldpgdir);
80100da2:	89 3c 24             	mov    %edi,(%esp)
80100da5:	e8 b6 65 00 00       	call   80107360 <freevm>
  return 0;
...
80100dbc:	68 01 77 10 80       	push   $0x80107701
...
80100dea:	68 0d 77 10 80       	push   $0x8010770d
80100def:	68 20 1a 11 80       	push   $0x80111a20
80100df4:	e8 57 3a 00 00       	call   80104850 <initlock>
}
...
80100e15:	e8 b6 3b 00 00       	call   801049d0 <acquire>
...
80100e41:	e8 4a 3c 00 00       	call   80104a90 <release>
      return f;
    }
  }
  release(&ftable.lock);
...
80100e5a:	e8 31 3c 00 00       	call   80104a90 <release>
}
...
80100e83:	e8 48 3b 00 00       	call   801049d0 <acquire>
  if(f->ref < 1)
...
80100ea0:	e8 eb 3b 00 00       	call   80104a90 <release>
  return f;
}
...
80100eaf:	68 14 77 10 80       	push   $0x80107714
...
80100ed5:	e8 f6 3a 00 00       	call   801049d0 <acquire>
  if(f->ref < 1)
...
80100f0d:	89 45 e0             	mov    %eax,-0x20(%ebp)
  release(&ftable.lock);
80100f10:	e8 7b 3b 00 00       	call   80104a90 <release>
...
80100f3d:	5d                   	pop    %ebp
    release(&ftable.lock);
80100f3e:	e9 4d 3b 00 00       	jmp    80104a90 <release>
...
80100f8c:	68 1c 77 10 80       	push   $0x8010771c
...
8010107a:	68 26 77 10 80       	push   $0x80107726
...
80101163:	68 2f 77 10 80       	push   $0x8010772f
...
80101199:	68 35 77 10 80       	push   $0x80107735
...
80101217:	68 3f 77 10 80       	push   $0x8010773f
...
801012d4:	68 52 77 10 80       	push   $0x80107752
...
80101315:	e8 c6 37 00 00       	call   80104ae0 <memset>
  log_write(bp);
...
8010135a:	e8 71 36 00 00       	call   801049d0 <acquire>
  for(ip = &icache.inode[0]; ip < &icache.inode[NINODE]; ip++){
...
801013c7:	e8 c4 36 00 00       	call   80104a90 <release>
...
801013f2:	89 4b 08             	mov    %ecx,0x8(%ebx)
      release(&icache.lock);
801013f5:	e8 96 36 00 00       	call   80104a90 <release>
      return ip;
...
80101422:	68 68 77 10 80       	push   $0x80107768
...
801014eb:	68 78 77 10 80       	push   $0x80107778
...
80101525:	e8 56 36 00 00       	call   80104b80 <memmove>
  brelse(bp);
...
80101550:	68 8b 77 10 80       	push   $0x8010778b
80101555:	68 40 24 11 80       	push   $0x80112440
8010155a:	e8 f1 32 00 00       	call   80104850 <initlock>
  for(i = 0; i < NINODE; i++) {
8010155f:	83 c4 10             	add    $0x10,%esp
80101562:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    initsleeplock(&icache.inode[i].lock, "inode");
80101568:	83 ec 08             	sub    $0x8,%esp
8010156b:	68 92 77 10 80       	push   $0x80107792
80101570:	53                   	push   %ebx
80101571:	81 c3 90 00 00 00    	add    $0x90,%ebx
80101577:	e8 94 31 00 00       	call   80104710 <initsleeplock>
  for(i = 0; i < NINODE; i++) {
...
801015c1:	68 f8 77 10 80       	push   $0x801077f8
...
8010165e:	e8 7d 34 00 00       	call   80104ae0 <memset>
      dip->type = type;
...
80101693:	68 98 77 10 80       	push   $0x80107798
...
80101705:	e8 76 34 00 00       	call   80104b80 <memmove>
  log_write(bp);
...
80101743:	e8 88 32 00 00       	call   801049d0 <acquire>
  ip->ref++;
80101748:	83 43 08 01          	addl   $0x1,0x8(%ebx)
  release(&icache.lock);
8010174c:	c7 04 24 40 24 11 80 	movl   $0x80112440,(%esp)
80101753:	e8 38 33 00 00       	call   80104a90 <release>
}
...
80101786:	e8 c5 2f 00 00       	call   80104750 <acquiresleep>
  if(ip->valid == 0){
...
801017f8:	e8 83 33 00 00       	call   80104b80 <memmove>
    brelse(bp);
...
8010181d:	68 b0 77 10 80       	push   $0x801077b0
80101822:	e8 69 eb ff ff       	call   80100390 <panic>
    panic("ilock");
80101827:	83 ec 0c             	sub    $0xc,%esp
8010182a:	68 aa 77 10 80       	push   $0x801077aa
...
80101857:	e8 94 2f 00 00       	call   801047f0 <holdingsleep>
...
80101872:	5d                   	pop    %ebp
  releasesleep(&ip->lock);
80101873:	e9 38 2f 00 00       	jmp    801047b0 <releasesleep>
    panic("iunlock");
80101878:	83 ec 0c             	sub    $0xc,%esp
8010187b:	68 bf 77 10 80       	push   $0x801077bf
...
801018a4:	e8 a7 2e 00 00       	call   80104750 <acquiresleep>
...
801018be:	e8 ed 2e 00 00       	call   801047b0 <releasesleep>
  acquire(&icache.lock);
801018c3:	c7 04 24 40 24 11 80 	movl   $0x80112440,(%esp)
801018ca:	e8 01 31 00 00       	call   801049d0 <acquire>
  ip->ref--;
...
801018e3:	5d                   	pop    %ebp
  release(&icache.lock);
801018e4:	e9 a7 31 00 00       	jmp    80104a90 <release>
801018e9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    acquire(&icache.lock);
801018f0:	83 ec 0c             	sub    $0xc,%esp
801018f3:	68 40 24 11 80       	push   $0x80112440
801018f8:	e8 d3 30 00 00       	call   801049d0 <acquire>
    int r = ip->ref;
801018fd:	8b 73 08             	mov    0x8(%ebx),%esi
    release(&icache.lock);
80101900:	c7 04 24 40 24 11 80 	movl   $0x80112440,(%esp)
80101907:	e8 84 31 00 00       	call   80104a90 <release>
    if(r == 1){
...
80101b07:	e8 74 30 00 00       	call   80104b80 <memmove>
    brelse(bp);
...
80101c03:	e8 78 2f 00 00       	call   80104b80 <memmove>
    log_write(bp);
...
80101ca2:	e8 49 2f 00 00       	call   80104bf0 <strncmp>
}
80101ca7:	c9                   	leave  
80101ca8:	c3                   	ret    
...
80101d05:	e8 e6 2e 00 00       	call   80104bf0 <strncmp>
      continue;
...
80101d4a:	68 d9 77 10 80       	push   $0x801077d9
80101d4f:	e8 3c e6 ff ff       	call   80100390 <panic>
    panic("dirlookup not DIR");
80101d54:	83 ec 0c             	sub    $0xc,%esp
80101d57:	68 c7 77 10 80       	push   $0x801077c7
...
80101d9c:	e8 2f 2c 00 00       	call   801049d0 <acquire>
  ip->ref++;
80101da1:	83 46 08 01          	addl   $0x1,0x8(%esi)
  release(&icache.lock);
80101da5:	c7 04 24 40 24 11 80 	movl   $0x80112440,(%esp)
80101dac:	e8 df 2c 00 00       	call   80104a90 <release>
...
80101e17:	e8 64 2d 00 00       	call   80104b80 <memmove>
...
80101ea3:	e8 d8 2c 00 00       	call   80104b80 <memmove>
    name[len] = 0;
...
80101fd5:	e8 66 2c 00 00       	call   80104c40 <strncpy>
...
80102013:	68 e8 77 10 80       	push   $0x801077e8
80102018:	e8 73 e3 ff ff       	call   80100390 <panic>
    panic("dirlink");
8010201d:	83 ec 0c             	sub    $0xc,%esp
80102020:	68 6e 7e 10 80       	push   $0x80107e6e
...
8010212b:	68 54 78 10 80       	push   $0x80107854
80102130:	e8 5b e2 ff ff       	call   80100390 <panic>
    panic("idestart");
80102135:	83 ec 0c             	sub    $0xc,%esp
80102138:	68 4b 78 10 80       	push   $0x8010784b
...
8010215a:	68 66 78 10 80       	push   $0x80107866
8010215f:	68 00 b6 10 80       	push   $0x8010b600
80102164:	e8 e7 26 00 00       	call   80104850 <initlock>
  ioapicenable(IRQ_IDE, ncpu - 1);
80102169:	58                   	pop    %eax
8010216a:	a1 60 47 11 80       	mov    0x80114760,%eax
8010216f:	5a                   	pop    %edx
...
801021f2:	e8 d9 27 00 00       	call   801049d0 <acquire>
...
8010224d:	e8 0e 21 00 00       	call   80104360 <wakeup>
...
8010226b:	e8 20 28 00 00       	call   80104a90 <release>
...
80102292:	e8 59 25 00 00       	call   801047f0 <holdingsleep>
...
801022cc:	e8 ff 26 00 00       	call   801049d0 <acquire>
...
80102335:	c9                   	leave  
  release(&idelock);
80102336:	e9 55 27 00 00       	jmp    80104a90 <release>
...
8010235a:	68 95 78 10 80       	push   $0x80107895
8010235f:	e8 2c e0 ff ff       	call   80100390 <panic>
    panic("iderw: nothing to do");
80102364:	83 ec 0c             	sub    $0xc,%esp
80102367:	68 80 78 10 80       	push   $0x80107880
8010236c:	e8 1f e0 ff ff       	call   80100390 <panic>
    panic("iderw: buf not locked");
80102371:	83 ec 0c             	sub    $0xc,%esp
80102374:	68 6a 78 10 80       	push   $0x8010786a
...
801023ce:	68 b4 78 10 80       	push   $0x801078b4
...
80102486:	81 fb 08 76 11 80    	cmp    $0x80117608,%ebx
...
801024a6:	e8 35 26 00 00       	call   80104ae0 <memset>
...
801024e0:	e8 eb 24 00 00       	call   801049d0 <acquire>
...
801024fa:	c9                   	leave  
    release(&kmem.lock);
801024fb:	e9 90 25 00 00       	jmp    80104a90 <release>
    panic("kfree");
80102500:	83 ec 0c             	sub    $0xc,%esp
80102503:	68 e6 78 10 80       	push   $0x801078e6
...
8010256f:	68 ec 78 10 80       	push   $0x801078ec
80102574:	68 a0 40 11 80       	push   $0x801140a0
80102579:	e8 d2 22 00 00       	call   80104850 <initlock>
  p = (char*)PGROUNDUP((uint)vstart);
...
80102663:	e8 68 23 00 00       	call   801049d0 <acquire>
  r = kmem.freelist;
...
80102691:	e8 fa 23 00 00       	call   80104a90 <release>
  return (char*)r;
...
801026df:	0f b6 8a 20 7a 10 80 	movzbl -0x7fef85e0(%edx),%ecx
  shift ^= togglecode[data];
801026e6:	0f b6 82 20 79 10 80 	movzbl -0x7fef86e0(%edx),%eax
  shift |= shiftcode[data];
...
801026fc:	83 e1 08             	and    $0x8,%ecx
  c = charcode[shift & (CTL | SHIFT)][data];
801026ff:	8b 04 85 00 79 10 80 	mov    -0x7fef8700(,%eax,4),%eax
...
80102738:	31 c0                	xor    %eax,%eax
    shift &= ~(shiftcode[data] | E0ESC);
8010273a:	0f b6 8a 20 7a 10 80 	movzbl -0x7fef85e0(%edx),%ecx
...
80102abf:	e8 6c 20 00 00       	call   80104b30 <memcmp>
...
80102bf4:	e8 87 1f 00 00       	call   80104b80 <memmove>
...
80102c9e:	68 20 7b 10 80       	push   $0x80107b20
80102ca3:	68 e0 40 11 80       	push   $0x801140e0
80102ca8:	e8 a3 1b 00 00       	call   80104850 <initlock>
  readsb(dev, &sb);
80102cad:	58                   	pop    %eax
...
80102d3f:	e8 8c 1c 00 00       	call   801049d0 <acquire>
...
80102d94:	e8 f7 1c 00 00       	call   80104a90 <release>
      break;
    }
  }
}
...
80102db2:	e8 19 1c 00 00       	call   801049d0 <acquire>
  log.outstanding -= 1;
...
80102df0:	e8 9b 1c 00 00       	call   80104a90 <release>
}
...
80102e0a:	e8 c1 1b 00 00       	call   801049d0 <acquire>
    wakeup(&log);
...
80102e1d:	00 00 00 
    wakeup(&log);
80102e20:	e8 3b 15 00 00       	call   80104360 <wakeup>
    release(&log.lock);
80102e25:	c7 04 24 e0 40 11 80 	movl   $0x801140e0,(%esp)
80102e2c:	e8 5f 1c 00 00       	call   80104a90 <release>
...
80102e84:	e8 f7 1c 00 00       	call   80104b80 <memmove>
...
80102ed8:	e8 83 14 00 00       	call   80104360 <wakeup>
  release(&log.lock);
80102edd:	c7 04 24 e0 40 11 80 	movl   $0x801140e0,(%esp)
80102ee4:	e8 a7 1b 00 00       	call   80104a90 <release>
...
80102ef7:	68 24 7b 10 80       	push   $0x80107b24
...
80102f52:	e8 79 1a 00 00       	call   801049d0 <acquire>
  for (i = 0; i < log.lh.n; i++) {
...
80102f94:	c9                   	leave  
  release(&log.lock);
80102f95:	e9 f6 1a 00 00       	jmp    80104a90 <release>
...
80102fc1:	68 33 7b 10 80       	push   $0x80107b33
80102fc6:	e8 c5 d3 ff ff       	call   80100390 <panic>
    panic("log_write outside of trans");
80102fcb:	83 ec 0c             	sub    $0xc,%esp
80102fce:	68 49 7b 10 80       	push   $0x80107b49
...
80102ff8:	68 64 7b 10 80       	push   $0x80107b64
80102ffd:	e8 ae d6 ff ff       	call   801006b0 <cprintf>
  idtinit();       // load idt register
80103002:	e8 99 2e 00 00       	call   80105ea0 <idtinit>
...
80103027:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
8010302a:	e8 51 3f 00 00       	call   80106f80 <switchkvm>
  seginit();
8010302f:	e8 bc 3e 00 00       	call   80106ef0 <seginit>
  lapicinit();
...
8010305b:	68 08 76 11 80       	push   $0x80117608
80103060:	e8 fb f4 ff ff       	call   80102560 <kinit1>
  kvmalloc();      // kernel page table
80103065:	e8 f6 43 00 00       	call   80107460 <kvmalloc>
  mpinit();        // detect other processors
8010306a:	e8 81 01 00 00       	call   801031f0 <mpinit>
  lapicinit();     // interrupt controller
8010306f:	e8 2c f7 ff ff       	call   801027a0 <lapicinit>
  seginit();       // segment descriptors
80103074:	e8 77 3e 00 00       	call   80106ef0 <seginit>
  picinit();       // disable pic
...
80103088:	e8 23 31 00 00       	call   801061b0 <uartinit>
  pinit();         // process table
8010308d:	e8 2e 08 00 00       	call   801038c0 <pinit>
  tvinit();        // trap vectors
80103092:	e8 89 2d 00 00       	call   80105e20 <tvinit>
  binit();         // buffer cache
...
801030b8:	e8 c3 1a 00 00       	call   80104b80 <memmove>

  for(c = cpus; c < cpus+ncpu; c++){
801030bd:	83 c4 10             	add    $0x10,%esp
801030c0:	69 05 60 47 11 80 b0 	imul   $0xb0,0x80114760,%eax
801030c7:	00 00 00 
...
801030e0:	69 05 60 47 11 80 b0 	imul   $0xb0,0x80114760,%eax
801030e7:	00 00 00 
...
8010319e:	68 78 7b 10 80       	push   $0x80107b78
801031a3:	56                   	push   %esi
801031a4:	e8 87 19 00 00       	call   80104b30 <memcmp>
...
8010325a:	68 7d 7b 10 80       	push   $0x80107b7d
8010325f:	50                   	push   %eax
  conf = (struct mpconf*) P2V((uint) mp->physaddr);
80103260:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  if(memcmp(conf, "PCMP", 4) != 0)
80103263:	e8 c8 18 00 00       	call   80104b30 <memcmp>
...
8010335e:	66 90                	xchg   %ax,%ax
      if(ncpu < NCPU) {
80103360:	8b 0d 60 47 11 80    	mov    0x80114760,%ecx
...
80103378:	89 0d 60 47 11 80    	mov    %ecx,0x80114760
        cpus[ncpu].apicid = proc->apicid;  // apicid may differ from ncpu
...
801033c0:	68 9c 7b 10 80       	push   $0x80107b9c
...
80103464:	00 00 00 
  initlock(&p->lock, "pipe");
80103467:	68 bb 7b 10 80       	push   $0x80107bbb
8010346c:	50                   	push   %eax
8010346d:	e8 de 13 00 00       	call   80104850 <initlock>
  (*f0)->type = FD_PIPE;
...
80103513:	e8 b8 14 00 00       	call   801049d0 <acquire>
  if(writable){
...
80103533:	e8 28 0e 00 00       	call   80104360 <wakeup>
...
80103557:	5d                   	pop    %ebp
    release(&p->lock);
80103558:	e9 33 15 00 00       	jmp    80104a90 <release>
...
80103574:	e8 e7 0d 00 00       	call   80104360 <wakeup>
...
80103584:	e8 07 15 00 00       	call   80104a90 <release>
    kfree((char*)p);
...
801035b1:	e8 1a 14 00 00       	call   801049d0 <acquire>
  for(i = 0; i < n; i++){
...
80103608:	e8 53 0d 00 00       	call   80104360 <wakeup>
      sleep(&p->nwrite, &p->lock);  //DOC: pipewrite-sleep
8010360d:	58                   	pop    %eax
8010360e:	5a                   	pop    %edx
...
8010363c:	e8 4f 14 00 00       	call   80104a90 <release>
        return -1;
...
8010368a:	e8 d1 0c 00 00       	call   80104360 <wakeup>
  release(&p->lock);
8010368f:	89 1c 24             	mov    %ebx,(%esp)
80103692:	e8 f9 13 00 00       	call   80104a90 <release>
  return n;
...
801036ba:	e8 11 13 00 00       	call   801049d0 <acquire>
...
80103756:	e8 05 0c 00 00       	call   80104360 <wakeup>
  release(&p->lock);
8010375b:	89 34 24             	mov    %esi,(%esp)
8010375e:	e8 2d 13 00 00       	call   80104a90 <release>
  return i;
...
80103779:	e8 12 13 00 00       	call   80104a90 <release>
      return -1;
...
80103794:	bb b4 47 11 80       	mov    $0x801147b4,%ebx
{
80103799:	83 ec 10             	sub    $0x10,%esp
  acquire(&ptable.lock);
8010379c:	68 80 47 11 80       	push   $0x80114780
801037a1:	e8 2a 12 00 00       	call   801049d0 <acquire>
...
801037b6:	81 fb b4 6d 11 80    	cmp    $0x80116db4,%ebx
...
801037e5:	8d 50 01             	lea    0x1(%eax),%edx
  release(&ptable.lock);
801037e8:	68 80 47 11 80       	push   $0x80114780
  p->pid = nextpid++;
801037ed:	89 15 04 b0 10 80    	mov    %edx,0x8010b004
  release(&ptable.lock);
801037f3:	e8 98 12 00 00       	call   80104a90 <release>
...
80103815:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
80103818:	c7 40 14 0f 5e 10 80 	movl   $0x80105e0f,0x14(%eax)
  p->context = (struct context*)sp;
...
80103827:	e8 b4 12 00 00       	call   80104ae0 <memset>
...
80103843:	31 db                	xor    %ebx,%ebx
  release(&ptable.lock);
80103845:	68 80 47 11 80       	push   $0x80114780
8010384a:	e8 41 12 00 00       	call   80104a90 <release>
}
...
80103877:	83 ec 14             	sub    $0x14,%esp
  ...
  release(&ptable.lock);
8010387a:	68 80 47 11 80       	push   $0x80114780
8010387f:	e8 0c 12 00 00       	call   80104a90 <release>
...
801038ca:	68 c0 7b 10 80       	push   $0x80107bc0
801038cf:	68 80 47 11 80       	push   $0x80114780
801038d4:	e8 77 0f 00 00       	call   80104850 <initlock>
}
...
801038f0:	e8 ab ef ff ff       	call   801028a0 <lapicid>
  for (i = 0; i < ncpu; ++i) {
801038f5:	8b 35 60 47 11 80    	mov    0x80114760,%esi
  apicid = lapicid();
...
80103978:	83 ec 04             	sub    $0x4,%esp
  pushcli();
8010397b:	e8 50 0f 00 00       	call   801048d0 <pushcli>
  c = mycpu();
80103980:	e8 5b ff ff ff       	call   801038e0 <mycpu>
  p = c->proc;
80103985:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
8010398b:	e8 90 0f 00 00       	call   80104920 <popcli>
}
...
801039b7:	e8 24 3a 00 00       	call   801073e0 <setupkvm>
...
801039d5:	e8 d6 36 00 00       	call   801070b0 <inituvm>
...
801039ea:	e8 f1 10 00 00       	call   80104ae0 <memset>
...
80103a43:	68 f0 7b 10 80       	push   $0x80107bf0
80103a48:	50                   	push   %eax
80103a49:	e8 52 12 00 00       	call   80104ca0 <safestrcpy>
  p->cwd = namei("/");
80103a4e:	c7 04 24 f9 7b 10 80 	movl   $0x80107bf9,(%esp)
80103a55:	e8 d6 e5 ff ff       	call   80102030 <namei>
80103a5a:	89 43 68             	mov    %eax,0x68(%ebx)
  acquire(&ptable.lock);
80103a5d:	c7 04 24 80 47 11 80 	movl   $0x80114780,(%esp)
80103a64:	e8 67 0f 00 00       	call   801049d0 <acquire>
  p->state = RUNNABLE;
80103a69:	c7 43 0c 03 00 00 00 	movl   $0x3,0xc(%ebx)
  release(&ptable.lock);
80103a70:	c7 04 24 80 47 11 80 	movl   $0x80114780,(%esp)
80103a77:	e8 14 10 00 00       	call   80104a90 <release>
}
...
80103a87:	68 d7 7b 10 80       	push   $0x80107bd7
...
80103aa9:	8b 75 08             	mov    0x8(%ebp),%esi
  pushcli();
80103aac:	e8 1f 0e 00 00       	call   801048d0 <pushcli>
  c = mycpu();
80103ab1:	e8 2a fe ff ff       	call   801038e0 <mycpu>
  p = c->proc;
80103ab6:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103abc:	e8 5f 0e 00 00       	call   80104920 <popcli>
  sz = curproc->sz;
...
80103acf:	e8 cc 34 00 00       	call   80106fa0 <switchuvm>
  return 0;
...
80103b2a:	83 ec 1c             	sub    $0x1c,%esp
  pushcli();
80103b2d:	e8 9e 0d 00 00       	call   801048d0 <pushcli>
  c = mycpu();
80103b32:	e8 a9 fd ff ff       	call   801038e0 <mycpu>
  p = c->proc;
80103b37:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103b3d:	e8 de 0d 00 00       	call   80104920 <popcli>
  if((np = allocproc()) == 0){
...
80103b5c:	e8 4f 39 00 00       	call   801074b0 <copyuvm>
...
80103be1:	e8 ba 10 00 00       	call   80104ca0 <safestrcpy>
  pid = np->pid;
80103be6:	8b 5f 10             	mov    0x10(%edi),%ebx
  acquire(&ptable.lock);
80103be9:	c7 04 24 80 47 11 80 	movl   $0x80114780,(%esp)
80103bf0:	e8 db 0d 00 00       	call   801049d0 <acquire>
  np->state = RUNNABLE;
80103bf5:	c7 47 0c 03 00 00 00 	movl   $0x3,0xc(%edi)
  release(&ptable.lock);
80103bfc:	c7 04 24 80 47 11 80 	movl   $0x80114780,(%esp)
80103c03:	e8 88 0e 00 00       	call   80104a90 <release>
  return pid;
...
80103c57:	83 ec 14             	sub    $0x14,%esp
  acquire(&ptable.lock);
80103c5a:	68 80 47 11 80       	push   $0x80114780
80103c5f:	e8 6c 0d 00 00       	call   801049d0 <acquire>
80103c64:	83 c4 10             	add    $0x10,%esp
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103c67:	b8 b4 47 11 80       	mov    $0x801147b4,%eax
...
80103c7a:	3d b4 6d 11 80       	cmp    $0x80116db4,%eax
...
80103c9a:	3d b4 6d 11 80       	cmp    $0x80116db4,%eax
80103c9f:	75 e0                	jne    80103c81 <contarprocessos+0x31>
  release(&ptable.lock);
80103ca1:	83 ec 0c             	sub    $0xc,%esp
80103ca4:	68 80 47 11 80       	push   $0x80114780
80103ca9:	e8 e2 0d 00 00       	call   80104a90 <release>
}
...
80103d11:	31 d2                	xor    %edx,%edx
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103d13:	b8 b4 47 11 80       	mov    $0x801147b4,%eax
...
80103d31:	3d b4 6d 11 80       	cmp    $0x80116db4,%eax
...
80103d3c:	e8 8f 09 00 00       	call   801046d0 <random_at_most>
   if (!foundproc) cli();
...
80103d4b:	83 ec 0c             	sub    $0xc,%esp
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103d4e:	bf b4 47 11 80       	mov    $0x801147b4,%edi
    acquire(&ptable.lock);
80103d53:	68 80 47 11 80       	push   $0x80114780
80103d58:	e8 73 0c 00 00       	call   801049d0 <acquire>
...
80103d7c:	e8 1f 32 00 00       	call   80106fa0 <switchuvm>
      p->counter++;
...
80103da1:	e8 5d 0f 00 00       	call   80104d03 <swtch>
      switchkvm();
80103da6:	e8 d5 31 00 00       	call   80106f80 <switchkvm>
      break;
...
80103dbb:	31 ff                	xor    %edi,%edi
    release(&ptable.lock);
80103dbd:	68 80 47 11 80       	push   $0x80114780
80103dc2:	e8 c9 0c 00 00       	call   80104a90 <release>
  for(;;){
...
80103dd6:	81 ff b4 6d 11 80    	cmp    $0x80116db4,%edi
...
80103df3:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103df9:	e8 22 0b 00 00       	call   80104920 <popcli>
  if(!holding(&ptable.lock))
80103dfe:	83 ec 0c             	sub    $0xc,%esp
80103e01:	68 80 47 11 80       	push   $0x80114780
80103e06:	e8 75 0b 00 00       	call   80104980 <holding>
...
80103e4e:	e8 b0 0e 00 00       	call   80104d03 <swtch>
  mycpu()->intena = intena;
...
80103eaa:	83 ec 0c             	sub    $0xc,%esp
  pushcli();
80103ead:	e8 1e 0a 00 00       	call   801048d0 <pushcli>
  c = mycpu();
80103eb2:	e8 29 fa ff ff       	call   801038e0 <mycpu>
  p = c->proc;
80103eb7:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80103ebd:	e8 5e 0a 00 00       	call   80104920 <popcli>
  if(curproc == initproc)
...
80103f0c:	c7 46 68 00 00 00 00 	movl   $0x0,0x68(%esi)
  acquire(&ptable.lock);
80103f13:	c7 04 24 80 47 11 80 	movl   $0x80114780,(%esp)
80103f1a:	e8 b1 0a 00 00       	call   801049d0 <acquire>
...
80103f53:	3d b4 6d 11 80       	cmp    $0x80116db4,%eax
80103f58:	75 e2                	jne    80103f3c <exit+0x9c>
      p->parent = initproc;
80103f5a:	8b 0d 38 b6 10 80    	mov    0x8010b638,%ecx
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103f60:	ba b4 47 11 80       	mov    $0x801147b4,%edx
...
80103f76:	81 fa b4 6d 11 80    	cmp    $0x80116db4,%edx
...
80103fc7:	68 48 7c 10 80       	push   $0x80107c48
80103fcc:	e8 bf c3 ff ff       	call   80100390 <panic>
    panic("init exiting");
80103fd1:	83 ec 0c             	sub    $0xc,%esp
80103fd4:	68 3b 7c 10 80       	push   $0x80107c3b
...
80103fe8:	83 ec 04             	sub    $0x4,%esp
  pushcli();
80103feb:	e8 e0 08 00 00       	call   801048d0 <pushcli>
  c = mycpu();
...
80104003:	68 80 47 11 80       	push   $0x80114780
80104008:	e8 c3 09 00 00       	call   801049d0 <acquire>
  p->timeslice--;
...
80104026:	68 80 47 11 80       	push   $0x80114780
8010402b:	e8 60 0a 00 00       	call   80104a90 <release>
}
...
80104060:	8b 75 0c             	mov    0xc(%ebp),%esi
  pushcli();
80104063:	e8 68 08 00 00       	call   801048d0 <pushcli>
  c = mycpu();
80104068:	e8 73 f8 ff ff       	call   801038e0 <mycpu>
  p = c->proc;
8010406d:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80104073:	e8 a8 08 00 00       	call   80104920 <popcli>
  if(p == 0)
...
80104084:	81 fe 80 47 11 80    	cmp    $0x80114780,%esi
8010408a:	74 4c                	je     801040d8 <sleep+0x88>
    acquire(&ptable.lock);  //DOC: sleeplock1
8010408c:	83 ec 0c             	sub    $0xc,%esp
8010408f:	68 80 47 11 80       	push   $0x80114780
80104094:	e8 37 09 00 00       	call   801049d0 <acquire>
    release(lk);
80104099:	89 34 24             	mov    %esi,(%esp)
8010409c:	e8 ef 09 00 00       	call   80104a90 <release>
  p->chan = chan;
...
801040b0:	c7 43 20 00 00 00 00 	movl   $0x0,0x20(%ebx)
    release(&ptable.lock);
801040b7:	c7 04 24 80 47 11 80 	movl   $0x80114780,(%esp)
801040be:	e8 cd 09 00 00       	call   80104a90 <release>
    acquire(lk);
...
801040cf:	5d                   	pop    %ebp
    acquire(lk);
801040d0:	e9 fb 08 00 00       	jmp    801049d0 <acquire>
...
801040f9:	68 5a 7c 10 80       	push   $0x80107c5a
801040fe:	e8 8d c2 ff ff       	call   80100390 <panic>
    panic("sleep");
80104103:	83 ec 0c             	sub    $0xc,%esp
80104106:	68 54 7c 10 80       	push   $0x80107c54
...
80104118:	53                   	push   %ebx
  pushcli();
80104119:	e8 b2 07 00 00       	call   801048d0 <pushcli>
  c = mycpu();
8010411e:	e8 bd f7 ff ff       	call   801038e0 <mycpu>
  p = c->proc;
80104123:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80104129:	e8 f2 07 00 00       	call   80104920 <popcli>
  acquire(&ptable.lock);
8010412e:	83 ec 0c             	sub    $0xc,%esp
80104131:	68 80 47 11 80       	push   $0x80114780
80104136:	e8 95 08 00 00       	call   801049d0 <acquire>
8010413b:	83 c4 10             	add    $0x10,%esp
    havekids = 0;
8010413e:	31 c0                	xor    %eax,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104140:	bb b4 47 11 80       	mov    $0x801147b4,%ebx
...
80104156:	81 fb b4 6d 11 80    	cmp    $0x80116db4,%ebx
...
8010416f:	b8 01 00 00 00       	mov    $0x1,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104174:	81 fb b4 6d 11 80    	cmp    $0x80116db4,%ebx
...
8010418a:	68 80 47 11 80       	push   $0x80114780
...
801041b2:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
801041b9:	e8 a2 31 00 00       	call   80107360 <freevm>
        release(&ptable.lock);
801041be:	c7 04 24 80 47 11 80 	movl   $0x80114780,(%esp)
        p->pid = 0;
...
801041de:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        release(&ptable.lock);
801041e5:	e8 a6 08 00 00       	call   80104a90 <release>
        return pid;
...
801041f9:	be ff ff ff ff       	mov    $0xffffffff,%esi
      release(&ptable.lock);
801041fe:	68 80 47 11 80       	push   $0x80114780
80104203:	e8 88 08 00 00       	call   80104a90 <release>
      return -1;
...
80104218:	53                   	push   %ebx
  pushcli();
80104219:	e8 b2 06 00 00       	call   801048d0 <pushcli>
  c = mycpu();
8010421e:	e8 bd f6 ff ff       	call   801038e0 <mycpu>
  p = c->proc;
80104223:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80104229:	e8 f2 06 00 00       	call   80104920 <popcli>
  acquire(&ptable.lock);
8010422e:	83 ec 0c             	sub    $0xc,%esp
80104231:	68 80 47 11 80       	push   $0x80114780
80104236:	e8 95 07 00 00       	call   801049d0 <acquire>
8010423b:	83 c4 10             	add    $0x10,%esp
    havekids = 0;
8010423e:	31 c0                	xor    %eax,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104240:	bb b4 47 11 80       	mov    $0x801147b4,%ebx
...
80104256:	81 fb b4 6d 11 80    	cmp    $0x80116db4,%ebx
...
8010426f:	b8 01 00 00 00       	mov    $0x1,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104274:	81 fb b4 6d 11 80    	cmp    $0x80116db4,%ebx
...
80104292:	68 80 47 11 80       	push   $0x80114780
...
801042db:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
801042e2:	e8 79 30 00 00       	call   80107360 <freevm>
        release(&ptable.lock);
801042e7:	c7 04 24 80 47 11 80 	movl   $0x80114780,(%esp)
        p->pid = 0;
...
80104329:	00 00 00 
        release(&ptable.lock);
8010432c:	e8 5f 07 00 00       	call   80104a90 <release>
        return pid;
...
80104340:	be ff ff ff ff       	mov    $0xffffffff,%esi
      release(&ptable.lock);
80104345:	68 80 47 11 80       	push   $0x80114780
8010434a:	e8 41 07 00 00       	call   80104a90 <release>
      return -1;
...
8010436b:	8b 5d 08             	mov    0x8(%ebp),%ebx
  acquire(&ptable.lock);
8010436e:	68 80 47 11 80       	push   $0x80114780
80104373:	e8 58 06 00 00       	call   801049d0 <acquire>
80104378:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
8010437b:	b8 b4 47 11 80       	mov    $0x801147b4,%eax
80104380:	eb 12                	jmp    80104394 <wakeup+0x34>
80104382:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
80104388:	05 98 00 00 00       	add    $0x98,%eax
8010438d:	3d b4 6d 11 80       	cmp    $0x80116db4,%eax
80104392:	74 1e                	je     801043b2 <wakeup+0x52>
    if(p->state == SLEEPING && p->chan == chan)
80104394:	83 78 0c 02          	cmpl   $0x2,0xc(%eax)
80104398:	75 ee                	jne    80104388 <wakeup+0x28>
8010439a:	3b 58 20             	cmp    0x20(%eax),%ebx
8010439d:	75 e9                	jne    80104388 <wakeup+0x28>
      p->state = RUNNABLE;
8010439f:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
801043a6:	05 98 00 00 00       	add    $0x98,%eax
801043ab:	3d b4 6d 11 80       	cmp    $0x80116db4,%eax
801043b0:	75 e2                	jne    80104394 <wakeup+0x34>
  wakeup1(chan);
  release(&ptable.lock);
801043b2:	c7 45 08 80 47 11 80 	movl   $0x80114780,0x8(%ebp)
}
801043b9:	8b 5d fc             	mov    -0x4(%ebp),%ebx
801043bc:	c9                   	leave  
  release(&ptable.lock);
801043bd:	e9 ce 06 00 00       	jmp    80104a90 <release>
...
801043db:	8b 5d 08             	mov    0x8(%ebp),%ebx
  ...
  acquire(&ptable.lock);
801043de:	68 80 47 11 80       	push   $0x80114780
801043e3:	e8 e8 05 00 00       	call   801049d0 <acquire>
801043e8:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801043eb:	b8 b4 47 11 80       	mov    $0x801147b4,%eax
801043f0:	eb 12                	jmp    80104404 <kill+0x34>
801043f2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
801043f8:	05 98 00 00 00       	add    $0x98,%eax
801043fd:	3d b4 6d 11 80       	cmp    $0x80116db4,%eax
80104402:	74 34                	je     80104438 <kill+0x68>
    if(p->pid == pid){
80104404:	39 58 10             	cmp    %ebx,0x10(%eax)
80104407:	75 ef                	jne    801043f8 <kill+0x28>
      p->killed = 1;
      // Wake process from sleep if necessary.
      if(p->state == SLEEPING)
80104409:	83 78 0c 02          	cmpl   $0x2,0xc(%eax)
      p->killed = 1;
8010440d:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
      if(p->state == SLEEPING)
80104414:	75 07                	jne    8010441d <kill+0x4d>
        p->state = RUNNABLE;
80104416:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
      release(&ptable.lock);
8010441d:	83 ec 0c             	sub    $0xc,%esp
80104420:	68 80 47 11 80       	push   $0x80114780
80104425:	e8 66 06 00 00       	call   80104a90 <release>
      return 0;
    }
  }
  release(&ptable.lock);
...
8010443b:	68 80 47 11 80       	push   $0x80114780
80104440:	e8 4b 06 00 00       	call   80104a90 <release>
}
...
80104469:	8d 75 e8             	lea    -0x18(%ebp),%esi
8010446c:	53                   	push   %ebx
8010446d:	bb 20 48 11 80       	mov    $0x80114820,%ebx
80104472:	83 ec 3c             	sub    $0x3c,%esp
80104475:	eb 2b                	jmp    801044a2 <procdump+0x42>
...
80104483:	68 83 80 10 80       	push   $0x80108083
80104488:	e8 23 c2 ff ff       	call   801006b0 <cprintf>
8010448d:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104490:	81 c3 98 00 00 00    	add    $0x98,%ebx
80104496:	81 fb 20 6e 11 80    	cmp    $0x80116e20,%ebx
8010449c:	0f 84 8e 00 00 00    	je     80104530 <procdump+0xd0>
    if(p->state == UNUSED)
801044a2:	8b 43 a0             	mov    -0x60(%ebx),%eax
801044a5:	85 c0                	test   %eax,%eax
801044a7:	74 e7                	je     80104490 <procdump+0x30>
      state = "???";
801044a9:	ba 6b 7c 10 80       	mov    $0x80107c6b,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
801044ae:	83 f8 05             	cmp    $0x5,%eax
801044b1:	77 11                	ja     801044c4 <procdump+0x64>
801044b3:	8b 14 85 cc 7c 10 80 	mov    -0x7fef8334(,%eax,4),%edx
      state = "???";
801044ba:	b8 6b 7c 10 80       	mov    $0x80107c6b,%eax
801044bf:	85 d2                	test   %edx,%edx
801044c1:	0f 44 d0             	cmove  %eax,%edx
    cprintf("%d %s %s", p->pid, state, p->name);
801044c4:	53                   	push   %ebx
801044c5:	52                   	push   %edx
801044c6:	ff 73 a4             	pushl  -0x5c(%ebx)
801044c9:	68 6f 7c 10 80       	push   $0x80107c6f
801044ce:	e8 dd c1 ff ff       	call   801006b0 <cprintf>
    if(p->state == SLEEPING){
801044d3:	83 c4 10             	add    $0x10,%esp
801044d6:	83 7b a0 02          	cmpl   $0x2,-0x60(%ebx)
801044da:	75 a4                	jne    80104480 <procdump+0x20>
      getcallerpcs((uint*)p->context->ebp+2, pc);
801044dc:	83 ec 08             	sub    $0x8,%esp
801044df:	8d 45 c0             	lea    -0x40(%ebp),%eax
801044e2:	8d 7d c0             	lea    -0x40(%ebp),%edi
801044e5:	50                   	push   %eax
801044e6:	8b 43 b0             	mov    -0x50(%ebx),%eax
801044e9:	8b 40 0c             	mov    0xc(%eax),%eax
801044ec:	83 c0 08             	add    $0x8,%eax
801044ef:	50                   	push   %eax
801044f0:	e8 7b 03 00 00       	call   80104870 <getcallerpcs>
      for(i=0; i<10 && pc[i] != 0; i++)
...
80104504:	0f 84 76 ff ff ff    	je     80104480 <procdump+0x20>
        cprintf(" %p", pc[i]);
8010450a:	83 ec 08             	sub    $0x8,%esp
8010450d:	83 c7 04             	add    $0x4,%edi
80104510:	52                   	push   %edx
80104511:	68 c1 76 10 80       	push   $0x801076c1
80104516:	e8 95 c1 ff ff       	call   801006b0 <cprintf>
      for(i=0; i<10 && pc[i] != 0; i++)
8010451b:	83 c4 10             	add    $0x10,%esp
8010451e:	39 fe                	cmp    %edi,%esi
80104520:	75 de                	jne    80104500 <procdump+0xa0>
80104522:	e9 59 ff ff ff       	jmp    80104480 <procdump+0x20>
...
80104541:	b8 44 b6 10 80       	mov    $0x8010b644,%eax
80104546:	89 e5                	mov    %esp,%ebp
80104548:	8b 55 08             	mov    0x8(%ebp),%edx
8010454b:	89 15 40 b6 10 80    	mov    %edx,0x8010b640
80104551:	eb 08                	jmp    8010455b <sgenrand+0x1b>
80104553:	90                   	nop
80104554:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80104558:	83 c0 04             	add    $0x4,%eax
8010455b:	69 d2 cd 0d 01 00    	imul   $0x10dcd,%edx,%edx
80104561:	3d fc bf 10 80       	cmp    $0x8010bffc,%eax
80104566:	89 10                	mov    %edx,(%eax)
80104568:	75 ee                	jne    80104558 <sgenrand+0x18>
8010456a:	c7 05 08 b0 10 80 70 	movl   $0x270,0x8010b008
80104571:	02 00 00 
80104574:	5d                   	pop    %ebp
80104575:	c3                   	ret    
...
80104580 <genrand>:
80104580:	a1 08 b0 10 80       	mov    0x8010b008,%eax
80104585:	55                   	push   %ebp
80104586:	89 e5                	mov    %esp,%ebp
80104588:	53                   	push   %ebx
80104589:	3d 6f 02 00 00       	cmp    $0x26f,%eax
8010458e:	0f 8e f2 00 00 00    	jle    80104686 <genrand+0x106>
80104594:	3d 71 02 00 00       	cmp    $0x271,%eax
80104599:	0f 84 f3 00 00 00    	je     80104692 <genrand+0x112>
8010459f:	b9 40 b6 10 80       	mov    $0x8010b640,%ecx
801045a4:	ba cc b9 10 80       	mov    $0x8010b9cc,%edx
801045a9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
801045b0:	8b 19                	mov    (%ecx),%ebx
801045b2:	8b 41 04             	mov    0x4(%ecx),%eax
801045b5:	83 c1 04             	add    $0x4,%ecx
801045b8:	81 e3 00 00 00 80    	and    $0x80000000,%ebx
801045be:	25 ff ff ff 7f       	and    $0x7fffffff,%eax
801045c3:	09 d8                	or     %ebx,%eax
801045c5:	89 c3                	mov    %eax,%ebx
801045c7:	83 e0 01             	and    $0x1,%eax
801045ca:	d1 eb                	shr    %ebx
801045cc:	33 99 30 06 00 00    	xor    0x630(%ecx),%ebx
801045d2:	33 1c 85 e4 7c 10 80 	xor    -0x7fef831c(,%eax,4),%ebx
801045d9:	89 59 fc             	mov    %ebx,-0x4(%ecx)
801045dc:	39 ca                	cmp    %ecx,%edx
801045de:	75 d0                	jne    801045b0 <genrand+0x30>
801045e0:	b9 fc bf 10 80       	mov    $0x8010bffc,%ecx
801045e5:	8d 76 00             	lea    0x0(%esi),%esi
801045e8:	8b 1a                	mov    (%edx),%ebx
801045ea:	8b 42 04             	mov    0x4(%edx),%eax
801045ed:	83 c2 04             	add    $0x4,%edx
801045f0:	81 e3 00 00 00 80    	and    $0x80000000,%ebx
801045f6:	25 ff ff ff 7f       	and    $0x7fffffff,%eax
801045fb:	09 d8                	or     %ebx,%eax
801045fd:	89 c3                	mov    %eax,%ebx
801045ff:	83 e0 01             	and    $0x1,%eax
80104602:	d1 eb                	shr    %ebx
80104604:	33 9a 70 fc ff ff    	xor    -0x390(%edx),%ebx
8010460a:	33 1c 85 e4 7c 10 80 	xor    -0x7fef831c(,%eax,4),%ebx
80104611:	89 5a fc             	mov    %ebx,-0x4(%edx)
80104614:	39 d1                	cmp    %edx,%ecx
80104616:	75 d0                	jne    801045e8 <genrand+0x68>
80104618:	a1 40 b6 10 80       	mov    0x8010b640,%eax
8010461d:	8b 0d fc bf 10 80    	mov    0x8010bffc,%ecx
80104623:	89 c2                	mov    %eax,%edx
80104625:	81 e1 00 00 00 80    	and    $0x80000000,%ecx
8010462b:	81 e2 ff ff ff 7f    	and    $0x7fffffff,%edx
80104631:	09 ca                	or     %ecx,%edx
80104633:	89 d1                	mov    %edx,%ecx
80104635:	83 e2 01             	and    $0x1,%edx
80104638:	d1 e9                	shr    %ecx
8010463a:	33 0d 70 bc 10 80    	xor    0x8010bc70,%ecx
80104640:	33 0c 95 e4 7c 10 80 	xor    -0x7fef831c(,%edx,4),%ecx
80104647:	ba 01 00 00 00       	mov    $0x1,%edx
8010464c:	89 0d fc bf 10 80    	mov    %ecx,0x8010bffc
80104652:	89 15 08 b0 10 80    	mov    %edx,0x8010b008
80104658:	89 c2                	mov    %eax,%edx
8010465a:	c1 ea 0b             	shr    $0xb,%edx
8010465d:	31 c2                	xor    %eax,%edx
8010465f:	89 d0                	mov    %edx,%eax
80104661:	c1 e0 07             	shl    $0x7,%eax
80104664:	25 80 56 2c 9d       	and    $0x9d2c5680,%eax
80104669:	31 c2                	xor    %eax,%edx
8010466b:	89 d0                	mov    %edx,%eax
8010466d:	c1 e0 0f             	shl    $0xf,%eax
80104670:	25 00 00 c6 ef       	and    $0xefc60000,%eax
80104675:	31 d0                	xor    %edx,%eax
80104677:	89 c2                	mov    %eax,%edx
80104679:	c1 ea 12             	shr    $0x12,%edx
8010467c:	31 d0                	xor    %edx,%eax
8010467e:	25 ff ff ff 7f       	and    $0x7fffffff,%eax
80104683:	5b                   	pop    %ebx
80104684:	5d                   	pop    %ebp
80104685:	c3                   	ret    
80104686:	8d 50 01             	lea    0x1(%eax),%edx
80104689:	8b 04 85 40 b6 10 80 	mov    -0x7fef49c0(,%eax,4),%eax
80104690:	eb c0                	jmp    80104652 <genrand+0xd2>
80104692:	c7 05 40 b6 10 80 05 	movl   $0x1105,0x8010b640
80104699:	11 00 00 
8010469c:	b8 44 b6 10 80       	mov    $0x8010b644,%eax
801046a1:	b9 fc bf 10 80       	mov    $0x8010bffc,%ecx
801046a6:	ba 05 11 00 00       	mov    $0x1105,%edx
801046ab:	eb 06                	jmp    801046b3 <genrand+0x133>
801046ad:	8d 76 00             	lea    0x0(%esi),%esi
801046b0:	83 c0 04             	add    $0x4,%eax
801046b3:	69 d2 cd 0d 01 00    	imul   $0x10dcd,%edx,%edx
801046b9:	39 c1                	cmp    %eax,%ecx
801046bb:	89 10                	mov    %edx,(%eax)
801046bd:	75 f1                	jne    801046b0 <genrand+0x130>
801046bf:	e9 db fe ff ff       	jmp    8010459f <genrand+0x1f>
801046c4:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
801046ca:	8d bf 00 00 00 00    	lea    0x0(%edi),%edi

801046d0 <random_at_most>:
...
801046da:	bb 00 00 00 80       	mov    $0x80000000,%ebx
801046df:	8d 48 01             	lea    0x1(%eax),%ecx
801046e2:	89 d8                	mov    %ebx,%eax
801046e4:	f7 f1                	div    %ecx
801046e6:	89 c6                	mov    %eax,%esi
801046e8:	29 d3                	sub    %edx,%ebx
801046ea:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
801046f0:	e8 8b fe ff ff       	call   80104580 <genrand>
801046f5:	39 d8                	cmp    %ebx,%eax
801046f7:	73 f7                	jae    801046f0 <random_at_most+0x20>
801046f9:	31 d2                	xor    %edx,%edx
801046fb:	f7 f6                	div    %esi
801046fd:	5b                   	pop    %ebx
801046fe:	5e                   	pop    %esi
801046ff:	5d                   	pop    %ebp
80104700:	c3                   	ret    
80104701:	66 90                	xchg   %ax,%ax
80104703:	66 90                	xchg   %ax,%ax
...
8010471e:	68 ec 7c 10 80       	push   $0x80107cec
80104723:	8d 43 04             	lea    0x4(%ebx),%eax
80104726:	50                   	push   %eax
80104727:	e8 24 01 00 00       	call   80104850 <initlock>
  lk->name = name;
...
80104735:	83 c4 10             	add    $0x10,%esp
  lk->pid = 0;
80104738:	c7 43 3c 00 00 00 00 	movl   $0x0,0x3c(%ebx)
  lk->name = name;
8010473f:	89 43 38             	mov    %eax,0x38(%ebx)
}
80104742:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80104745:	c9                   	leave  
80104746:	c3                   	ret    
...
80104763:	e8 68 02 00 00       	call   801049d0 <acquire>
  while (lk->locked) {
80104768:	8b 13                	mov    (%ebx),%edx
8010476a:	83 c4 10             	add    $0x10,%esp
8010476d:	85 d2                	test   %edx,%edx
8010476f:	74 1a                	je     8010478b <acquiresleep+0x3b>
80104771:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    sleep(lk, &lk->lk);
80104778:	83 ec 08             	sub    $0x8,%esp
8010477b:	56                   	push   %esi
8010477c:	53                   	push   %ebx
8010477d:	e8 ce f8 ff ff       	call   80104050 <sleep>
  while (lk->locked) {
80104782:	8b 03                	mov    (%ebx),%eax
80104784:	83 c4 10             	add    $0x10,%esp
80104787:	85 c0                	test   %eax,%eax
80104789:	75 ed                	jne    80104778 <acquiresleep+0x28>
  }
  lk->locked = 1;
8010478b:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
80104791:	e8 da f1 ff ff       	call   80103970 <myproc>
80104796:	8b 40 10             	mov    0x10(%eax),%eax
80104799:	89 43 3c             	mov    %eax,0x3c(%ebx)
  release(&lk->lk);
8010479c:	89 75 08             	mov    %esi,0x8(%ebp)
}
...
801047a4:	5d                   	pop    %ebp
  release(&lk->lk);
801047a5:	e9 e6 02 00 00       	jmp    80104a90 <release>
...
801047c3:	e8 08 02 00 00       	call   801049d0 <acquire>
  lk->locked = 0;
801047c8:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
  lk->pid = 0;
801047ce:	c7 43 3c 00 00 00 00 	movl   $0x0,0x3c(%ebx)
  wakeup(lk);
801047d5:	89 1c 24             	mov    %ebx,(%esp)
801047d8:	e8 83 fb ff ff       	call   80104360 <wakeup>
  release(&lk->lk);
801047dd:	89 75 08             	mov    %esi,0x8(%ebp)
...
801047e8:	5d                   	pop    %ebp
  release(&lk->lk);
801047e9:	e9 a2 02 00 00       	jmp    80104a90 <release>
...
801047f8:	31 ff                	xor    %edi,%edi
801047fa:	56                   	push   %esi
801047fb:	53                   	push   %ebx
801047fc:	83 ec 18             	sub    $0x18,%esp
801047ff:	8b 5d 08             	mov    0x8(%ebp),%ebx
  int r;
  
  acquire(&lk->lk);
80104802:	8d 73 04             	lea    0x4(%ebx),%esi
80104805:	56                   	push   %esi
80104806:	e8 c5 01 00 00       	call   801049d0 <acquire>
  r = lk->locked && (lk->pid == myproc()->pid);
8010480b:	8b 03                	mov    (%ebx),%eax
8010480d:	83 c4 10             	add    $0x10,%esp
80104810:	85 c0                	test   %eax,%eax
80104812:	75 1c                	jne    80104830 <holdingsleep+0x40>
  release(&lk->lk);
80104814:	83 ec 0c             	sub    $0xc,%esp
80104817:	56                   	push   %esi
80104818:	e8 73 02 00 00       	call   80104a90 <release>
  return r;
}
...
8010485a:	8b 55 0c             	mov    0xc(%ebp),%edx
  lk->locked = 0;
8010485d:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  lk->name = name;
80104863:	89 50 04             	mov    %edx,0x4(%eax)
  lk->cpu = 0;
80104866:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
}
8010486d:	5d                   	pop    %ebp
8010486e:	c3                   	ret    
8010486f:	90                   	nop
...
{
8010487d:	8b 4d 0c             	mov    0xc(%ebp),%ecx
  ebp = (uint*)v - 2;
80104880:	83 e8 08             	sub    $0x8,%eax
  for(i = 0; i < 10; i++){
...
80104894:	77 1a                	ja     801048b0 <getcallerpcs+0x40>
      break;
    pcs[i] = ebp[1];     // saved %eip
80104896:	8b 58 04             	mov    0x4(%eax),%ebx
80104899:	89 1c 91             	mov    %ebx,(%ecx,%edx,4)
  for(i = 0; i < 10; i++){
8010489c:	83 c2 01             	add    $0x1,%edx
    ebp = (uint*)ebp[0]; // saved %ebp
8010489f:	8b 00                	mov    (%eax),%eax
  for(i = 0; i < 10; i++){
801048a1:	83 fa 0a             	cmp    $0xa,%edx
801048a4:	75 e2                	jne    80104888 <getcallerpcs+0x18>
  }
  for(; i < 10; i++)
    pcs[i] = 0;
}
...
801048a9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  for(; i < 10; i++)
801048b0:	8d 04 91             	lea    (%ecx,%edx,4),%eax
801048b3:	8d 51 28             	lea    0x28(%ecx),%edx
...
801048cb:	75 f3                	jne    801048c0 <getcallerpcs+0x50>
}
801048cd:	5b                   	pop    %ebx
801048ce:	5d                   	pop    %ebp
801048cf:	c3                   	ret    
...
801048dd:	fa                   	cli    
  ...
  cli();
  if(mycpu()->ncli == 0)
801048de:	e8 fd ef ff ff       	call   801038e0 <mycpu>
801048e3:	8b 80 a4 00 00 00    	mov    0xa4(%eax),%eax
801048e9:	85 c0                	test   %eax,%eax
801048eb:	74 13                	je     80104900 <pushcli+0x30>
    mycpu()->intena = eflags & FL_IF;
  mycpu()->ncli += 1;
801048ed:	e8 ee ef ff ff       	call   801038e0 <mycpu>
801048f2:	83 80 a4 00 00 00 01 	addl   $0x1,0xa4(%eax)
}
...
801048ff:	90                   	nop
    mycpu()->intena = eflags & FL_IF;
80104900:	e8 db ef ff ff       	call   801038e0 <mycpu>
80104905:	81 e3 00 02 00 00    	and    $0x200,%ebx
8010490b:	89 98 a8 00 00 00    	mov    %ebx,0xa8(%eax)
80104911:	eb da                	jmp    801048ed <pushcli+0x1d>
...
8010492b:	58                   	pop    %eax
  if(readeflags()&FL_IF)
8010492c:	f6 c4 02             	test   $0x2,%ah
8010492f:	75 31                	jne    80104962 <popcli+0x42>
    panic("popcli - interruptible");
  if(--mycpu()->ncli < 0)
80104931:	e8 aa ef ff ff       	call   801038e0 <mycpu>
80104936:	83 a8 a4 00 00 00 01 	subl   $0x1,0xa4(%eax)
8010493d:	78 30                	js     8010496f <popcli+0x4f>
    panic("popcli");
  if(mycpu()->ncli == 0 && mycpu()->intena)
8010493f:	e8 9c ef ff ff       	call   801038e0 <mycpu>
80104944:	8b 90 a4 00 00 00    	mov    0xa4(%eax),%edx
8010494a:	85 d2                	test   %edx,%edx
8010494c:	74 02                	je     80104950 <popcli+0x30>
    sti();
}
8010494e:	c9                   	leave  
8010494f:	c3                   	ret    
...
8010495d:	74 ef                	je     8010494e <popcli+0x2e>
  asm volatile("sti");
8010495f:	fb                   	sti    
}
80104960:	c9                   	leave  
...
80104965:	68 f7 7c 10 80       	push   $0x80107cf7
8010496a:	e8 21 ba ff ff       	call   80100390 <panic>
    panic("popcli");
8010496f:	83 ec 0c             	sub    $0xc,%esp
80104972:	68 0e 7d 10 80       	push   $0x80107d0e
80104977:	e8 14 ba ff ff       	call   80100390 <panic>
...
8010498c:	31 db                	xor    %ebx,%ebx
  pushcli();
8010498e:	e8 3d ff ff ff       	call   801048d0 <pushcli>
  r = lock->locked && lock->cpu == mycpu();
80104993:	8b 06                	mov    (%esi),%eax
80104995:	85 c0                	test   %eax,%eax
80104997:	75 0f                	jne    801049a8 <holding+0x28>
  popcli();
80104999:	e8 82 ff ff ff       	call   80104920 <popcli>
}
...
801049a4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  r = lock->locked && lock->cpu == mycpu();
801049a8:	8b 5e 08             	mov    0x8(%esi),%ebx
801049ab:	e8 30 ef ff ff       	call   801038e0 <mycpu>
801049b0:	39 c3                	cmp    %eax,%ebx
801049b2:	0f 94 c3             	sete   %bl
  popcli();
801049b5:	e8 66 ff ff ff       	call   80104920 <popcli>
  r = lock->locked && lock->cpu == mycpu();
801049ba:	0f b6 db             	movzbl %bl,%ebx
}
801049bd:	89 d8                	mov    %ebx,%eax
801049bf:	5b                   	pop    %ebx
801049c0:	5e                   	pop    %esi
801049c1:	5d                   	pop    %ebp
801049c2:	c3                   	ret    
...
801049d9:	e8 f2 fe ff ff       	call   801048d0 <pushcli>
  if(holding(lk))
801049de:	8b 5d 08             	mov    0x8(%ebp),%ebx
801049e1:	83 ec 0c             	sub    $0xc,%esp
801049e4:	53                   	push   %ebx
801049e5:	e8 96 ff ff ff       	call   80104980 <holding>
801049ea:	83 c4 10             	add    $0x10,%esp
801049ed:	85 c0                	test   %eax,%eax
801049ef:	0f 85 7f 00 00 00    	jne    80104a74 <acquire+0xa4>
801049f5:	89 c6                	mov    %eax,%esi
  asm volatile("lock; xchgl %0, %1" :
801049f7:	ba 01 00 00 00       	mov    $0x1,%edx
801049fc:	eb 05                	jmp    80104a03 <acquire+0x33>
801049fe:	66 90                	xchg   %ax,%ax
80104a00:	8b 5d 08             	mov    0x8(%ebp),%ebx
80104a03:	89 d0                	mov    %edx,%eax
80104a05:	f0 87 03             	lock xchg %eax,(%ebx)
  while(xchg(&lk->locked, 1) != 0)
80104a08:	85 c0                	test   %eax,%eax
80104a0a:	75 f4                	jne    80104a00 <acquire+0x30>
  __sync_synchronize();
80104a0c:	f0 83 0c 24 00       	lock orl $0x0,(%esp)
  lk->cpu = mycpu();
80104a11:	8b 5d 08             	mov    0x8(%ebp),%ebx
80104a14:	e8 c7 ee ff ff       	call   801038e0 <mycpu>
80104a19:	89 43 08             	mov    %eax,0x8(%ebx)
  ebp = (uint*)v - 2;
80104a1c:	89 e8                	mov    %ebp,%eax
80104a1e:	66 90                	xchg   %ax,%ax
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
80104a20:	8d 90 00 00 00 80    	lea    -0x80000000(%eax),%edx
80104a26:	81 fa fe ff ff 7f    	cmp    $0x7ffffffe,%edx
80104a2c:	77 22                	ja     80104a50 <acquire+0x80>
    pcs[i] = ebp[1];     // saved %eip
80104a2e:	8b 50 04             	mov    0x4(%eax),%edx
80104a31:	89 54 b3 0c          	mov    %edx,0xc(%ebx,%esi,4)
  for(i = 0; i < 10; i++){
80104a35:	83 c6 01             	add    $0x1,%esi
    ebp = (uint*)ebp[0]; // saved %ebp
80104a38:	8b 00                	mov    (%eax),%eax
  for(i = 0; i < 10; i++){
80104a3a:	83 fe 0a             	cmp    $0xa,%esi
80104a3d:	75 e1                	jne    80104a20 <acquire+0x50>
}
...
80104a4d:	8d 76 00             	lea    0x0(%esi),%esi
  for(; i < 10; i++)
80104a50:	8d 44 b3 0c          	lea    0xc(%ebx,%esi,4),%eax
80104a54:	83 c3 34             	add    $0x34,%ebx
...
80104a69:	39 d8                	cmp    %ebx,%eax
80104a6b:	75 f3                	jne    80104a60 <acquire+0x90>
}
...
80104a77:	68 15 7d 10 80       	push   $0x80107d15
...
80104a9f:	e8 dc fe ff ff       	call   80104980 <holding>
80104aa4:	83 c4 10             	add    $0x10,%esp
80104aa7:	85 c0                	test   %eax,%eax
80104aa9:	74 22                	je     80104acd <release+0x3d>
  lk->pcs[0] = 0;
80104aab:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
  lk->cpu = 0;
80104ab2:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
  __sync_synchronize();
80104ab9:	f0 83 0c 24 00       	lock orl $0x0,(%esp)
  asm volatile("movl $0, %0" : "+m" (lk->locked) : );
80104abe:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
}
80104ac4:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80104ac7:	c9                   	leave  
  popcli();
80104ac8:	e9 53 fe ff ff       	jmp    80104920 <popcli>
    panic("release");
80104acd:	83 ec 0c             	sub    $0xc,%esp
80104ad0:	68 1d 7d 10 80       	push   $0x80107d1d
80104ad5:	e8 b6 b8 ff ff       	call   80100390 <panic>
...
80104af4:	09 cf                	or     %ecx,%edi
80104af6:	83 e7 03             	and    $0x3,%edi
80104af9:	75 25                	jne    80104b20 <memset+0x40>
    c &= 0xFF;
80104afb:	0f b6 f8             	movzbl %al,%edi
    stosl(dst, (c<<24)|(c<<16)|(c<<8)|c, n/4);
80104afe:	c1 e0 18             	shl    $0x18,%eax
80104b01:	89 fb                	mov    %edi,%ebx
80104b03:	c1 e9 02             	shr    $0x2,%ecx
...
80104b22:	fc                   	cld    
80104b23:	f3 aa                	rep stos %al,%es:(%edi)
80104b25:	5b                   	pop    %ebx
...
80104b3b:	8b 55 08             	mov    0x8(%ebp),%edx
...
80104b44:	74 2a                	je     80104b70 <memcmp+0x40>
80104b46:	01 c6                	add    %eax,%esi
80104b48:	eb 10                	jmp    80104b5a <memcmp+0x2a>
80104b4a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    if(*s1 != *s2)
      return *s1 - *s2;
    s1++, s2++;
80104b50:	83 c0 01             	add    $0x1,%eax
80104b53:	83 c2 01             	add    $0x1,%edx
  while(n-- > 0){
80104b56:	39 f0                	cmp    %esi,%eax
80104b58:	74 16                	je     80104b70 <memcmp+0x40>
    if(*s1 != *s2)
80104b5a:	0f b6 0a             	movzbl (%edx),%ecx
80104b5d:	0f b6 18             	movzbl (%eax),%ebx
80104b60:	38 d9                	cmp    %bl,%cl
80104b62:	74 ec                	je     80104b50 <memcmp+0x20>
      return *s1 - *s2;
80104b64:	0f b6 c1             	movzbl %cl,%eax
...
80104b8f:	8b 75 0c             	mov    0xc(%ebp),%esi
  const char *s;
  char *d;
  ...
  d = dst;
  if(s < d && s + n > d){
80104b92:	39 d6                	cmp    %edx,%esi
80104b94:	73 2a                	jae    80104bc0 <memmove+0x40>
80104b96:	8d 3c 0e             	lea    (%esi,%ecx,1),%edi
80104b99:	39 fa                	cmp    %edi,%edx
80104b9b:	73 23                	jae    80104bc0 <memmove+0x40>
80104b9d:	8d 41 ff             	lea    -0x1(%ecx),%eax
    s += n;
    d += n;
    while(n-- > 0)
80104ba0:	85 c9                	test   %ecx,%ecx
80104ba2:	74 13                	je     80104bb7 <memmove+0x37>
80104ba4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
      *--d = *--s;
80104ba8:	0f b6 0c 06          	movzbl (%esi,%eax,1),%ecx
80104bac:	88 0c 02             	mov    %cl,(%edx,%eax,1)
    while(n-- > 0)
80104baf:	83 e8 01             	sub    $0x1,%eax
80104bb2:	83 f8 ff             	cmp    $0xffffffff,%eax
80104bb5:	75 f1                	jne    80104ba8 <memmove+0x28>
  } else
    while(n-- > 0)
      *d++ = *s++;
...
80104bbd:	8d 76 00             	lea    0x0(%esi),%esi
    while(n-- > 0)
80104bc0:	8d 04 0e             	lea    (%esi,%ecx,1),%eax
80104bc3:	89 d7                	mov    %edx,%edi
80104bc5:	85 c9                	test   %ecx,%ecx
80104bc7:	74 ee                	je     80104bb7 <memmove+0x37>
80104bc9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
      *d++ = *s++;
80104bd0:	a4                   	movsb  %ds:(%esi),%es:(%edi)
    while(n-- > 0)
80104bd1:	39 f0                	cmp    %esi,%eax
80104bd3:	75 fb                	jne    80104bd0 <memmove+0x50>
}
80104bd5:	5e                   	pop    %esi
80104bd6:	89 d0                	mov    %edx,%eax
80104bd8:	5f                   	pop    %edi
80104bd9:	5d                   	pop    %ebp
80104bda:	c3                   	ret    
...
80104bf8:	8b 75 10             	mov    0x10(%ebp),%esi
80104bfb:	8b 4d 08             	mov    0x8(%ebp),%ecx
80104bfe:	53                   	push   %ebx
80104bff:	8b 45 0c             	mov    0xc(%ebp),%eax
  while(n > 0 && *p && *p == *q)
80104c02:	85 f6                	test   %esi,%esi
80104c04:	74 32                	je     80104c38 <strncmp+0x48>
80104c06:	01 c6                	add    %eax,%esi
80104c08:	eb 14                	jmp    80104c1e <strncmp+0x2e>
80104c0a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
80104c10:	38 da                	cmp    %bl,%dl
80104c12:	75 14                	jne    80104c28 <strncmp+0x38>
    n--, p++, q++;
80104c14:	83 c0 01             	add    $0x1,%eax
80104c17:	83 c1 01             	add    $0x1,%ecx
  while(n > 0 && *p && *p == *q)
80104c1a:	39 f0                	cmp    %esi,%eax
80104c1c:	74 1a                	je     80104c38 <strncmp+0x48>
80104c1e:	0f b6 11             	movzbl (%ecx),%edx
80104c21:	0f b6 18             	movzbl (%eax),%ebx
80104c24:	84 d2                	test   %dl,%dl
80104c26:	75 e8                	jne    80104c10 <strncmp+0x20>
  if(n == 0)
    return 0;
  return (uchar)*p - (uchar)*q;
80104c28:	0f b6 c2             	movzbl %dl,%eax
80104c2b:	29 d8                	sub    %ebx,%eax
}
80104c2d:	5b                   	pop    %ebx
80104c2e:	5e                   	pop    %esi
80104c2f:	5d                   	pop    %ebp
...
80104c4d:	8b 45 10             	mov    0x10(%ebp),%eax
  ...
  os = s;
  while(n-- > 0 && (*s++ = *t++) != 0)
80104c50:	89 f2                	mov    %esi,%edx
80104c52:	eb 1b                	jmp    80104c6f <strncpy+0x2f>
80104c54:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80104c58:	83 45 0c 01          	addl   $0x1,0xc(%ebp)
80104c5c:	8b 7d 0c             	mov    0xc(%ebp),%edi
80104c5f:	83 c2 01             	add    $0x1,%edx
80104c62:	0f b6 7f ff          	movzbl -0x1(%edi),%edi
80104c66:	89 f9                	mov    %edi,%ecx
80104c68:	88 4a ff             	mov    %cl,-0x1(%edx)
80104c6b:	84 c9                	test   %cl,%cl
80104c6d:	74 09                	je     80104c78 <strncpy+0x38>
80104c6f:	89 c3                	mov    %eax,%ebx
80104c71:	83 e8 01             	sub    $0x1,%eax
80104c74:	85 db                	test   %ebx,%ebx
80104c76:	7f e0                	jg     80104c58 <strncpy+0x18>
    ;
  while(n-- > 0)
80104c78:	89 d1                	mov    %edx,%ecx
80104c7a:	85 c0                	test   %eax,%eax
80104c7c:	7e 15                	jle    80104c93 <strncpy+0x53>
80104c7e:	66 90                	xchg   %ax,%ax
    *s++ = 0;
80104c80:	83 c1 01             	add    $0x1,%ecx
80104c83:	c6 41 ff 00          	movb   $0x0,-0x1(%ecx)
  while(n-- > 0)
80104c87:	89 c8                	mov    %ecx,%eax
80104c89:	f7 d0                	not    %eax
80104c8b:	01 d0                	add    %edx,%eax
80104c8d:	01 d8                	add    %ebx,%eax
80104c8f:	85 c0                	test   %eax,%eax
80104c91:	7f ed                	jg     80104c80 <strncpy+0x40>
  return os;
}
80104c93:	5b                   	pop    %ebx
80104c94:	89 f0                	mov    %esi,%eax
80104c96:	5e                   	pop    %esi
80104c97:	5f                   	pop    %edi
80104c98:	5d                   	pop    %ebp
80104c99:	c3                   	ret    
...
80104ca8:	8b 55 10             	mov    0x10(%ebp),%edx
80104cab:	8b 75 08             	mov    0x8(%ebp),%esi
...
80104caf:	8b 45 0c             	mov    0xc(%ebp),%eax
  ...
  os = s;
  if(n <= 0)
80104cb2:	85 d2                	test   %edx,%edx
80104cb4:	7e 21                	jle    80104cd7 <safestrcpy+0x37>
80104cb6:	8d 5c 10 ff          	lea    -0x1(%eax,%edx,1),%ebx
80104cba:	89 f2                	mov    %esi,%edx
80104cbc:	eb 12                	jmp    80104cd0 <safestrcpy+0x30>
80104cbe:	66 90                	xchg   %ax,%ax
    return os;
  while(--n > 0 && (*s++ = *t++) != 0)
80104cc0:	0f b6 08             	movzbl (%eax),%ecx
80104cc3:	83 c0 01             	add    $0x1,%eax
80104cc6:	83 c2 01             	add    $0x1,%edx
80104cc9:	88 4a ff             	mov    %cl,-0x1(%edx)
80104ccc:	84 c9                	test   %cl,%cl
80104cce:	74 04                	je     80104cd4 <safestrcpy+0x34>
80104cd0:	39 d8                	cmp    %ebx,%eax
80104cd2:	75 ec                	jne    80104cc0 <safestrcpy+0x20>
    ;
  *s = 0;
80104cd4:	c6 02 00             	movb   $0x0,(%edx)
  return os;
}
80104cd7:	89 f0                	mov    %esi,%eax
80104cd9:	5b                   	pop    %ebx
80104cda:	5e                   	pop    %esi
80104cdb:	5d                   	pop    %ebp
80104cdc:	c3                   	ret    
...
80104ce9:	8b 55 08             	mov    0x8(%ebp),%edx
  for(n = 0; s[n]; n++)
80104cec:	80 3a 00             	cmpb   $0x0,(%edx)
80104cef:	74 10                	je     80104d01 <strlen+0x21>
80104cf1:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80104cf8:	83 c0 01             	add    $0x1,%eax
80104cfb:	80 3c 02 00          	cmpb   $0x0,(%edx,%eax,1)
80104cff:	75 f7                	jne    80104cf8 <strlen+0x18>
    ;
  return n;
}
80104d01:	5d                   	pop    %ebp
...
80104d03 <swtch>:
80104d03:	8b 44 24 04          	mov    0x4(%esp),%eax
80104d07:	8b 54 24 08          	mov    0x8(%esp),%edx
80104d0b:	55                   	push   %ebp
80104d0c:	53                   	push   %ebx
80104d0d:	56                   	push   %esi
80104d0e:	57                   	push   %edi
80104d0f:	89 20                	mov    %esp,(%eax)
80104d11:	89 d4                	mov    %edx,%esp
80104d13:	5f                   	pop    %edi
80104d14:	5e                   	pop    %esi
80104d15:	5b                   	pop    %ebx
80104d16:	5d                   	pop    %ebp
...
80104d2b:	8b 5d 08             	mov    0x8(%ebp),%ebx
  struct proc *curproc = myproc();
80104d2e:	e8 3d ec ff ff       	call   80103970 <myproc>

  if(addr >= curproc->sz || addr+4 > curproc->sz)
80104d33:	8b 00                	mov    (%eax),%eax
80104d35:	39 d8                	cmp    %ebx,%eax
80104d37:	76 17                	jbe    80104d50 <fetchint+0x30>
80104d39:	8d 53 04             	lea    0x4(%ebx),%edx
80104d3c:	39 d0                	cmp    %edx,%eax
80104d3e:	72 10                	jb     80104d50 <fetchint+0x30>
    return -1;
  *ip = *(int*)(addr);
80104d40:	8b 45 0c             	mov    0xc(%ebp),%eax
80104d43:	8b 13                	mov    (%ebx),%edx
...
80104d55:	eb f2                	jmp    80104d49 <fetchint+0x29>
...
80104d6e:	e8 fd eb ff ff       	call   80103970 <myproc>
  ...
  if(addr >= curproc->sz)
80104d73:	39 18                	cmp    %ebx,(%eax)
80104d75:	76 31                	jbe    80104da8 <fetchstr+0x48>
    return -1;
  *pp = (char*)addr;
...
80104d80:	73 26                	jae    80104da8 <fetchstr+0x48>
80104d82:	89 d8                	mov    %ebx,%eax
80104d84:	eb 11                	jmp    80104d97 <fetchstr+0x37>
...
80104d95:	76 11                	jbe    80104da8 <fetchstr+0x48>
    if(*s == 0)
80104d97:	80 38 00             	cmpb   $0x0,(%eax)
80104d9a:	75 f4                	jne    80104d90 <fetchstr+0x30>
      return s - *pp;
  }
  return -1;
}
80104d9c:	83 c4 04             	add    $0x4,%esp
      return s - *pp;
...
80104dd4:	8b 40 44             	mov    0x44(%eax),%eax
80104dd7:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80104dda:	e8 91 eb ff ff       	call   80103970 <myproc>
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
80104ddf:	8d 73 04             	lea    0x4(%ebx),%esi
  if(addr >= curproc->sz || addr+4 > curproc->sz)
80104de2:	8b 00                	mov    (%eax),%eax
80104de4:	39 c6                	cmp    %eax,%esi
80104de6:	73 18                	jae    80104e00 <argint+0x40>
80104de8:	8d 53 08             	lea    0x8(%ebx),%edx
80104deb:	39 d0                	cmp    %edx,%eax
80104ded:	72 11                	jb     80104e00 <argint+0x40>
  *ip = *(int*)(addr);
80104def:	8b 45 0c             	mov    0xc(%ebp),%eax
80104df2:	8b 53 04             	mov    0x4(%ebx),%edx
...
80104e00:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
80104e05:	eb f2                	jmp    80104df9 <argint+0x39>
...
80104e1c:	8b 5d 10             	mov    0x10(%ebp),%ebx
  int i;
  struct proc *curproc = myproc();
80104e1f:	e8 4c eb ff ff       	call   80103970 <myproc>

  if(argint(n, &i) < 0)
80104e24:	83 ec 08             	sub    $0x8,%esp
  struct proc *curproc = myproc();
80104e27:	89 c6                	mov    %eax,%esi
  if(argint(n, &i) < 0)
80104e29:	8d 45 f4             	lea    -0xc(%ebp),%eax
80104e2c:	50                   	push   %eax
80104e2d:	ff 75 08             	pushl  0x8(%ebp)
80104e30:	e8 8b ff ff ff       	call   80104dc0 <argint>
    return -1;
  if(size < 0 || (uint)i >= curproc->sz || (uint)i+size > curproc->sz)
80104e35:	83 c4 10             	add    $0x10,%esp
80104e38:	85 c0                	test   %eax,%eax
80104e3a:	78 24                	js     80104e60 <argptr+0x50>
80104e3c:	85 db                	test   %ebx,%ebx
80104e3e:	78 20                	js     80104e60 <argptr+0x50>
80104e40:	8b 16                	mov    (%esi),%edx
80104e42:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104e45:	39 c2                	cmp    %eax,%edx
80104e47:	76 17                	jbe    80104e60 <argptr+0x50>
80104e49:	01 c3                	add    %eax,%ebx
80104e4b:	39 da                	cmp    %ebx,%edx
80104e4d:	72 11                	jb     80104e60 <argptr+0x50>
    return -1;
  *pp = (char*)i;
...
80104e65:	eb ef                	jmp    80104e56 <argptr+0x46>
...
80104e7e:	ff 75 08             	pushl  0x8(%ebp)
80104e81:	e8 3a ff ff ff       	call   80104dc0 <argint>
80104e86:	83 c4 10             	add    $0x10,%esp
80104e89:	85 c0                	test   %eax,%eax
80104e8b:	78 13                	js     80104ea0 <argstr+0x30>
    return -1;
  return fetchstr(addr, pp);
80104e8d:	83 ec 08             	sub    $0x8,%esp
80104e90:	ff 75 0c             	pushl  0xc(%ebp)
80104e93:	ff 75 f4             	pushl  -0xc(%ebp)
80104e96:	e8 c5 fe ff ff       	call   80104d60 <fetchstr>
...
80104ebe:	89 c3                	mov    %eax,%ebx

  num = curproc->tf->eax;
80104ec0:	8b 40 18             	mov    0x18(%eax),%eax
80104ec3:	8b 70 1c             	mov    0x1c(%eax),%esi
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
80104ec6:	8d 46 ff             	lea    -0x1(%esi),%eax
80104ec9:	83 f8 18             	cmp    $0x18,%eax
80104ecc:	77 42                	ja     80104f10 <syscall+0x60>
80104ece:	8b 04 b5 e0 7d 10 80 	mov    -0x7fef8220(,%esi,4),%eax
80104ed5:	85 c0                	test   %eax,%eax
80104ed7:	74 37                	je     80104f10 <syscall+0x60>
    curproc->tf->eax = syscalls[num]();
80104ed9:	ff d0                	call   *%eax
80104edb:	8b 53 18             	mov    0x18(%ebx),%edx
80104ede:	89 42 1c             	mov    %eax,0x1c(%edx)
...
80104ee1:	8b 43 7c             	mov    0x7c(%ebx),%eax
80104ee4:	85 c0                	test   %eax,%eax
80104ee6:	74 4e                	je     80104f36 <syscall+0x86>
      cprintf("ID: %d NOME: %s NUM_CALL: %d CALL_NAME %s\n",
80104ee8:	83 ec 0c             	sub    $0xc,%esp
        curproc->pid,
        curproc->name,
80104eeb:	8d 43 6c             	lea    0x6c(%ebx),%eax
      cprintf("ID: %d NOME: %s NUM_CALL: %d CALL_NAME %s\n",
80104eee:	ff 34 b5 20 b0 10 80 	pushl  -0x7fef4fe0(,%esi,4)
80104ef5:	56                   	push   %esi
80104ef6:	50                   	push   %eax
80104ef7:	ff 73 10             	pushl  0x10(%ebx)
80104efa:	68 a4 7d 10 80       	push   $0x80107da4
80104eff:	e8 ac b7 ff ff       	call   801006b0 <cprintf>
80104f04:	83 c4 20             	add    $0x20,%esp
        num,
        syscallnames[num]);
  }
}
...
80104f28:	c7 40 1c ff ff ff ff 	movl   $0xffffffff,0x1c(%eax)
  if (curproc->traceflag != 0) {
80104f2f:	8b 43 7c             	mov    0x7c(%ebx),%eax
80104f32:	85 c0                	test   %eax,%eax
80104f34:	75 b2                	jne    80104ee8 <syscall+0x38>
}
...
80105074:	68 64 7e 10 80       	push   $0x80107e64
...
8010508c:	68 63 7e 10 80       	push   $0x80107e63
...
801050a1:	68 57 7e 10 80       	push   $0x80107e57
...
801050bf:	68 66 7e 10 80       	push   $0x80107e66
801050c4:	e8 c7 b2 ff ff       	call   80100390 <panic>
    panic("create: ialloc");
801050c9:	83 ec 0c             	sub    $0xc,%esp
801050cc:	68 48 7e 10 80       	push   $0x80107e48
...
801050f2:	e8 c9 fc ff ff       	call   80104dc0 <argint>
...
80105104:	e8 67 e8 ff ff       	call   80103970 <myproc>
...
8010514d:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
8010514f:	e8 1c e8 ff ff       	call   80103970 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
801051c1:	e8 fa fb ff ff       	call   80104dc0 <argint>
...
801051d9:	e8 32 fc ff ff       	call   80104e10 <argptr>
...
80105231:	e8 8a fb ff ff       	call   80104dc0 <argint>
...
80105249:	e8 c2 fb ff ff       	call   80104e10 <argptr>
...
801052f3:	e8 18 fb ff ff       	call   80104e10 <argptr>
...
80105333:	e8 38 fb ff ff       	call   80104e70 <argstr>
...
8010534c:	e8 1f fb ff ff       	call   80104e70 <argstr>
...
80105385:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
...
80105420:	e8 3b c3 ff ff       	call   80101760 <ilock>
  ip->nlink--;
80105425:	66 83 6b 56 01       	subw   $0x1,0x56(%ebx)
  iupdate(ip);
...
80105483:	e8 e8 f9 ff ff       	call   80104e70 <argstr>
...
801054bd:	58                   	pop    %eax
801054be:	5a                   	pop    %edx
801054bf:	68 64 7e 10 80       	push   $0x80107e64
...
801054d8:	68 63 7e 10 80       	push   $0x80107e63
...
80105532:	e8 a9 f5 ff ff       	call   80104ae0 <memset>
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
...
80105549:	0f 85 e7 00 00 00    	jne    80105636 <sys_unlink+0x1c6>
  if(ip->type == T_DIR){
8010554f:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
...
8010555e:	e8 9d c4 ff ff       	call   80101a00 <iunlockput>
  ip->nlink--;
80105563:	66 83 6b 56 01       	subw   $0x1,0x56(%ebx)
  iupdate(ip);
...
801055a3:	39 53 58             	cmp    %edx,0x58(%ebx)
...
801055f0:	83 ec 0c             	sub    $0xc,%esp
    dp->nlink--;
801055f3:	66 83 6e 56 01       	subw   $0x1,0x56(%esi)
    iupdate(dp);
...
80105663:	e8 08 f8 ff ff       	call   80104e70 <argstr>
...
8010567c:	e8 3f f7 ff ff       	call   80104dc0 <argint>
...
801057a8:	e8 c3 f6 ff ff       	call   80104e70 <argstr>
...
80105818:	e8 53 f6 ff ff       	call   80104e70 <argstr>
...
8010582d:	e8 8e f5 ff ff       	call   80104dc0 <argint>
  if((argstr(0, &path)) < 0 ||
...
80105842:	e8 79 f5 ff ff       	call   80104dc0 <argint>
     argint(1, &major) < 0 ||
...
801058a9:	83 ec 10             	sub    $0x10,%esp
  ...
  struct inode *ip;
  struct proc *curproc = myproc();
801058ac:	e8 bf e0 ff ff       	call   80103970 <myproc>
...
801058c1:	e8 aa f5 ff ff       	call   80104e70 <argstr>
...
80105969:	e8 02 f5 ff ff       	call   80104e70 <argstr>
...
80105985:	e8 36 f4 ff ff       	call   80104dc0 <argint>
...
801059aa:	e8 31 f1 ff ff       	call   80104ae0 <memset>
...
801059cc:	e8 4f f3 ff ff       	call   80104d20 <fetchint>
...
801059f0:	e8 6b f3 ff ff       	call   80104d60 <fetchstr>
...
80105a65:	e8 a6 f3 ff ff       	call   80104e10 <argptr>
...
80105a8b:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
80105a8d:	e8 de de ff ff       	call   80103970 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
80105b30:	f3 0f 1e fb          	endbr32 
  return fork();
80105b34:	e9 e7 df ff ff       	jmp    80103b20 <fork>
...
80105b47:	83 ec 08             	sub    $0x8,%esp
  exit();
80105b4a:	e8 51 e3 ff ff       	call   80103ea0 <exit>
...
80105b60:	f3 0f 1e fb          	endbr32 
  return wait();
80105b64:	e9 a7 e5 ff ff       	jmp    80104110 <wait>
...
80105b80:	e8 3b f2 ff ff       	call   80104dc0 <argint>
...
80105b92:	e8 39 e8 ff ff       	call   801043d0 <kill>
...
80105bf0:	e8 1b f2 ff ff       	call   80104e10 <argptr>
80105bf5:	83 c4 10             	add    $0x10,%esp
80105bf8:	85 c0                	test   %eax,%eax
80105bfa:	78 1c                	js     80105c18 <sys_wait2+0x68>
    return -1;

  return wait2(retime, rutime, stime);
80105bfc:	83 ec 04             	sub    $0x4,%esp
80105bff:	ff 75 f4             	pushl  -0xc(%ebp)
80105c02:	ff 75 f0             	pushl  -0x10(%ebp)
80105c05:	ff 75 ec             	pushl  -0x14(%ebp)
80105c08:	e8 03 e6 ff ff       	call   80104210 <wait2>
...
80105c27:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
80105c2a:	e8 41 dd ff ff       	call   80103970 <myproc>
80105c2f:	8b 40 10             	mov    0x10(%eax),%eax
}
80105c32:	c9                   	leave  
80105c33:	c3                   	ret    
...
80105c51:	e8 6a f1 ff ff       	call   80104dc0 <argint>
80105c56:	83 c4 10             	add    $0x10,%esp
80105c59:	85 c0                	test   %eax,%eax
80105c5b:	78 23                	js     80105c80 <sys_sbrk+0x40>
    return -1;
  addr = myproc()->sz;
...
80105c62:	83 ec 0c             	sub    $0xc,%esp
  addr = myproc()->sz;
80105c65:	8b 18                	mov    (%eax),%ebx
  if(growproc(n) < 0)
80105c67:	ff 75 f4             	pushl  -0xc(%ebp)
80105c6a:	e8 31 de ff ff       	call   80103aa0 <growproc>
80105c6f:	83 c4 10             	add    $0x10,%esp
80105c72:	85 c0                	test   %eax,%eax
80105c74:	78 0a                	js     80105c80 <sys_sbrk+0x40>
    return -1;
  return addr;
}
80105c76:	89 d8                	mov    %ebx,%eax
80105c78:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80105c7b:	c9                   	leave  
80105c7c:	c3                   	ret    
...
80105ca1:	e8 1a f1 ff ff       	call   80104dc0 <argint>
80105ca6:	83 c4 10             	add    $0x10,%esp
80105ca9:	85 c0                	test   %eax,%eax
80105cab:	0f 88 86 00 00 00    	js     80105d37 <sys_sleep+0xa7>
    return -1;
  acquire(&tickslock);
80105cb1:	83 ec 0c             	sub    $0xc,%esp
80105cb4:	68 c0 6d 11 80       	push   $0x80116dc0
80105cb9:	e8 12 ed ff ff       	call   801049d0 <acquire>
  ticks0 = ticks;
  while(ticks - ticks0 < n){
80105cbe:	8b 55 f4             	mov    -0xc(%ebp),%edx
  ticks0 = ticks;
80105cc1:	8b 1d 00 76 11 80    	mov    0x80117600,%ebx
  while(ticks - ticks0 < n){
80105cc7:	83 c4 10             	add    $0x10,%esp
80105cca:	85 d2                	test   %edx,%edx
80105ccc:	75 23                	jne    80105cf1 <sys_sleep+0x61>
80105cce:	eb 50                	jmp    80105d20 <sys_sleep+0x90>
    if(myproc()->killed){
      release(&tickslock);
      return -1;
    }
...
80105cd3:	68 c0 6d 11 80       	push   $0x80116dc0
80105cd8:	68 00 76 11 80       	push   $0x80117600
80105cdd:	e8 6e e3 ff ff       	call   80104050 <sleep>
  while(ticks - ticks0 < n){
80105ce2:	a1 00 76 11 80       	mov    0x80117600,%eax
...
80105d00:	68 c0 6d 11 80       	push   $0x80116dc0
80105d05:	e8 86 ed ff ff       	call   80104a90 <release>
  }
  release(&tickslock);
  return 0;
}
...
80105d23:	68 c0 6d 11 80       	push   $0x80116dc0
80105d28:	e8 63 ed ff ff       	call   80104a90 <release>
  return 0;
...
80105d48:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
80105d4b:	68 c0 6d 11 80       	push   $0x80116dc0
80105d50:	e8 7b ec ff ff       	call   801049d0 <acquire>
  xticks = ticks;
80105d55:	8b 1d 00 76 11 80    	mov    0x80117600,%ebx
  release(&tickslock);
80105d5b:	c7 04 24 c0 6d 11 80 	movl   $0x80116dc0,(%esp)
80105d62:	e8 29 ed ff ff       	call   80104a90 <release>
  return xticks;
}
80105d67:	89 d8                	mov    %ebx,%eax
80105d69:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80105d6c:	c9                   	leave  
80105d6d:	c3                   	ret    
...
80105d82:	83 c0 7c             	add    $0x7c,%eax
80105d85:	50                   	push   %eax
80105d86:	6a 00                	push   $0x0
80105d88:	e8 33 f0 ff ff       	call   80104dc0 <argint>
    return -1;
...
80105daa:	e8 c1 db ff ff       	call   80103970 <myproc>
  return aux;
80105daf:	8b 80 80 00 00 00    	mov    0x80(%eax),%eax
}
80105db5:	c9                   	leave  
80105db6:	c3                   	ret    
...
80105dd0:	e8 eb ef ff ff       	call   80104dc0 <argint>
80105dd5:	83 c4 10             	add    $0x10,%esp
80105dd8:	85 c0                	test   %eax,%eax
80105dda:	78 14                	js     80105df0 <sys_set_tickets+0x30>
    return -1;

  myproc()->tickets = n;
80105ddc:	e8 8f db ff ff       	call   80103970 <myproc>
80105de1:	89 c2                	mov    %eax,%edx
80105de3:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105de6:	89 82 88 00 00 00    	mov    %eax,0x88(%edx)
...
80105e07:	e8 c4 00 00 00       	call   80105ed0 <trap>
...
80105e30:	8b 14 85 84 b0 10 80 	mov    -0x7fef4f7c(,%eax,4),%edx
80105e37:	c7 04 c5 02 6e 11 80 	movl   $0x8e000008,-0x7fee91fe(,%eax,8)
80105e3e:	08 00 00 8e 
80105e42:	66 89 14 c5 00 6e 11 	mov    %dx,-0x7fee9200(,%eax,8)
80105e49:	80 
80105e4a:	c1 ea 10             	shr    $0x10,%edx
80105e4d:	66 89 14 c5 06 6e 11 	mov    %dx,-0x7fee91fa(,%eax,8)
80105e54:	80 
  for(i = 0; i < 256; i++)
...
80105e5f:	83 ec 08             	sub    $0x8,%esp
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105e62:	a1 84 b1 10 80       	mov    0x8010b184,%eax
80105e67:	c7 05 02 70 11 80 08 	movl   $0xef000008,0x80117002
80105e6e:	00 00 ef 
  initlock(&tickslock, "time");
80105e71:	68 6f 7d 10 80       	push   $0x80107d6f
80105e76:	68 c0 6d 11 80       	push   $0x80116dc0
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105e7b:	66 a3 00 70 11 80    	mov    %ax,0x80117000
80105e81:	c1 e8 10             	shr    $0x10,%eax
80105e84:	66 a3 06 70 11 80    	mov    %ax,0x80117006
  initlock(&tickslock, "time");
80105e8a:	e8 c1 e9 ff ff       	call   80104850 <initlock>
}
...
80105eaf:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
80105eb3:	b8 00 6e 11 80       	mov    $0x80116e00,%eax
...
80105ee6:	0f 84 c4 01 00 00    	je     801060b0 <trap+0x1e0>
    if(myproc()->killed)
      exit();
    return;
  }
...
80105ef4:	3e ff 24 85 4c 7f 10 	notrack jmp *-0x7fef80b4(,%eax,4)
80105efb:	80 
    lapiceoi();
    break;
...
80105efc:	e8 6f da ff ff       	call   80103970 <myproc>
80105f01:	8b 7b 38             	mov    0x38(%ebx),%edi
80105f04:	85 c0                	test   %eax,%eax
80105f06:	0f 84 f3 01 00 00    	je     801060ff <trap+0x22f>
80105f0c:	f6 43 3c 03          	testb  $0x3,0x3c(%ebx)
80105f10:	0f 84 e9 01 00 00    	je     801060ff <trap+0x22f>
...
80105f1c:	e8 2f da ff ff       	call   80103950 <cpuid>
...
80105f2d:	e8 3e da ff ff       	call   80103970 <myproc>
80105f32:	89 45 e0             	mov    %eax,-0x20(%ebp)
80105f35:	e8 36 da ff ff       	call   80103970 <myproc>
    cprintf("pid %d %s: trap %d err %d on cpu %d "
...
80105f51:	68 08 7f 10 80       	push   $0x80107f08
80105f56:	e8 55 a7 ff ff       	call   801006b0 <cprintf>
            tf->err, cpuid(), tf->eip, rcr2());
    myproc()->killed = 1;
80105f5b:	83 c4 20             	add    $0x20,%esp
80105f5e:	e8 0d da ff ff       	call   80103970 <myproc>
...
80105f8a:	0f 84 58 01 00 00    	je     801060e8 <trap+0x218>
    exit();
...
80105fa2:	0f 84 f0 00 00 00    	je     80106098 <trap+0x1c8>
...
80105fc8:	0f 84 0b 01 00 00    	je     801060d9 <trap+0x209>
    exit();
}
...
80105fd5:	c3                   	ret    
    ideintr();
80105fd6:	e8 05 c2 ff ff       	call   801021e0 <ideintr>
    lapiceoi();
80105fdb:	e8 e0 c8 ff ff       	call   801028c0 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
...
80105fe9:	eb a5                	jmp    80105f90 <trap+0xc0>
    if(cpuid() == 0){
80105feb:	e8 60 d9 ff ff       	call   80103950 <cpuid>
80105ff0:	85 c0                	test   %eax,%eax
80105ff2:	75 e7                	jne    80105fdb <trap+0x10b>
      acquire(&tickslock);
80105ff4:	83 ec 0c             	sub    $0xc,%esp
80105ff7:	68 c0 6d 11 80       	push   $0x80116dc0
80105ffc:	e8 cf e9 ff ff       	call   801049d0 <acquire>
      ticks++;
80106001:	83 05 00 76 11 80 01 	addl   $0x1,0x80117600
      contarprocessos(); //count procs
80106008:	e8 43 dc ff ff       	call   80103c50 <contarprocessos>
      wakeup(&ticks);
8010600d:	c7 04 24 00 76 11 80 	movl   $0x80117600,(%esp)
80106014:	e8 47 e3 ff ff       	call   80104360 <wakeup>
      release(&tickslock);
80106019:	c7 04 24 c0 6d 11 80 	movl   $0x80116dc0,(%esp)
80106020:	e8 6b ea ff ff       	call   80104a90 <release>
80106025:	83 c4 10             	add    $0x10,%esp
    lapiceoi();
80106028:	eb b1                	jmp    80105fdb <trap+0x10b>
    kbdintr();
8010602a:	e8 51 c7 ff ff       	call   80102780 <kbdintr>
    lapiceoi();
8010602f:	e8 8c c8 ff ff       	call   801028c0 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80106034:	e8 37 d9 ff ff       	call   80103970 <myproc>
80106039:	85 c0                	test   %eax,%eax
8010603b:	0f 85 32 ff ff ff    	jne    80105f73 <trap+0xa3>
80106041:	e9 4a ff ff ff       	jmp    80105f90 <trap+0xc0>
    uartintr();
80106046:	e8 55 02 00 00       	call   801062a0 <uartintr>
    lapiceoi();
8010604b:	e8 70 c8 ff ff       	call   801028c0 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80106050:	e8 1b d9 ff ff       	call   80103970 <myproc>
80106055:	85 c0                	test   %eax,%eax
80106057:	0f 85 16 ff ff ff    	jne    80105f73 <trap+0xa3>
8010605d:	e9 2e ff ff ff       	jmp    80105f90 <trap+0xc0>
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
80106062:	8b 7b 38             	mov    0x38(%ebx),%edi
80106065:	0f b7 73 3c          	movzwl 0x3c(%ebx),%esi
80106069:	e8 e2 d8 ff ff       	call   80103950 <cpuid>
8010606e:	57                   	push   %edi
8010606f:	56                   	push   %esi
80106070:	50                   	push   %eax
80106071:	68 b0 7e 10 80       	push   $0x80107eb0
80106076:	e8 35 a6 ff ff       	call   801006b0 <cprintf>
    lapiceoi();
8010607b:	e8 40 c8 ff ff       	call   801028c0 <lapiceoi>
    break;
80106080:	83 c4 10             	add    $0x10,%esp
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80106083:	e8 e8 d8 ff ff       	call   80103970 <myproc>
80106088:	85 c0                	test   %eax,%eax
8010608a:	0f 85 e3 fe ff ff    	jne    80105f73 <trap+0xa3>
80106090:	e9 fb fe ff ff       	jmp    80105f90 <trap+0xc0>
80106095:	8d 76 00             	lea    0x0(%esi),%esi
  if(myproc() && myproc()->state == RUNNING &&
80106098:	83 7b 30 20          	cmpl   $0x20,0x30(%ebx)
8010609c:	0f 85 06 ff ff ff    	jne    80105fa8 <trap+0xd8>
    yield();
801060a2:	e8 39 df ff ff       	call   80103fe0 <yield>
801060a7:	e9 fc fe ff ff       	jmp    80105fa8 <trap+0xd8>
...
801060ba:	75 3c                	jne    801060f8 <trap+0x228>
    myproc()->tf = tf;
801060bc:	e8 af d8 ff ff       	call   80103970 <myproc>
801060c1:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
801060c4:	e8 e7 ed ff ff       	call   80104eb0 <syscall>
    if(myproc()->killed)
801060c9:	e8 a2 d8 ff ff       	call   80103970 <myproc>
801060ce:	8b 48 24             	mov    0x24(%eax),%ecx
801060d1:	85 c9                	test   %ecx,%ecx
801060d3:	0f 84 f5 fe ff ff    	je     80105fce <trap+0xfe>
}
801060d9:	8d 65 f4             	lea    -0xc(%ebp),%esp
801060dc:	5b                   	pop    %ebx
801060dd:	5e                   	pop    %esi
801060de:	5f                   	pop    %edi
801060df:	5d                   	pop    %ebp
      exit();
801060e0:	e9 bb dd ff ff       	jmp    80103ea0 <exit>
801060e5:	8d 76 00             	lea    0x0(%esi),%esi
    exit();
801060e8:	e8 b3 dd ff ff       	call   80103ea0 <exit>
801060ed:	e9 9e fe ff ff       	jmp    80105f90 <trap+0xc0>
801060f2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      exit();
801060f8:	e8 a3 dd ff ff       	call   80103ea0 <exit>
801060fd:	eb bd                	jmp    801060bc <trap+0x1ec>
801060ff:	0f 20 d6             	mov    %cr2,%esi
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80106102:	e8 49 d8 ff ff       	call   80103950 <cpuid>
80106107:	83 ec 0c             	sub    $0xc,%esp
8010610a:	56                   	push   %esi
8010610b:	57                   	push   %edi
8010610c:	50                   	push   %eax
8010610d:	ff 73 30             	pushl  0x30(%ebx)
80106110:	68 d4 7e 10 80       	push   $0x80107ed4
80106115:	e8 96 a5 ff ff       	call   801006b0 <cprintf>
      panic("trap");
8010611a:	83 c4 14             	add    $0x14,%esp
8010611d:	68 a9 7e 10 80       	push   $0x80107ea9
80106122:	e8 69 a2 ff ff       	call   80100390 <panic>
...
80106130:	f3 0f 1e fb          	endbr32 
  if(!uart)
80106134:	a1 00 c0 10 80       	mov    0x8010c000,%eax
80106139:	85 c0                	test   %eax,%eax
8010613b:	74 1b                	je     80106158 <uartgetc+0x28>
  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
8010613d:	ba fd 03 00 00       	mov    $0x3fd,%edx
80106142:	ec                   	in     (%dx),%al
    return -1;
  if(!(inb(COM1+5) & 0x01))
80106143:	a8 01                	test   $0x1,%al
80106145:	74 11                	je     80106158 <uartgetc+0x28>
80106147:	ba f8 03 00 00       	mov    $0x3f8,%edx
8010614c:	ec                   	in     (%dx),%al
    return -1;
  return inb(COM1+0);
8010614d:	0f b6 c0             	movzbl %al,%eax
80106150:	c3                   	ret    
...
80106164:	89 c7                	mov    %eax,%edi
80106166:	56                   	push   %esi
80106167:	be fd 03 00 00       	mov    $0x3fd,%esi
8010616c:	53                   	push   %ebx
8010616d:	bb 80 00 00 00       	mov    $0x80,%ebx
...
80106185:	e8 56 c7 ff ff       	call   801028e0 <microdelay>
...
801061b5:	31 c9                	xor    %ecx,%ecx
801061b7:	89 c8                	mov    %ecx,%eax
801061b9:	89 e5                	mov    %esp,%ebp
801061bb:	57                   	push   %edi
801061bc:	56                   	push   %esi
801061bd:	53                   	push   %ebx
801061be:	bb fa 03 00 00       	mov    $0x3fa,%ebx
801061c3:	89 da                	mov    %ebx,%edx
801061c5:	83 ec 0c             	sub    $0xc,%esp
801061c8:	ee                   	out    %al,(%dx)
801061c9:	bf fb 03 00 00       	mov    $0x3fb,%edi
801061ce:	b8 80 ff ff ff       	mov    $0xffffff80,%eax
801061d3:	89 fa                	mov    %edi,%edx
801061d5:	ee                   	out    %al,(%dx)
801061d6:	b8 0c 00 00 00       	mov    $0xc,%eax
801061db:	ba f8 03 00 00       	mov    $0x3f8,%edx
801061e0:	ee                   	out    %al,(%dx)
801061e1:	be f9 03 00 00       	mov    $0x3f9,%esi
801061e6:	89 c8                	mov    %ecx,%eax
801061e8:	89 f2                	mov    %esi,%edx
801061ea:	ee                   	out    %al,(%dx)
801061eb:	b8 03 00 00 00       	mov    $0x3,%eax
801061f0:	89 fa                	mov    %edi,%edx
801061f2:	ee                   	out    %al,(%dx)
801061f3:	ba fc 03 00 00       	mov    $0x3fc,%edx
801061f8:	89 c8                	mov    %ecx,%eax
801061fa:	ee                   	out    %al,(%dx)
801061fb:	b8 01 00 00 00       	mov    $0x1,%eax
80106200:	89 f2                	mov    %esi,%edx
80106202:	ee                   	out    %al,(%dx)
  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
80106203:	ba fd 03 00 00       	mov    $0x3fd,%edx
80106208:	ec                   	in     (%dx),%al
  if(inb(COM1+5) == 0xFF)
80106209:	3c ff                	cmp    $0xff,%al
8010620b:	74 52                	je     8010625f <uartinit+0xaf>
  uart = 1;
8010620d:	c7 05 00 c0 10 80 01 	movl   $0x1,0x8010c000
80106214:	00 00 00 
80106217:	89 da                	mov    %ebx,%edx
80106219:	ec                   	in     (%dx),%al
8010621a:	ba f8 03 00 00       	mov    $0x3f8,%edx
8010621f:	ec                   	in     (%dx),%al
  ioapicenable(IRQ_COM1, 0);
80106220:	83 ec 08             	sub    $0x8,%esp
80106223:	be 76 00 00 00       	mov    $0x76,%esi
  for(p="xv6...\n"; *p; p++)
80106228:	bb cc 7f 10 80       	mov    $0x80107fcc,%ebx
  ioapicenable(IRQ_COM1, 0);
8010622d:	6a 00                	push   $0x0
8010622f:	6a 04                	push   $0x4
80106231:	e8 fa c1 ff ff       	call   80102430 <ioapicenable>
80106236:	83 c4 10             	add    $0x10,%esp
  for(p="xv6...\n"; *p; p++)
80106239:	b8 78 00 00 00       	mov    $0x78,%eax
8010623e:	eb 04                	jmp    80106244 <uartinit+0x94>
80106240:	0f b6 73 01          	movzbl 0x1(%ebx),%esi
  if(!uart)
80106244:	8b 15 00 c0 10 80    	mov    0x8010c000,%edx
8010624a:	85 d2                	test   %edx,%edx
8010624c:	74 08                	je     80106256 <uartinit+0xa6>
    uartputc(*p);
8010624e:	0f be c0             	movsbl %al,%eax
80106251:	e8 0a ff ff ff       	call   80106160 <uartputc.part.0>
  for(p="xv6...\n"; *p; p++)
80106256:	89 f0                	mov    %esi,%eax
80106258:	83 c3 01             	add    $0x1,%ebx
8010625b:	84 c0                	test   %al,%al
8010625d:	75 e1                	jne    80106240 <uartinit+0x90>
}
8010625f:	8d 65 f4             	lea    -0xc(%ebp),%esp
80106262:	5b                   	pop    %ebx
80106263:	5e                   	pop    %esi
80106264:	5f                   	pop    %edi
80106265:	5d                   	pop    %ebp
...
80106274:	55                   	push   %ebp
  if(!uart)
80106275:	8b 15 00 c0 10 80    	mov    0x8010c000,%edx
{
8010627b:	89 e5                	mov    %esp,%ebp
8010627d:	8b 45 08             	mov    0x8(%ebp),%eax
  if(!uart)
80106280:	85 d2                	test   %edx,%edx
80106282:	74 0c                	je     80106290 <uartputc+0x20>
}
80106284:	5d                   	pop    %ebp
80106285:	e9 d6 fe ff ff       	jmp    80106160 <uartputc.part.0>
...
801062a7:	83 ec 14             	sub    $0x14,%esp
  consoleintr(uartgetc);
801062aa:	68 30 61 10 80       	push   $0x80106130
801062af:	e8 ac a5 ff ff       	call   80100860 <consoleintr>
}
...
801062bb:	6a 00                	push   $0x0
  jmp alltraps
801062bd:	e9 35 fb ff ff       	jmp    80105df7 <alltraps>
...
801062c4:	6a 01                	push   $0x1
  jmp alltraps
801062c6:	e9 2c fb ff ff       	jmp    80105df7 <alltraps>
...
801062cb:	6a 00                	push   $0x0
  pushl $2
801062cd:	6a 02                	push   $0x2
  jmp alltraps
801062cf:	e9 23 fb ff ff       	jmp    80105df7 <alltraps>
...
801062d6:	6a 03                	push   $0x3
  jmp alltraps
801062d8:	e9 1a fb ff ff       	jmp    80105df7 <alltraps>
...
801062dd:	6a 00                	push   $0x0
  pushl $4
801062df:	6a 04                	push   $0x4
  jmp alltraps
801062e1:	e9 11 fb ff ff       	jmp    80105df7 <alltraps>
...
801062e6:	6a 00                	push   $0x0
  pushl $5
801062e8:	6a 05                	push   $0x5
  jmp alltraps
801062ea:	e9 08 fb ff ff       	jmp    80105df7 <alltraps>
...
801062f1:	6a 06                	push   $0x6
  jmp alltraps
801062f3:	e9 ff fa ff ff       	jmp    80105df7 <alltraps>
...
801062f8:	6a 00                	push   $0x0
  pushl $7
801062fa:	6a 07                	push   $0x7
  jmp alltraps
801062fc:	e9 f6 fa ff ff       	jmp    80105df7 <alltraps>

80106301 <vector8>:
.globl vector8
vector8:
  pushl $8
80106301:	6a 08                	push   $0x8
  jmp alltraps
80106303:	e9 ef fa ff ff       	jmp    80105df7 <alltraps>
...
80106308:	6a 00                	push   $0x0
  pushl $9
8010630a:	6a 09                	push   $0x9
  jmp alltraps
8010630c:	e9 e6 fa ff ff       	jmp    80105df7 <alltraps>

80106311 <vector10>:
.globl vector10
vector10:
  pushl $10
80106311:	6a 0a                	push   $0xa
  jmp alltraps
80106313:	e9 df fa ff ff       	jmp    80105df7 <alltraps>

80106318 <vector11>:
.globl vector11
vector11:
  pushl $11
80106318:	6a 0b                	push   $0xb
  jmp alltraps
8010631a:	e9 d8 fa ff ff       	jmp    80105df7 <alltraps>

8010631f <vector12>:
.globl vector12
vector12:
  pushl $12
8010631f:	6a 0c                	push   $0xc
  jmp alltraps
80106321:	e9 d1 fa ff ff       	jmp    80105df7 <alltraps>

80106326 <vector13>:
.globl vector13
vector13:
  pushl $13
80106326:	6a 0d                	push   $0xd
  jmp alltraps
80106328:	e9 ca fa ff ff       	jmp    80105df7 <alltraps>

8010632d <vector14>:
.globl vector14
vector14:
  pushl $14
8010632d:	6a 0e                	push   $0xe
  jmp alltraps
8010632f:	e9 c3 fa ff ff       	jmp    80105df7 <alltraps>
...
80106334:	6a 00                	push   $0x0
  pushl $15
80106336:	6a 0f                	push   $0xf
  jmp alltraps
80106338:	e9 ba fa ff ff       	jmp    80105df7 <alltraps>
...
8010633d:	6a 00                	push   $0x0
  pushl $16
8010633f:	6a 10                	push   $0x10
  jmp alltraps
80106341:	e9 b1 fa ff ff       	jmp    80105df7 <alltraps>

80106346 <vector17>:
.globl vector17
vector17:
  pushl $17
80106346:	6a 11                	push   $0x11
  jmp alltraps
80106348:	e9 aa fa ff ff       	jmp    80105df7 <alltraps>
...
8010634d:	6a 00                	push   $0x0
  pushl $18
8010634f:	6a 12                	push   $0x12
  jmp alltraps
80106351:	e9 a1 fa ff ff       	jmp    80105df7 <alltraps>
...
80106356:	6a 00                	push   $0x0
  pushl $19
80106358:	6a 13                	push   $0x13
  jmp alltraps
8010635a:	e9 98 fa ff ff       	jmp    80105df7 <alltraps>
...
8010635f:	6a 00                	push   $0x0
  pushl $20
80106361:	6a 14                	push   $0x14
  jmp alltraps
80106363:	e9 8f fa ff ff       	jmp    80105df7 <alltraps>
...
80106368:	6a 00                	push   $0x0
  pushl $21
8010636a:	6a 15                	push   $0x15
  jmp alltraps
8010636c:	e9 86 fa ff ff       	jmp    80105df7 <alltraps>
...
80106371:	6a 00                	push   $0x0
  pushl $22
80106373:	6a 16                	push   $0x16
  jmp alltraps
80106375:	e9 7d fa ff ff       	jmp    80105df7 <alltraps>
...
8010637a:	6a 00                	push   $0x0
  pushl $23
8010637c:	6a 17                	push   $0x17
  jmp alltraps
8010637e:	e9 74 fa ff ff       	jmp    80105df7 <alltraps>
...
80106383:	6a 00                	push   $0x0
  pushl $24
80106385:	6a 18                	push   $0x18
  jmp alltraps
80106387:	e9 6b fa ff ff       	jmp    80105df7 <alltraps>
...
8010638c:	6a 00                	push   $0x0
  pushl $25
8010638e:	6a 19                	push   $0x19
  jmp alltraps
80106390:	e9 62 fa ff ff       	jmp    80105df7 <alltraps>
...
80106395:	6a 00                	push   $0x0
  pushl $26
80106397:	6a 1a                	push   $0x1a
  jmp alltraps
80106399:	e9 59 fa ff ff       	jmp    80105df7 <alltraps>
...
8010639e:	6a 00                	push   $0x0
  pushl $27
801063a0:	6a 1b                	push   $0x1b
  jmp alltraps
801063a2:	e9 50 fa ff ff       	jmp    80105df7 <alltraps>
...
801063a7:	6a 00                	push   $0x0
  pushl $28
801063a9:	6a 1c                	push   $0x1c
  jmp alltraps
801063ab:	e9 47 fa ff ff       	jmp    80105df7 <alltraps>
...
801063b0:	6a 00                	push   $0x0
  pushl $29
801063b2:	6a 1d                	push   $0x1d
  jmp alltraps
801063b4:	e9 3e fa ff ff       	jmp    80105df7 <alltraps>
...
801063b9:	6a 00                	push   $0x0
  pushl $30
801063bb:	6a 1e                	push   $0x1e
  jmp alltraps
801063bd:	e9 35 fa ff ff       	jmp    80105df7 <alltraps>
...
801063c2:	6a 00                	push   $0x0
  pushl $31
801063c4:	6a 1f                	push   $0x1f
  jmp alltraps
801063c6:	e9 2c fa ff ff       	jmp    80105df7 <alltraps>
...
801063cb:	6a 00                	push   $0x0
  pushl $32
801063cd:	6a 20                	push   $0x20
  jmp alltraps
801063cf:	e9 23 fa ff ff       	jmp    80105df7 <alltraps>
...
801063d4:	6a 00                	push   $0x0
  pushl $33
801063d6:	6a 21                	push   $0x21
  jmp alltraps
801063d8:	e9 1a fa ff ff       	jmp    80105df7 <alltraps>
...
801063dd:	6a 00                	push   $0x0
  pushl $34
801063df:	6a 22                	push   $0x22
  jmp alltraps
801063e1:	e9 11 fa ff ff       	jmp    80105df7 <alltraps>
...
801063e6:	6a 00                	push   $0x0
  pushl $35
801063e8:	6a 23                	push   $0x23
  jmp alltraps
801063ea:	e9 08 fa ff ff       	jmp    80105df7 <alltraps>
...
801063ef:	6a 00                	push   $0x0
  pushl $36
801063f1:	6a 24                	push   $0x24
  jmp alltraps
801063f3:	e9 ff f9 ff ff       	jmp    80105df7 <alltraps>
...
801063f8:	6a 00                	push   $0x0
  pushl $37
801063fa:	6a 25                	push   $0x25
  jmp alltraps
801063fc:	e9 f6 f9 ff ff       	jmp    80105df7 <alltraps>
...
80106401:	6a 00                	push   $0x0
  pushl $38
80106403:	6a 26                	push   $0x26
  jmp alltraps
80106405:	e9 ed f9 ff ff       	jmp    80105df7 <alltraps>
...
8010640a:	6a 00                	push   $0x0
  pushl $39
8010640c:	6a 27                	push   $0x27
  jmp alltraps
8010640e:	e9 e4 f9 ff ff       	jmp    80105df7 <alltraps>
...
80106413:	6a 00                	push   $0x0
  pushl $40
80106415:	6a 28                	push   $0x28
  jmp alltraps
80106417:	e9 db f9 ff ff       	jmp    80105df7 <alltraps>
...
8010641c:	6a 00                	push   $0x0
  pushl $41
8010641e:	6a 29                	push   $0x29
  jmp alltraps
80106420:	e9 d2 f9 ff ff       	jmp    80105df7 <alltraps>
...
80106425:	6a 00                	push   $0x0
  pushl $42
80106427:	6a 2a                	push   $0x2a
  jmp alltraps
80106429:	e9 c9 f9 ff ff       	jmp    80105df7 <alltraps>
...
8010642e:	6a 00                	push   $0x0
  pushl $43
80106430:	6a 2b                	push   $0x2b
  jmp alltraps
80106432:	e9 c0 f9 ff ff       	jmp    80105df7 <alltraps>
...
80106437:	6a 00                	push   $0x0
  pushl $44
80106439:	6a 2c                	push   $0x2c
  jmp alltraps
8010643b:	e9 b7 f9 ff ff       	jmp    80105df7 <alltraps>
...
80106440:	6a 00                	push   $0x0
  pushl $45
80106442:	6a 2d                	push   $0x2d
  jmp alltraps
80106444:	e9 ae f9 ff ff       	jmp    80105df7 <alltraps>
...
80106449:	6a 00                	push   $0x0
  pushl $46
8010644b:	6a 2e                	push   $0x2e
  jmp alltraps
8010644d:	e9 a5 f9 ff ff       	jmp    80105df7 <alltraps>
...
80106452:	6a 00                	push   $0x0
  pushl $47
80106454:	6a 2f                	push   $0x2f
  jmp alltraps
80106456:	e9 9c f9 ff ff       	jmp    80105df7 <alltraps>
...
8010645b:	6a 00                	push   $0x0
  pushl $48
8010645d:	6a 30                	push   $0x30
  jmp alltraps
8010645f:	e9 93 f9 ff ff       	jmp    80105df7 <alltraps>
...
80106464:	6a 00                	push   $0x0
  pushl $49
80106466:	6a 31                	push   $0x31
  jmp alltraps
80106468:	e9 8a f9 ff ff       	jmp    80105df7 <alltraps>
...
8010646d:	6a 00                	push   $0x0
  pushl $50
8010646f:	6a 32                	push   $0x32
  jmp alltraps
80106471:	e9 81 f9 ff ff       	jmp    80105df7 <alltraps>
...
80106476:	6a 00                	push   $0x0
  pushl $51
80106478:	6a 33                	push   $0x33
  jmp alltraps
8010647a:	e9 78 f9 ff ff       	jmp    80105df7 <alltraps>
...
8010647f:	6a 00                	push   $0x0
  pushl $52
80106481:	6a 34                	push   $0x34
  jmp alltraps
80106483:	e9 6f f9 ff ff       	jmp    80105df7 <alltraps>
...
80106488:	6a 00                	push   $0x0
  pushl $53
8010648a:	6a 35                	push   $0x35
  jmp alltraps
8010648c:	e9 66 f9 ff ff       	jmp    80105df7 <alltraps>
...
80106491:	6a 00                	push   $0x0
  pushl $54
80106493:	6a 36                	push   $0x36
  jmp alltraps
80106495:	e9 5d f9 ff ff       	jmp    80105df7 <alltraps>
...
8010649a:	6a 00                	push   $0x0
  pushl $55
8010649c:	6a 37                	push   $0x37
  jmp alltraps
8010649e:	e9 54 f9 ff ff       	jmp    80105df7 <alltraps>
...
801064a3:	6a 00                	push   $0x0
  pushl $56
801064a5:	6a 38                	push   $0x38
  jmp alltraps
801064a7:	e9 4b f9 ff ff       	jmp    80105df7 <alltraps>
...
801064ac:	6a 00                	push   $0x0
  pushl $57
801064ae:	6a 39                	push   $0x39
  jmp alltraps
801064b0:	e9 42 f9 ff ff       	jmp    80105df7 <alltraps>
...
801064b5:	6a 00                	push   $0x0
  pushl $58
801064b7:	6a 3a                	push   $0x3a
  jmp alltraps
801064b9:	e9 39 f9 ff ff       	jmp    80105df7 <alltraps>
...
801064be:	6a 00                	push   $0x0
  pushl $59
801064c0:	6a 3b                	push   $0x3b
  jmp alltraps
801064c2:	e9 30 f9 ff ff       	jmp    80105df7 <alltraps>
...
801064c7:	6a 00                	push   $0x0
  pushl $60
801064c9:	6a 3c                	push   $0x3c
  jmp alltraps
801064cb:	e9 27 f9 ff ff       	jmp    80105df7 <alltraps>
...
801064d9:	6a 00                	push   $0x0
  pushl $62
801064db:	6a 3e                	push   $0x3e
  jmp alltraps
801064dd:	e9 15 f9 ff ff       	jmp    80105df7 <alltraps>
...
801064e2:	6a 00                	push   $0x0
  pushl $63
801064e4:	6a 3f                	push   $0x3f
  jmp alltraps
801064e6:	e9 0c f9 ff ff       	jmp    80105df7 <alltraps>
...
801064eb:	6a 00                	push   $0x0
  pushl $64
801064ed:	6a 40                	push   $0x40
  jmp alltraps
801064ef:	e9 03 f9 ff ff       	jmp    80105df7 <alltraps>
...
801064f4:	6a 00                	push   $0x0
  pushl $65
801064f6:	6a 41                	push   $0x41
  jmp alltraps
801064f8:	e9 fa f8 ff ff       	jmp    80105df7 <alltraps>
...
801064fd:	6a 00                	push   $0x0
  pushl $66
801064ff:	6a 42                	push   $0x42
  jmp alltraps
80106501:	e9 f1 f8 ff ff       	jmp    80105df7 <alltraps>
...
80106506:	6a 00                	push   $0x0
  pushl $67
80106508:	6a 43                	push   $0x43
  jmp alltraps
8010650a:	e9 e8 f8 ff ff       	jmp    80105df7 <alltraps>
...
8010650f:	6a 00                	push   $0x0
  pushl $68
80106511:	6a 44                	push   $0x44
  jmp alltraps
80106513:	e9 df f8 ff ff       	jmp    80105df7 <alltraps>
...
80106518:	6a 00                	push   $0x0
  pushl $69
8010651a:	6a 45                	push   $0x45
  jmp alltraps
8010651c:	e9 d6 f8 ff ff       	jmp    80105df7 <alltraps>
...
80106521:	6a 00                	push   $0x0
  pushl $70
80106523:	6a 46                	push   $0x46
  jmp alltraps
80106525:	e9 cd f8 ff ff       	jmp    80105df7 <alltraps>
...
8010652a:	6a 00                	push   $0x0
  pushl $71
8010652c:	6a 47                	push   $0x47
  jmp alltraps
8010652e:	e9 c4 f8 ff ff       	jmp    80105df7 <alltraps>
...
80106533:	6a 00                	push   $0x0
  pushl $72
80106535:	6a 48                	push   $0x48
  jmp alltraps
80106537:	e9 bb f8 ff ff       	jmp    80105df7 <alltraps>
...
8010653c:	6a 00                	push   $0x0
  pushl $73
8010653e:	6a 49                	push   $0x49
  jmp alltraps
80106540:	e9 b2 f8 ff ff       	jmp    80105df7 <alltraps>
...
80106545:	6a 00                	push   $0x0
  pushl $74
80106547:	6a 4a                	push   $0x4a
  jmp alltraps
80106549:	e9 a9 f8 ff ff       	jmp    80105df7 <alltraps>
...
8010654e:	6a 00                	push   $0x0
  pushl $75
80106550:	6a 4b                	push   $0x4b
  jmp alltraps
80106552:	e9 a0 f8 ff ff       	jmp    80105df7 <alltraps>
...
80106557:	6a 00                	push   $0x0
  pushl $76
80106559:	6a 4c                	push   $0x4c
  jmp alltraps
8010655b:	e9 97 f8 ff ff       	jmp    80105df7 <alltraps>
...
80106560:	6a 00                	push   $0x0
  pushl $77
80106562:	6a 4d                	push   $0x4d
  jmp alltraps
80106564:	e9 8e f8 ff ff       	jmp    80105df7 <alltraps>
...
80106569:	6a 00                	push   $0x0
  pushl $78
8010656b:	6a 4e                	push   $0x4e
  jmp alltraps
8010656d:	e9 85 f8 ff ff       	jmp    80105df7 <alltraps>
...
80106572:	6a 00                	push   $0x0
  pushl $79
80106574:	6a 4f                	push   $0x4f
  jmp alltraps
80106576:	e9 7c f8 ff ff       	jmp    80105df7 <alltraps>
...
8010657b:	6a 00                	push   $0x0
  pushl $80
8010657d:	6a 50                	push   $0x50
  jmp alltraps
8010657f:	e9 73 f8 ff ff       	jmp    80105df7 <alltraps>
...
80106584:	6a 00                	push   $0x0
  pushl $81
80106586:	6a 51                	push   $0x51
  jmp alltraps
80106588:	e9 6a f8 ff ff       	jmp    80105df7 <alltraps>
...
8010658d:	6a 00                	push   $0x0
  pushl $82
8010658f:	6a 52                	push   $0x52
  jmp alltraps
80106591:	e9 61 f8 ff ff       	jmp    80105df7 <alltraps>
...
80106596:	6a 00                	push   $0x0
  pushl $83
80106598:	6a 53                	push   $0x53
  jmp alltraps
8010659a:	e9 58 f8 ff ff       	jmp    80105df7 <alltraps>
...
8010659f:	6a 00                	push   $0x0
  pushl $84
801065a1:	6a 54                	push   $0x54
  jmp alltraps
801065a3:	e9 4f f8 ff ff       	jmp    80105df7 <alltraps>
...
801065a8:	6a 00                	push   $0x0
  pushl $85
801065aa:	6a 55                	push   $0x55
  jmp alltraps
801065ac:	e9 46 f8 ff ff       	jmp    80105df7 <alltraps>
...
801065b1:	6a 00                	push   $0x0
  pushl $86
801065b3:	6a 56                	push   $0x56
  jmp alltraps
801065b5:	e9 3d f8 ff ff       	jmp    80105df7 <alltraps>
...
801065ba:	6a 00                	push   $0x0
  pushl $87
801065bc:	6a 57                	push   $0x57
  jmp alltraps
801065be:	e9 34 f8 ff ff       	jmp    80105df7 <alltraps>
...
801065c3:	6a 00                	push   $0x0
  pushl $88
801065c5:	6a 58                	push   $0x58
  jmp alltraps
801065c7:	e9 2b f8 ff ff       	jmp    80105df7 <alltraps>
...
801065cc:	6a 00                	push   $0x0
  pushl $89
801065ce:	6a 59                	push   $0x59
  jmp alltraps
801065d0:	e9 22 f8 ff ff       	jmp    80105df7 <alltraps>
...
801065d5:	6a 00                	push   $0x0
  pushl $90
801065d7:	6a 5a                	push   $0x5a
  jmp alltraps
801065d9:	e9 19 f8 ff ff       	jmp    80105df7 <alltraps>
...
801065de:	6a 00                	push   $0x0
  pushl $91
801065e0:	6a 5b                	push   $0x5b
  jmp alltraps
801065e2:	e9 10 f8 ff ff       	jmp    80105df7 <alltraps>
...
801065e7:	6a 00                	push   $0x0
  pushl $92
801065e9:	6a 5c                	push   $0x5c
  jmp alltraps
801065eb:	e9 07 f8 ff ff       	jmp    80105df7 <alltraps>
...
801065f0:	6a 00                	push   $0x0
  pushl $93
801065f2:	6a 5d                	push   $0x5d
  jmp alltraps
801065f4:	e9 fe f7 ff ff       	jmp    80105df7 <alltraps>
...
801065f9:	6a 00                	push   $0x0
  pushl $94
801065fb:	6a 5e                	push   $0x5e
  jmp alltraps
801065fd:	e9 f5 f7 ff ff       	jmp    80105df7 <alltraps>
...
80106602:	6a 00                	push   $0x0
  pushl $95
80106604:	6a 5f                	push   $0x5f
  jmp alltraps
80106606:	e9 ec f7 ff ff       	jmp    80105df7 <alltraps>
...
8010660b:	6a 00                	push   $0x0
  pushl $96
8010660d:	6a 60                	push   $0x60
  jmp alltraps
8010660f:	e9 e3 f7 ff ff       	jmp    80105df7 <alltraps>
...
80106614:	6a 00                	push   $0x0
  pushl $97
80106616:	6a 61                	push   $0x61
  jmp alltraps
80106618:	e9 da f7 ff ff       	jmp    80105df7 <alltraps>
...
8010661d:	6a 00                	push   $0x0
  pushl $98
8010661f:	6a 62                	push   $0x62
  jmp alltraps
80106621:	e9 d1 f7 ff ff       	jmp    80105df7 <alltraps>
...
80106626:	6a 00                	push   $0x0
  pushl $99
80106628:	6a 63                	push   $0x63
  jmp alltraps
8010662a:	e9 c8 f7 ff ff       	jmp    80105df7 <alltraps>
...
8010662f:	6a 00                	push   $0x0
  pushl $100
80106631:	6a 64                	push   $0x64
  jmp alltraps
80106633:	e9 bf f7 ff ff       	jmp    80105df7 <alltraps>
...
80106638:	6a 00                	push   $0x0
  pushl $101
8010663a:	6a 65                	push   $0x65
  jmp alltraps
8010663c:	e9 b6 f7 ff ff       	jmp    80105df7 <alltraps>
...
80106641:	6a 00                	push   $0x0
  pushl $102
80106643:	6a 66                	push   $0x66
  jmp alltraps
80106645:	e9 ad f7 ff ff       	jmp    80105df7 <alltraps>
...
8010664a:	6a 00                	push   $0x0
  pushl $103
8010664c:	6a 67                	push   $0x67
  jmp alltraps
8010664e:	e9 a4 f7 ff ff       	jmp    80105df7 <alltraps>
...
80106653:	6a 00                	push   $0x0
  pushl $104
80106655:	6a 68                	push   $0x68
  jmp alltraps
80106657:	e9 9b f7 ff ff       	jmp    80105df7 <alltraps>
...
8010665c:	6a 00                	push   $0x0
  pushl $105
8010665e:	6a 69                	push   $0x69
  jmp alltraps
80106660:	e9 92 f7 ff ff       	jmp    80105df7 <alltraps>
...
80106665:	6a 00                	push   $0x0
  pushl $106
80106667:	6a 6a                	push   $0x6a
  jmp alltraps
80106669:	e9 89 f7 ff ff       	jmp    80105df7 <alltraps>
...
8010666e:	6a 00                	push   $0x0
  pushl $107
80106670:	6a 6b                	push   $0x6b
  jmp alltraps
80106672:	e9 80 f7 ff ff       	jmp    80105df7 <alltraps>
...
80106677:	6a 00                	push   $0x0
  pushl $108
80106679:	6a 6c                	push   $0x6c
  jmp alltraps
8010667b:	e9 77 f7 ff ff       	jmp    80105df7 <alltraps>
...
80106680:	6a 00                	push   $0x0
  pushl $109
80106682:	6a 6d                	push   $0x6d
  jmp alltraps
80106684:	e9 6e f7 ff ff       	jmp    80105df7 <alltraps>
...
80106689:	6a 00                	push   $0x0
  pushl $110
8010668b:	6a 6e                	push   $0x6e
  jmp alltraps
8010668d:	e9 65 f7 ff ff       	jmp    80105df7 <alltraps>
...
80106692:	6a 00                	push   $0x0
  pushl $111
80106694:	6a 6f                	push   $0x6f
  jmp alltraps
80106696:	e9 5c f7 ff ff       	jmp    80105df7 <alltraps>
...
8010669b:	6a 00                	push   $0x0
  pushl $112
8010669d:	6a 70                	push   $0x70
  jmp alltraps
8010669f:	e9 53 f7 ff ff       	jmp    80105df7 <alltraps>
...
801066a4:	6a 00                	push   $0x0
  pushl $113
801066a6:	6a 71                	push   $0x71
  jmp alltraps
801066a8:	e9 4a f7 ff ff       	jmp    80105df7 <alltraps>
...
801066ad:	6a 00                	push   $0x0
  pushl $114
801066af:	6a 72                	push   $0x72
  jmp alltraps
801066b1:	e9 41 f7 ff ff       	jmp    80105df7 <alltraps>
...
801066b6:	6a 00                	push   $0x0
  pushl $115
801066b8:	6a 73                	push   $0x73
  jmp alltraps
801066ba:	e9 38 f7 ff ff       	jmp    80105df7 <alltraps>
...
801066bf:	6a 00                	push   $0x0
  pushl $116
801066c1:	6a 74                	push   $0x74
  jmp alltraps
801066c3:	e9 2f f7 ff ff       	jmp    80105df7 <alltraps>
...
801066c8:	6a 00                	push   $0x0
  pushl $117
801066ca:	6a 75                	push   $0x75
  jmp alltraps
801066cc:	e9 26 f7 ff ff       	jmp    80105df7 <alltraps>
...
801066d1:	6a 00                	push   $0x0
  pushl $118
801066d3:	6a 76                	push   $0x76
  jmp alltraps
801066d5:	e9 1d f7 ff ff       	jmp    80105df7 <alltraps>
...
801066da:	6a 00                	push   $0x0
  pushl $119
801066dc:	6a 77                	push   $0x77
  jmp alltraps
801066de:	e9 14 f7 ff ff       	jmp    80105df7 <alltraps>
...
801066e3:	6a 00                	push   $0x0
  pushl $120
801066e5:	6a 78                	push   $0x78
  jmp alltraps
801066e7:	e9 0b f7 ff ff       	jmp    80105df7 <alltraps>
...
801066ec:	6a 00                	push   $0x0
  pushl $121
801066ee:	6a 79                	push   $0x79
  jmp alltraps
801066f0:	e9 02 f7 ff ff       	jmp    80105df7 <alltraps>
...
801066f5:	6a 00                	push   $0x0
  pushl $122
801066f7:	6a 7a                	push   $0x7a
  jmp alltraps
801066f9:	e9 f9 f6 ff ff       	jmp    80105df7 <alltraps>
...
801066fe:	6a 00                	push   $0x0
  pushl $123
80106700:	6a 7b                	push   $0x7b
  jmp alltraps
80106702:	e9 f0 f6 ff ff       	jmp    80105df7 <alltraps>
...
80106707:	6a 00                	push   $0x0
  pushl $124
80106709:	6a 7c                	push   $0x7c
  jmp alltraps
8010670b:	e9 e7 f6 ff ff       	jmp    80105df7 <alltraps>
...
80106710:	6a 00                	push   $0x0
  pushl $125
80106712:	6a 7d                	push   $0x7d
  jmp alltraps
80106714:	e9 de f6 ff ff       	jmp    80105df7 <alltraps>
...
80106719:	6a 00                	push   $0x0
  pushl $126
8010671b:	6a 7e                	push   $0x7e
  jmp alltraps
8010671d:	e9 d5 f6 ff ff       	jmp    80105df7 <alltraps>
...
80106722:	6a 00                	push   $0x0
  pushl $127
80106724:	6a 7f                	push   $0x7f
  jmp alltraps
80106726:	e9 cc f6 ff ff       	jmp    80105df7 <alltraps>
...
8010672b:	6a 00                	push   $0x0
  pushl $128
8010672d:	68 80 00 00 00       	push   $0x80
  jmp alltraps
80106732:	e9 c0 f6 ff ff       	jmp    80105df7 <alltraps>
...
80106737:	6a 00                	push   $0x0
  pushl $129
80106739:	68 81 00 00 00       	push   $0x81
  jmp alltraps
8010673e:	e9 b4 f6 ff ff       	jmp    80105df7 <alltraps>
...
80106743:	6a 00                	push   $0x0
  pushl $130
80106745:	68 82 00 00 00       	push   $0x82
  jmp alltraps
8010674a:	e9 a8 f6 ff ff       	jmp    80105df7 <alltraps>
...
8010674f:	6a 00                	push   $0x0
  pushl $131
80106751:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80106756:	e9 9c f6 ff ff       	jmp    80105df7 <alltraps>
...
8010675b:	6a 00                	push   $0x0
  pushl $132
8010675d:	68 84 00 00 00       	push   $0x84
  jmp alltraps
80106762:	e9 90 f6 ff ff       	jmp    80105df7 <alltraps>
...
80106767:	6a 00                	push   $0x0
  pushl $133
80106769:	68 85 00 00 00       	push   $0x85
  jmp alltraps
8010676e:	e9 84 f6 ff ff       	jmp    80105df7 <alltraps>
...
80106773:	6a 00                	push   $0x0
  pushl $134
80106775:	68 86 00 00 00       	push   $0x86
  jmp alltraps
8010677a:	e9 78 f6 ff ff       	jmp    80105df7 <alltraps>
...
8010677f:	6a 00                	push   $0x0
  pushl $135
80106781:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80106786:	e9 6c f6 ff ff       	jmp    80105df7 <alltraps>
...
8010678b:	6a 00                	push   $0x0
  pushl $136
8010678d:	68 88 00 00 00       	push   $0x88
  jmp alltraps
80106792:	e9 60 f6 ff ff       	jmp    80105df7 <alltraps>
...
80106797:	6a 00                	push   $0x0
  pushl $137
80106799:	68 89 00 00 00       	push   $0x89
  jmp alltraps
8010679e:	e9 54 f6 ff ff       	jmp    80105df7 <alltraps>
...
801067a3:	6a 00                	push   $0x0
  pushl $138
801067a5:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
801067aa:	e9 48 f6 ff ff       	jmp    80105df7 <alltraps>
...
801067af:	6a 00                	push   $0x0
  pushl $139
801067b1:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
801067b6:	e9 3c f6 ff ff       	jmp    80105df7 <alltraps>
...
801067bb:	6a 00                	push   $0x0
  pushl $140
801067bd:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
801067c2:	e9 30 f6 ff ff       	jmp    80105df7 <alltraps>
...
801067c7:	6a 00                	push   $0x0
  pushl $141
801067c9:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
801067ce:	e9 24 f6 ff ff       	jmp    80105df7 <alltraps>
...
801067d3:	6a 00                	push   $0x0
  pushl $142
801067d5:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
801067da:	e9 18 f6 ff ff       	jmp    80105df7 <alltraps>
...
801067df:	6a 00                	push   $0x0
  pushl $143
801067e1:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
801067e6:	e9 0c f6 ff ff       	jmp    80105df7 <alltraps>
...
801067eb:	6a 00                	push   $0x0
  pushl $144
801067ed:	68 90 00 00 00       	push   $0x90
  jmp alltraps
801067f2:	e9 00 f6 ff ff       	jmp    80105df7 <alltraps>
...
801067f7:	6a 00                	push   $0x0
  pushl $145
801067f9:	68 91 00 00 00       	push   $0x91
  jmp alltraps
801067fe:	e9 f4 f5 ff ff       	jmp    80105df7 <alltraps>
...
80106803:	6a 00                	push   $0x0
  pushl $146
80106805:	68 92 00 00 00       	push   $0x92
  jmp alltraps
8010680a:	e9 e8 f5 ff ff       	jmp    80105df7 <alltraps>
...
8010680f:	6a 00                	push   $0x0
  pushl $147
80106811:	68 93 00 00 00       	push   $0x93
  jmp alltraps
80106816:	e9 dc f5 ff ff       	jmp    80105df7 <alltraps>
...
8010681b:	6a 00                	push   $0x0
  pushl $148
8010681d:	68 94 00 00 00       	push   $0x94
  jmp alltraps
80106822:	e9 d0 f5 ff ff       	jmp    80105df7 <alltraps>
...
80106827:	6a 00                	push   $0x0
  pushl $149
80106829:	68 95 00 00 00       	push   $0x95
  jmp alltraps
8010682e:	e9 c4 f5 ff ff       	jmp    80105df7 <alltraps>
...
80106833:	6a 00                	push   $0x0
  pushl $150
80106835:	68 96 00 00 00       	push   $0x96
  jmp alltraps
8010683a:	e9 b8 f5 ff ff       	jmp    80105df7 <alltraps>
...
8010683f:	6a 00                	push   $0x0
  pushl $151
80106841:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80106846:	e9 ac f5 ff ff       	jmp    80105df7 <alltraps>
...
8010684b:	6a 00                	push   $0x0
  pushl $152
8010684d:	68 98 00 00 00       	push   $0x98
  jmp alltraps
80106852:	e9 a0 f5 ff ff       	jmp    80105df7 <alltraps>
...
80106857:	6a 00                	push   $0x0
  pushl $153
80106859:	68 99 00 00 00       	push   $0x99
  jmp alltraps
8010685e:	e9 94 f5 ff ff       	jmp    80105df7 <alltraps>
...
80106863:	6a 00                	push   $0x0
  pushl $154
80106865:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
8010686a:	e9 88 f5 ff ff       	jmp    80105df7 <alltraps>
...
8010686f:	6a 00                	push   $0x0
  pushl $155
80106871:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80106876:	e9 7c f5 ff ff       	jmp    80105df7 <alltraps>
...
8010687b:	6a 00                	push   $0x0
  pushl $156
8010687d:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
80106882:	e9 70 f5 ff ff       	jmp    80105df7 <alltraps>
...
80106887:	6a 00                	push   $0x0
  pushl $157
80106889:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
8010688e:	e9 64 f5 ff ff       	jmp    80105df7 <alltraps>
...
80106893:	6a 00                	push   $0x0
  pushl $158
80106895:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
8010689a:	e9 58 f5 ff ff       	jmp    80105df7 <alltraps>
...
8010689f:	6a 00                	push   $0x0
  pushl $159
801068a1:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
801068a6:	e9 4c f5 ff ff       	jmp    80105df7 <alltraps>
...
801068ab:	6a 00                	push   $0x0
  pushl $160
801068ad:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
801068b2:	e9 40 f5 ff ff       	jmp    80105df7 <alltraps>
...
801068b7:	6a 00                	push   $0x0
  pushl $161
801068b9:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
801068be:	e9 34 f5 ff ff       	jmp    80105df7 <alltraps>
...
801068c3:	6a 00                	push   $0x0
  pushl $162
801068c5:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
801068ca:	e9 28 f5 ff ff       	jmp    80105df7 <alltraps>
...
801068cf:	6a 00                	push   $0x0
  pushl $163
801068d1:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
801068d6:	e9 1c f5 ff ff       	jmp    80105df7 <alltraps>
...
801068db:	6a 00                	push   $0x0
  pushl $164
801068dd:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
801068e2:	e9 10 f5 ff ff       	jmp    80105df7 <alltraps>
...
801068e7:	6a 00                	push   $0x0
  pushl $165
801068e9:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
801068ee:	e9 04 f5 ff ff       	jmp    80105df7 <alltraps>
...
801068f3:	6a 00                	push   $0x0
  pushl $166
801068f5:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
801068fa:	e9 f8 f4 ff ff       	jmp    80105df7 <alltraps>
...
801068ff:	6a 00                	push   $0x0
  pushl $167
80106901:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
80106906:	e9 ec f4 ff ff       	jmp    80105df7 <alltraps>
...
8010690b:	6a 00                	push   $0x0
  pushl $168
8010690d:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
80106912:	e9 e0 f4 ff ff       	jmp    80105df7 <alltraps>
...
80106917:	6a 00                	push   $0x0
  pushl $169
80106919:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
8010691e:	e9 d4 f4 ff ff       	jmp    80105df7 <alltraps>
...
80106923:	6a 00                	push   $0x0
  pushl $170
80106925:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
8010692a:	e9 c8 f4 ff ff       	jmp    80105df7 <alltraps>
...
8010692f:	6a 00                	push   $0x0
  pushl $171
80106931:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80106936:	e9 bc f4 ff ff       	jmp    80105df7 <alltraps>
...
8010693b:	6a 00                	push   $0x0
  pushl $172
8010693d:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
80106942:	e9 b0 f4 ff ff       	jmp    80105df7 <alltraps>
...
80106947:	6a 00                	push   $0x0
  pushl $173
80106949:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
8010694e:	e9 a4 f4 ff ff       	jmp    80105df7 <alltraps>
...
80106953:	6a 00                	push   $0x0
  pushl $174
80106955:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
8010695a:	e9 98 f4 ff ff       	jmp    80105df7 <alltraps>
...
8010695f:	6a 00                	push   $0x0
  pushl $175
80106961:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80106966:	e9 8c f4 ff ff       	jmp    80105df7 <alltraps>
...
8010696b:	6a 00                	push   $0x0
  pushl $176
8010696d:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
80106972:	e9 80 f4 ff ff       	jmp    80105df7 <alltraps>
...
80106977:	6a 00                	push   $0x0
  pushl $177
80106979:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
8010697e:	e9 74 f4 ff ff       	jmp    80105df7 <alltraps>
...
80106983:	6a 00                	push   $0x0
  pushl $178
80106985:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
8010698a:	e9 68 f4 ff ff       	jmp    80105df7 <alltraps>
...
8010698f:	6a 00                	push   $0x0
  pushl $179
80106991:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80106996:	e9 5c f4 ff ff       	jmp    80105df7 <alltraps>
...
8010699b:	6a 00                	push   $0x0
  pushl $180
8010699d:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
801069a2:	e9 50 f4 ff ff       	jmp    80105df7 <alltraps>
...
801069a7:	6a 00                	push   $0x0
  pushl $181
801069a9:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
801069ae:	e9 44 f4 ff ff       	jmp    80105df7 <alltraps>
...
801069b3:	6a 00                	push   $0x0
  pushl $182
801069b5:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
801069ba:	e9 38 f4 ff ff       	jmp    80105df7 <alltraps>
...
801069bf:	6a 00                	push   $0x0
  pushl $183
801069c1:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
801069c6:	e9 2c f4 ff ff       	jmp    80105df7 <alltraps>
...
801069cb:	6a 00                	push   $0x0
  pushl $184
801069cd:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
801069d2:	e9 20 f4 ff ff       	jmp    80105df7 <alltraps>
...
801069d7:	6a 00                	push   $0x0
  pushl $185
801069d9:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
801069de:	e9 14 f4 ff ff       	jmp    80105df7 <alltraps>
...
801069e3:	6a 00                	push   $0x0
  pushl $186
801069e5:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
801069ea:	e9 08 f4 ff ff       	jmp    80105df7 <alltraps>
...
801069ef:	6a 00                	push   $0x0
  pushl $187
801069f1:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
801069f6:	e9 fc f3 ff ff       	jmp    80105df7 <alltraps>
...
801069fb:	6a 00                	push   $0x0
  pushl $188
801069fd:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
80106a02:	e9 f0 f3 ff ff       	jmp    80105df7 <alltraps>
...
80106a07:	6a 00                	push   $0x0
  pushl $189
80106a09:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
80106a0e:	e9 e4 f3 ff ff       	jmp    80105df7 <alltraps>
...
80106a13:	6a 00                	push   $0x0
  pushl $190
80106a15:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
80106a1a:	e9 d8 f3 ff ff       	jmp    80105df7 <alltraps>
...
80106a1f:	6a 00                	push   $0x0
  pushl $191
80106a21:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
80106a26:	e9 cc f3 ff ff       	jmp    80105df7 <alltraps>
...
80106a2b:	6a 00                	push   $0x0
  pushl $192
80106a2d:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
80106a32:	e9 c0 f3 ff ff       	jmp    80105df7 <alltraps>
...
80106a37:	6a 00                	push   $0x0
  pushl $193
80106a39:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
80106a3e:	e9 b4 f3 ff ff       	jmp    80105df7 <alltraps>
...
80106a43:	6a 00                	push   $0x0
  pushl $194
80106a45:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
80106a4a:	e9 a8 f3 ff ff       	jmp    80105df7 <alltraps>
...
80106a4f:	6a 00                	push   $0x0
  pushl $195
80106a51:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80106a56:	e9 9c f3 ff ff       	jmp    80105df7 <alltraps>
...
80106a5b:	6a 00                	push   $0x0
  pushl $196
80106a5d:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
80106a62:	e9 90 f3 ff ff       	jmp    80105df7 <alltraps>
...
80106a67:	6a 00                	push   $0x0
  pushl $197
80106a69:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
80106a6e:	e9 84 f3 ff ff       	jmp    80105df7 <alltraps>
...
80106a73:	6a 00                	push   $0x0
  pushl $198
80106a75:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80106a7a:	e9 78 f3 ff ff       	jmp    80105df7 <alltraps>
...
80106a7f:	6a 00                	push   $0x0
  pushl $199
80106a81:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80106a86:	e9 6c f3 ff ff       	jmp    80105df7 <alltraps>
...
80106a8b:	6a 00                	push   $0x0
  pushl $200
80106a8d:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
80106a92:	e9 60 f3 ff ff       	jmp    80105df7 <alltraps>
...
80106a97:	6a 00                	push   $0x0
  pushl $201
80106a99:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
80106a9e:	e9 54 f3 ff ff       	jmp    80105df7 <alltraps>
...
80106aa3:	6a 00                	push   $0x0
  pushl $202
80106aa5:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
80106aaa:	e9 48 f3 ff ff       	jmp    80105df7 <alltraps>
...
80106aaf:	6a 00                	push   $0x0
  pushl $203
80106ab1:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
80106ab6:	e9 3c f3 ff ff       	jmp    80105df7 <alltraps>
...
80106abb:	6a 00                	push   $0x0
  pushl $204
80106abd:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
80106ac2:	e9 30 f3 ff ff       	jmp    80105df7 <alltraps>
...
80106ac7:	6a 00                	push   $0x0
  pushl $205
80106ac9:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
80106ace:	e9 24 f3 ff ff       	jmp    80105df7 <alltraps>
...
80106ad3:	6a 00                	push   $0x0
  pushl $206
80106ad5:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
80106ada:	e9 18 f3 ff ff       	jmp    80105df7 <alltraps>
...
80106adf:	6a 00                	push   $0x0
  pushl $207
80106ae1:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
80106ae6:	e9 0c f3 ff ff       	jmp    80105df7 <alltraps>
...
80106aeb:	6a 00                	push   $0x0
  pushl $208
80106aed:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
80106af2:	e9 00 f3 ff ff       	jmp    80105df7 <alltraps>
...
80106af7:	6a 00                	push   $0x0
  pushl $209
80106af9:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
80106afe:	e9 f4 f2 ff ff       	jmp    80105df7 <alltraps>
...
80106b03:	6a 00                	push   $0x0
  pushl $210
80106b05:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
80106b0a:	e9 e8 f2 ff ff       	jmp    80105df7 <alltraps>
...
80106b0f:	6a 00                	push   $0x0
  pushl $211
80106b11:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
80106b16:	e9 dc f2 ff ff       	jmp    80105df7 <alltraps>
...
80106b1b:	6a 00                	push   $0x0
  pushl $212
80106b1d:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
80106b22:	e9 d0 f2 ff ff       	jmp    80105df7 <alltraps>
...
80106b27:	6a 00                	push   $0x0
  pushl $213
80106b29:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
80106b2e:	e9 c4 f2 ff ff       	jmp    80105df7 <alltraps>
...
80106b33:	6a 00                	push   $0x0
  pushl $214
80106b35:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
80106b3a:	e9 b8 f2 ff ff       	jmp    80105df7 <alltraps>
...
80106b3f:	6a 00                	push   $0x0
  pushl $215
80106b41:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80106b46:	e9 ac f2 ff ff       	jmp    80105df7 <alltraps>
...
80106b4b:	6a 00                	push   $0x0
  pushl $216
80106b4d:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
80106b52:	e9 a0 f2 ff ff       	jmp    80105df7 <alltraps>
...
80106b57:	6a 00                	push   $0x0
  pushl $217
80106b59:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
80106b5e:	e9 94 f2 ff ff       	jmp    80105df7 <alltraps>
...
80106b63:	6a 00                	push   $0x0
  pushl $218
80106b65:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80106b6a:	e9 88 f2 ff ff       	jmp    80105df7 <alltraps>
...
80106b6f:	6a 00                	push   $0x0
  pushl $219
80106b71:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80106b76:	e9 7c f2 ff ff       	jmp    80105df7 <alltraps>
...
80106b7b:	6a 00                	push   $0x0
  pushl $220
80106b7d:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
80106b82:	e9 70 f2 ff ff       	jmp    80105df7 <alltraps>
...
80106b87:	6a 00                	push   $0x0
  pushl $221
80106b89:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
80106b8e:	e9 64 f2 ff ff       	jmp    80105df7 <alltraps>
...
80106b93:	6a 00                	push   $0x0
  pushl $222
80106b95:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80106b9a:	e9 58 f2 ff ff       	jmp    80105df7 <alltraps>
...
80106b9f:	6a 00                	push   $0x0
  pushl $223
80106ba1:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80106ba6:	e9 4c f2 ff ff       	jmp    80105df7 <alltraps>
...
80106bab:	6a 00                	push   $0x0
  pushl $224
80106bad:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
80106bb2:	e9 40 f2 ff ff       	jmp    80105df7 <alltraps>
...
80106bb7:	6a 00                	push   $0x0
  pushl $225
80106bb9:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
80106bbe:	e9 34 f2 ff ff       	jmp    80105df7 <alltraps>
...
80106bc3:	6a 00                	push   $0x0
  pushl $226
80106bc5:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80106bca:	e9 28 f2 ff ff       	jmp    80105df7 <alltraps>
...
80106bcf:	6a 00                	push   $0x0
  pushl $227
80106bd1:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80106bd6:	e9 1c f2 ff ff       	jmp    80105df7 <alltraps>
...
80106bdb:	6a 00                	push   $0x0
  pushl $228
80106bdd:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
80106be2:	e9 10 f2 ff ff       	jmp    80105df7 <alltraps>
...
80106be7:	6a 00                	push   $0x0
  pushl $229
80106be9:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
80106bee:	e9 04 f2 ff ff       	jmp    80105df7 <alltraps>
...
80106bf3:	6a 00                	push   $0x0
  pushl $230
80106bf5:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
80106bfa:	e9 f8 f1 ff ff       	jmp    80105df7 <alltraps>
...
80106bff:	6a 00                	push   $0x0
  pushl $231
80106c01:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
80106c06:	e9 ec f1 ff ff       	jmp    80105df7 <alltraps>
...
80106c0b:	6a 00                	push   $0x0
  pushl $232
80106c0d:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
80106c12:	e9 e0 f1 ff ff       	jmp    80105df7 <alltraps>
...
80106c17:	6a 00                	push   $0x0
  pushl $233
80106c19:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
80106c1e:	e9 d4 f1 ff ff       	jmp    80105df7 <alltraps>
...
80106c23:	6a 00                	push   $0x0
  pushl $234
80106c25:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
80106c2a:	e9 c8 f1 ff ff       	jmp    80105df7 <alltraps>
...
80106c2f:	6a 00                	push   $0x0
  pushl $235
80106c31:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80106c36:	e9 bc f1 ff ff       	jmp    80105df7 <alltraps>
...
80106c3b:	6a 00                	push   $0x0
  pushl $236
80106c3d:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
80106c42:	e9 b0 f1 ff ff       	jmp    80105df7 <alltraps>
...
80106c47:	6a 00                	push   $0x0
  pushl $237
80106c49:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
80106c4e:	e9 a4 f1 ff ff       	jmp    80105df7 <alltraps>
...
80106c53:	6a 00                	push   $0x0
  pushl $238
80106c55:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80106c5a:	e9 98 f1 ff ff       	jmp    80105df7 <alltraps>
...
80106c5f:	6a 00                	push   $0x0
  pushl $239
80106c61:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80106c66:	e9 8c f1 ff ff       	jmp    80105df7 <alltraps>
...
80106c6b:	6a 00                	push   $0x0
  pushl $240
80106c6d:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
80106c72:	e9 80 f1 ff ff       	jmp    80105df7 <alltraps>
...
80106c77:	6a 00                	push   $0x0
  pushl $241
80106c79:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
80106c7e:	e9 74 f1 ff ff       	jmp    80105df7 <alltraps>
...
80106c83:	6a 00                	push   $0x0
  pushl $242
80106c85:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80106c8a:	e9 68 f1 ff ff       	jmp    80105df7 <alltraps>
...
80106c8f:	6a 00                	push   $0x0
  pushl $243
80106c91:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80106c96:	e9 5c f1 ff ff       	jmp    80105df7 <alltraps>
...
80106c9b:	6a 00                	push   $0x0
  pushl $244
80106c9d:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
80106ca2:	e9 50 f1 ff ff       	jmp    80105df7 <alltraps>
...
80106ca7:	6a 00                	push   $0x0
  pushl $245
80106ca9:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
80106cae:	e9 44 f1 ff ff       	jmp    80105df7 <alltraps>
...
80106cb3:	6a 00                	push   $0x0
  pushl $246
80106cb5:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80106cba:	e9 38 f1 ff ff       	jmp    80105df7 <alltraps>
...
80106cbf:	6a 00                	push   $0x0
  pushl $247
80106cc1:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80106cc6:	e9 2c f1 ff ff       	jmp    80105df7 <alltraps>
...
80106ccb:	6a 00                	push   $0x0
  pushl $248
80106ccd:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
80106cd2:	e9 20 f1 ff ff       	jmp    80105df7 <alltraps>
...
80106cd7:	6a 00                	push   $0x0
  pushl $249
80106cd9:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
80106cde:	e9 14 f1 ff ff       	jmp    80105df7 <alltraps>
...
80106ce3:	6a 00                	push   $0x0
  pushl $250
80106ce5:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80106cea:	e9 08 f1 ff ff       	jmp    80105df7 <alltraps>
...
80106cef:	6a 00                	push   $0x0
  pushl $251
80106cf1:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80106cf6:	e9 fc f0 ff ff       	jmp    80105df7 <alltraps>
...
80106cfb:	6a 00                	push   $0x0
  pushl $252
80106cfd:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
80106d02:	e9 f0 f0 ff ff       	jmp    80105df7 <alltraps>
...
80106d07:	6a 00                	push   $0x0
  pushl $253
80106d09:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
80106d0e:	e9 e4 f0 ff ff       	jmp    80105df7 <alltraps>
...
80106d13:	6a 00                	push   $0x0
  pushl $254
80106d15:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80106d1a:	e9 d8 f0 ff ff       	jmp    80105df7 <alltraps>
...
80106d1f:	6a 00                	push   $0x0
  pushl $255
80106d21:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80106d26:	e9 cc f0 ff ff       	jmp    80105df7 <alltraps>
...
80106d56:	8d 65 f4             	lea    -0xc(%ebp),%esp
  return &pgtab[PTX(va)];
80106d59:	c1 e8 0a             	shr    $0xa,%eax
80106d5c:	25 fc 0f 00 00       	and    $0xffc,%eax
80106d61:	01 d8                	add    %ebx,%eax
}
80106d63:	5b                   	pop    %ebx
80106d64:	5e                   	pop    %esi
80106d65:	5f                   	pop    %edi
...
80106d74:	e8 b7 b8 ff ff       	call   80102630 <kalloc>
80106d79:	89 c3                	mov    %eax,%ebx
...
80106d8a:	e8 51 dd ff ff       	call   80104ae0 <memset>
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
...
80106db4:	89 c7                	mov    %eax,%edi
  char *a, *last;
  pte_t *pte;

  a = (char*)PGROUNDDOWN((uint)va);
  last = (char*)PGROUNDDOWN(((uint)va) + size - 1);
80106db6:	8d 44 0a ff          	lea    -0x1(%edx,%ecx,1),%eax
{
80106dba:	56                   	push   %esi
  last = (char*)PGROUNDDOWN(((uint)va) + size - 1);
80106dbb:	25 00 f0 ff ff       	and    $0xfffff000,%eax
  a = (char*)PGROUNDDOWN((uint)va);
80106dc0:	89 d6                	mov    %edx,%esi
{
80106dc2:	53                   	push   %ebx
  a = (char*)PGROUNDDOWN((uint)va);
80106dc3:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
{
80106dc9:	83 ec 1c             	sub    $0x1c,%esp
  last = (char*)PGROUNDDOWN(((uint)va) + size - 1);
80106dcc:	89 45 e0             	mov    %eax,-0x20(%ebp)
80106dcf:	8b 45 08             	mov    0x8(%ebp),%eax
80106dd2:	29 f0                	sub    %esi,%eax
80106dd4:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106dd7:	eb 1f                	jmp    80106df8 <mappages+0x48>
...
80106de3:	75 45                	jne    80106e2a <mappages+0x7a>
      panic("remap");
    *pte = pa | perm | PTE_P;
80106de5:	0b 5d 0c             	or     0xc(%ebp),%ebx
80106de8:	83 cb 01             	or     $0x1,%ebx
80106deb:	89 18                	mov    %ebx,(%eax)
    if(a == last)
80106ded:	3b 75 e0             	cmp    -0x20(%ebp),%esi
80106df0:	74 2e                	je     80106e20 <mappages+0x70>
      break;
    a += PGSIZE;
...
80106df8:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    if((pte = walkpgdir(pgdir, a, 1)) == 0)
80106dfb:	b9 01 00 00 00       	mov    $0x1,%ecx
80106e00:	89 f2                	mov    %esi,%edx
80106e02:	8d 1c 06             	lea    (%esi,%eax,1),%ebx
80106e05:	89 f8                	mov    %edi,%eax
80106e07:	e8 24 ff ff ff       	call   80106d30 <walkpgdir>
80106e0c:	85 c0                	test   %eax,%eax
80106e0e:	75 d0                	jne    80106de0 <mappages+0x30>
    pa += PGSIZE;
  }
  return 0;
}
...
80106e2d:	68 d4 7f 10 80       	push   $0x80107fd4
...
80106e48:	89 d3                	mov    %edx,%ebx
  ...
  a = PGROUNDUP(newsz);
80106e4a:	8d 91 ff 0f 00 00    	lea    0xfff(%ecx),%edx
80106e50:	81 e2 00 f0 ff ff    	and    $0xfffff000,%edx
deallocuvm(pde_t *pgdir, uint oldsz, uint newsz)
80106e56:	83 ec 1c             	sub    $0x1c,%esp
80106e59:	89 4d e0             	mov    %ecx,-0x20(%ebp)
  for(; a  < oldsz; a += PGSIZE){
80106e5c:	39 da                	cmp    %ebx,%edx
80106e5e:	73 5b                	jae    80106ebb <deallocuvm.part.0+0x7b>
80106e60:	89 5d e4             	mov    %ebx,-0x1c(%ebp)
80106e63:	89 d7                	mov    %edx,%edi
80106e65:	eb 14                	jmp    80106e7b <deallocuvm.part.0+0x3b>
80106e67:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80106e6e:	66 90                	xchg   %ax,%ax
80106e70:	81 c7 00 10 00 00    	add    $0x1000,%edi
80106e76:	39 7d e4             	cmp    %edi,-0x1c(%ebp)
80106e79:	76 40                	jbe    80106ebb <deallocuvm.part.0+0x7b>
    pte = walkpgdir(pgdir, (char*)a, 0);
80106e7b:	31 c9                	xor    %ecx,%ecx
80106e7d:	89 fa                	mov    %edi,%edx
80106e7f:	89 f0                	mov    %esi,%eax
80106e81:	e8 aa fe ff ff       	call   80106d30 <walkpgdir>
80106e86:	89 c3                	mov    %eax,%ebx
    if(!pte)
80106e88:	85 c0                	test   %eax,%eax
80106e8a:	74 44                	je     80106ed0 <deallocuvm.part.0+0x90>
      a = PGADDR(PDX(a) + 1, 0, 0) - PGSIZE;
    else if((*pte & PTE_P) != 0){
80106e8c:	8b 00                	mov    (%eax),%eax
80106e8e:	a8 01                	test   $0x1,%al
80106e90:	74 de                	je     80106e70 <deallocuvm.part.0+0x30>
      pa = PTE_ADDR(*pte);
      if(pa == 0)
80106e92:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80106e97:	74 47                	je     80106ee0 <deallocuvm.part.0+0xa0>
        panic("kfree");
      char *v = P2V(pa);
      kfree(v);
80106e99:	83 ec 0c             	sub    $0xc,%esp
      char *v = P2V(pa);
80106e9c:	05 00 00 00 80       	add    $0x80000000,%eax
80106ea1:	81 c7 00 10 00 00    	add    $0x1000,%edi
      kfree(v);
80106ea7:	50                   	push   %eax
80106ea8:	e8 c3 b5 ff ff       	call   80102470 <kfree>
      *pte = 0;
80106ead:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
80106eb3:	83 c4 10             	add    $0x10,%esp
  for(; a  < oldsz; a += PGSIZE){
80106eb6:	39 7d e4             	cmp    %edi,-0x1c(%ebp)
80106eb9:	77 c0                	ja     80106e7b <deallocuvm.part.0+0x3b>
    }
  }
  return newsz;
}
80106ebb:	8b 45 e0             	mov    -0x20(%ebp),%eax
...
80106ed2:	81 e2 00 00 c0 ff    	and    $0xffc00000,%edx
80106ed8:	8d ba 00 00 40 00    	lea    0x400000(%edx),%edi
80106ede:	eb 96                	jmp    80106e76 <deallocuvm.part.0+0x36>
        panic("kfree");
80106ee0:	83 ec 0c             	sub    $0xc,%esp
80106ee3:	68 e6 78 10 80       	push   $0x801078e6
...
80106ef7:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
80106efa:	e8 51 ca ff ff       	call   80103950 <cpuid>
  pd[0] = size-1;
80106eff:	ba 2f 00 00 00       	mov    $0x2f,%edx
80106f04:	69 c0 b0 00 00 00    	imul   $0xb0,%eax,%eax
80106f0a:	66 89 55 f2          	mov    %dx,-0xe(%ebp)
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
80106f0e:	c7 80 58 42 11 80 ff 	movl   $0xffff,-0x7feebda8(%eax)
80106f15:	ff 00 00 
80106f18:	c7 80 5c 42 11 80 00 	movl   $0xcf9a00,-0x7feebda4(%eax)
80106f1f:	9a cf 00 
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
80106f22:	c7 80 60 42 11 80 ff 	movl   $0xffff,-0x7feebda0(%eax)
80106f29:	ff 00 00 
80106f2c:	c7 80 64 42 11 80 00 	movl   $0xcf9200,-0x7feebd9c(%eax)
80106f33:	92 cf 00 
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
80106f36:	c7 80 68 42 11 80 ff 	movl   $0xffff,-0x7feebd98(%eax)
80106f3d:	ff 00 00 
80106f40:	c7 80 6c 42 11 80 00 	movl   $0xcffa00,-0x7feebd94(%eax)
80106f47:	fa cf 00 
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
80106f4a:	c7 80 70 42 11 80 ff 	movl   $0xffff,-0x7feebd90(%eax)
80106f51:	ff 00 00 
80106f54:	c7 80 74 42 11 80 00 	movl   $0xcff200,-0x7feebd8c(%eax)
80106f5b:	f2 cf 00 
  lgdt(c->gdt, sizeof(c->gdt));
80106f5e:	05 50 42 11 80       	add    $0x80114250,%eax
  pd[1] = (uint)p;
...
80106f84:	a1 04 76 11 80       	mov    0x80117604,%eax
80106f89:	05 00 00 00 80       	add    $0x80000000,%eax
}
...
80106fb2:	0f 84 cb 00 00 00    	je     80107083 <switchuvm+0xe3>
  if(p->kstack == 0)
80106fb8:	8b 46 08             	mov    0x8(%esi),%eax
80106fbb:	85 c0                	test   %eax,%eax
80106fbd:	0f 84 da 00 00 00    	je     8010709d <switchuvm+0xfd>
  if(p->pgdir == 0)
80106fc3:	8b 46 04             	mov    0x4(%esi),%eax
80106fc6:	85 c0                	test   %eax,%eax
80106fc8:	0f 84 c2 00 00 00    	je     80107090 <switchuvm+0xf0>
  pushcli();
80106fce:	e8 fd d8 ff ff       	call   801048d0 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
80106fd3:	e8 08 c9 ff ff       	call   801038e0 <mycpu>
80106fd8:	89 c3                	mov    %eax,%ebx
80106fda:	e8 01 c9 ff ff       	call   801038e0 <mycpu>
80106fdf:	89 c7                	mov    %eax,%edi
80106fe1:	e8 fa c8 ff ff       	call   801038e0 <mycpu>
80106fe6:	83 c7 08             	add    $0x8,%edi
80106fe9:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106fec:	e8 ef c8 ff ff       	call   801038e0 <mycpu>
80106ff1:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
80106ff4:	ba 67 00 00 00       	mov    $0x67,%edx
80106ff9:	66 89 bb 9a 00 00 00 	mov    %di,0x9a(%ebx)
80107000:	83 c0 08             	add    $0x8,%eax
80107003:	66 89 93 98 00 00 00 	mov    %dx,0x98(%ebx)
  mycpu()->ts.iomb = (ushort) 0xFFFF;
8010700a:	bf ff ff ff ff       	mov    $0xffffffff,%edi
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
8010700f:	83 c1 08             	add    $0x8,%ecx
80107012:	c1 e8 18             	shr    $0x18,%eax
80107015:	c1 e9 10             	shr    $0x10,%ecx
80107018:	88 83 9f 00 00 00    	mov    %al,0x9f(%ebx)
8010701e:	88 8b 9c 00 00 00    	mov    %cl,0x9c(%ebx)
80107024:	b9 99 40 00 00       	mov    $0x4099,%ecx
80107029:	66 89 8b 9d 00 00 00 	mov    %cx,0x9d(%ebx)
  mycpu()->ts.ss0 = SEG_KDATA << 3;
80107030:	bb 10 00 00 00       	mov    $0x10,%ebx
  mycpu()->gdt[SEG_TSS].s = 0;
80107035:	e8 a6 c8 ff ff       	call   801038e0 <mycpu>
8010703a:	80 a0 9d 00 00 00 ef 	andb   $0xef,0x9d(%eax)
  mycpu()->ts.ss0 = SEG_KDATA << 3;
80107041:	e8 9a c8 ff ff       	call   801038e0 <mycpu>
80107046:	66 89 58 10          	mov    %bx,0x10(%eax)
  mycpu()->ts.esp0 = (uint)p->kstack + KSTACKSIZE;
8010704a:	8b 5e 08             	mov    0x8(%esi),%ebx
8010704d:	81 c3 00 10 00 00    	add    $0x1000,%ebx
80107053:	e8 88 c8 ff ff       	call   801038e0 <mycpu>
80107058:	89 58 0c             	mov    %ebx,0xc(%eax)
  mycpu()->ts.iomb = (ushort) 0xFFFF;
8010705b:	e8 80 c8 ff ff       	call   801038e0 <mycpu>
80107060:	66 89 78 6e          	mov    %di,0x6e(%eax)
  asm volatile("ltr %0" : : "r" (sel));
80107064:	b8 28 00 00 00       	mov    $0x28,%eax
80107069:	0f 00 d8             	ltr    %ax
  lcr3(V2P(p->pgdir));  // switch to process's address space
8010706c:	8b 46 04             	mov    0x4(%esi),%eax
8010706f:	05 00 00 00 80       	add    $0x80000000,%eax
  asm volatile("movl %0,%%cr3" : : "r" (val));
80107074:	0f 22 d8             	mov    %eax,%cr3
}
...
8010707d:	5d                   	pop    %ebp
  popcli();
8010707e:	e9 9d d8 ff ff       	jmp    80104920 <popcli>
    panic("switchuvm: no process");
80107083:	83 ec 0c             	sub    $0xc,%esp
80107086:	68 da 7f 10 80       	push   $0x80107fda
8010708b:	e8 00 93 ff ff       	call   80100390 <panic>
    panic("switchuvm: no pgdir");
80107090:	83 ec 0c             	sub    $0xc,%esp
80107093:	68 05 80 10 80       	push   $0x80108005
80107098:	e8 f3 92 ff ff       	call   80100390 <panic>
    panic("switchuvm: no kstack");
8010709d:	83 ec 0c             	sub    $0xc,%esp
801070a0:	68 f0 7f 10 80       	push   $0x80107ff0
801070a5:	e8 e6 92 ff ff       	call   80100390 <panic>
...
801070c0:	8b 75 10             	mov    0x10(%ebp),%esi
801070c3:	8b 7d 08             	mov    0x8(%ebp),%edi
801070c6:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  if(sz >= PGSIZE)
801070c9:	81 fe ff 0f 00 00    	cmp    $0xfff,%esi
801070cf:	77 4b                	ja     8010711c <inituvm+0x6c>
  mem = kalloc();
801070d1:	e8 5a b5 ff ff       	call   80102630 <kalloc>
  memset(mem, 0, PGSIZE);
801070d6:	83 ec 04             	sub    $0x4,%esp
801070d9:	68 00 10 00 00       	push   $0x1000
  mem = kalloc();
801070de:	89 c3                	mov    %eax,%ebx
  memset(mem, 0, PGSIZE);
801070e0:	6a 00                	push   $0x0
801070e2:	50                   	push   %eax
801070e3:	e8 f8 d9 ff ff       	call   80104ae0 <memset>
  mappages(pgdir, 0, PGSIZE, V2P(mem), PTE_W|PTE_U);
801070e8:	58                   	pop    %eax
801070e9:	8d 83 00 00 00 80    	lea    -0x80000000(%ebx),%eax
801070ef:	5a                   	pop    %edx
801070f0:	6a 06                	push   $0x6
801070f2:	b9 00 10 00 00       	mov    $0x1000,%ecx
801070f7:	31 d2                	xor    %edx,%edx
801070f9:	50                   	push   %eax
801070fa:	89 f8                	mov    %edi,%eax
801070fc:	e8 af fc ff ff       	call   80106db0 <mappages>
  memmove(mem, init, sz);
80107101:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80107104:	89 75 10             	mov    %esi,0x10(%ebp)
80107107:	83 c4 10             	add    $0x10,%esp
8010710a:	89 5d 08             	mov    %ebx,0x8(%ebp)
8010710d:	89 45 0c             	mov    %eax,0xc(%ebp)
}
...
80107116:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80107117:	e9 64 da ff ff       	jmp    80104b80 <memmove>
    panic("inituvm: more than a page");
8010711c:	83 ec 0c             	sub    $0xc,%esp
8010711f:	68 19 80 10 80       	push   $0x80108019
...
80107140:	8b 75 18             	mov    0x18(%ebp),%esi
  if((uint) addr % PGSIZE != 0)
80107143:	a9 ff 0f 00 00       	test   $0xfff,%eax
80107148:	0f 85 99 00 00 00    	jne    801071e7 <loaduvm+0xb7>
  for(i = 0; i < sz; i += PGSIZE){
8010714e:	01 f0                	add    %esi,%eax
80107150:	89 f3                	mov    %esi,%ebx
80107152:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if(readi(ip, P2V(pa), offset+i, n) != n)
80107155:	8b 45 14             	mov    0x14(%ebp),%eax
80107158:	01 f0                	add    %esi,%eax
8010715a:	89 45 e0             	mov    %eax,-0x20(%ebp)
  for(i = 0; i < sz; i += PGSIZE){
8010715d:	85 f6                	test   %esi,%esi
8010715f:	75 15                	jne    80107176 <loaduvm+0x46>
80107161:	eb 6d                	jmp    801071d0 <loaduvm+0xa0>
80107163:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80107167:	90                   	nop
80107168:	81 eb 00 10 00 00    	sub    $0x1000,%ebx
8010716e:	89 f0                	mov    %esi,%eax
80107170:	29 d8                	sub    %ebx,%eax
80107172:	39 c6                	cmp    %eax,%esi
80107174:	76 5a                	jbe    801071d0 <loaduvm+0xa0>
    if((pte = walkpgdir(pgdir, addr+i, 0)) == 0)
80107176:	8b 55 e4             	mov    -0x1c(%ebp),%edx
80107179:	8b 45 08             	mov    0x8(%ebp),%eax
8010717c:	31 c9                	xor    %ecx,%ecx
8010717e:	29 da                	sub    %ebx,%edx
80107180:	e8 ab fb ff ff       	call   80106d30 <walkpgdir>
80107185:	85 c0                	test   %eax,%eax
80107187:	74 51                	je     801071da <loaduvm+0xaa>
    pa = PTE_ADDR(*pte);
...
801071ae:	e8 ad a8 ff ff       	call   80101a60 <readi>
801071b3:	83 c4 10             	add    $0x10,%esp
801071b6:	39 f8                	cmp    %edi,%eax
801071b8:	74 ae                	je     80107168 <loaduvm+0x38>
}
...
801071dd:	68 33 80 10 80       	push   $0x80108033
801071e2:	e8 a9 91 ff ff       	call   80100390 <panic>
    panic("loaduvm: addr must be page aligned");
801071e7:	83 ec 0c             	sub    $0xc,%esp
801071ea:	68 d4 80 10 80       	push   $0x801080d4
801071ef:	e8 9c 91 ff ff       	call   80100390 <panic>
801071f4:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
...
8010720a:	83 ec 1c             	sub    $0x1c,%esp
  if(newsz >= KERNBASE)
8010720d:	8b 45 10             	mov    0x10(%ebp),%eax
{
80107210:	8b 7d 08             	mov    0x8(%ebp),%edi
  if(newsz >= KERNBASE)
80107213:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80107216:	85 c0                	test   %eax,%eax
80107218:	0f 88 b2 00 00 00    	js     801072d0 <allocuvm+0xd0>
  if(newsz < oldsz)
8010721e:	3b 45 0c             	cmp    0xc(%ebp),%eax
    return oldsz;
80107221:	8b 45 0c             	mov    0xc(%ebp),%eax
  if(newsz < oldsz)
80107224:	0f 82 96 00 00 00    	jb     801072c0 <allocuvm+0xc0>
  a = PGROUNDUP(oldsz);
8010722a:	8d b0 ff 0f 00 00    	lea    0xfff(%eax),%esi
80107230:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
  for(; a < newsz; a += PGSIZE){
80107236:	39 75 10             	cmp    %esi,0x10(%ebp)
80107239:	77 40                	ja     8010727b <allocuvm+0x7b>
8010723b:	e9 83 00 00 00       	jmp    801072c3 <allocuvm+0xc3>
    memset(mem, 0, PGSIZE);
80107240:	83 ec 04             	sub    $0x4,%esp
80107243:	68 00 10 00 00       	push   $0x1000
80107248:	6a 00                	push   $0x0
8010724a:	50                   	push   %eax
8010724b:	e8 90 d8 ff ff       	call   80104ae0 <memset>
...
80107264:	e8 47 fb ff ff       	call   80106db0 <mappages>
...
80107279:	76 48                	jbe    801072c3 <allocuvm+0xc3>
    mem = kalloc();
8010727b:	e8 b0 b3 ff ff       	call   80102630 <kalloc>
...
80107289:	68 51 80 10 80       	push   $0x80108051
8010728e:	e8 1d 94 ff ff       	call   801006b0 <cprintf>
  if(newsz >= oldsz)
...
801072a5:	e8 96 fb ff ff       	call   80106e40 <deallocuvm.part.0>
      return 0;
...
801072eb:	68 69 80 10 80       	push   $0x80108069
801072f0:	e8 bb 93 ff ff       	call   801006b0 <cprintf>
  if(newsz >= oldsz)
...
80107307:	e8 34 fb ff ff       	call   80106e40 <deallocuvm.part.0>
      kfree(mem);
8010730c:	83 ec 0c             	sub    $0xc,%esp
8010730f:	53                   	push   %ebx
80107310:	e8 5b b1 ff ff       	call   80102470 <kfree>
      return 0;
...
80107337:	8b 55 0c             	mov    0xc(%ebp),%edx
8010733a:	8b 4d 10             	mov    0x10(%ebp),%ecx
8010733d:	8b 45 08             	mov    0x8(%ebp),%eax
  if(newsz >= oldsz)
80107340:	39 d1                	cmp    %edx,%ecx
80107342:	73 0c                	jae    80107350 <deallocuvm+0x20>
}
80107344:	5d                   	pop    %ebp
80107345:	e9 f6 fa ff ff       	jmp    80106e40 <deallocuvm.part.0>
...
80107372:	74 55                	je     801073c9 <freevm+0x69>
  if(newsz >= oldsz)
80107374:	31 c9                	xor    %ecx,%ecx
80107376:	ba 00 00 00 80       	mov    $0x80000000,%edx
8010737b:	89 f0                	mov    %esi,%eax
8010737d:	89 f3                	mov    %esi,%ebx
8010737f:	e8 bc fa ff ff       	call   80106e40 <deallocuvm.part.0>
    panic("freevm: no pgdir");
  deallocuvm(pgdir, KERNBASE, 0);
  for(i = 0; i < NPDENTRIES; i++){
80107384:	8d be 00 10 00 00    	lea    0x1000(%esi),%edi
8010738a:	eb 0b                	jmp    80107397 <freevm+0x37>
...
801073ae:	e8 bd b0 ff ff       	call   80102470 <kfree>
...
801073c3:	5d                   	pop    %ebp
  kfree((char*)pgdir);
801073c4:	e9 a7 b0 ff ff       	jmp    80102470 <kfree>
    panic("freevm: no pgdir");
801073c9:	83 ec 0c             	sub    $0xc,%esp
801073cc:	68 85 80 10 80       	push   $0x80108085
...
801073e7:	56                   	push   %esi
801073e8:	53                   	push   %ebx
  if((pgdir = (pde_t*)kalloc()) == 0)
801073e9:	e8 42 b2 ff ff       	call   80102630 <kalloc>
801073ee:	89 c6                	mov    %eax,%esi
801073f0:	85 c0                	test   %eax,%eax
801073f2:	74 42                	je     80107436 <setupkvm+0x56>
  memset(pgdir, 0, PGSIZE);
801073f4:	83 ec 04             	sub    $0x4,%esp
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
801073f7:	bb a0 b4 10 80       	mov    $0x8010b4a0,%ebx
  memset(pgdir, 0, PGSIZE);
801073fc:	68 00 10 00 00       	push   $0x1000
80107401:	6a 00                	push   $0x0
80107403:	50                   	push   %eax
80107404:	e8 d7 d6 ff ff       	call   80104ae0 <memset>
80107409:	83 c4 10             	add    $0x10,%esp
                (uint)k->phys_start, k->perm) < 0) {
8010740c:	8b 43 04             	mov    0x4(%ebx),%eax
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start,
8010740f:	83 ec 08             	sub    $0x8,%esp
80107412:	8b 4b 08             	mov    0x8(%ebx),%ecx
80107415:	ff 73 0c             	pushl  0xc(%ebx)
80107418:	8b 13                	mov    (%ebx),%edx
8010741a:	50                   	push   %eax
8010741b:	29 c1                	sub    %eax,%ecx
8010741d:	89 f0                	mov    %esi,%eax
8010741f:	e8 8c f9 ff ff       	call   80106db0 <mappages>
80107424:	83 c4 10             	add    $0x10,%esp
80107427:	85 c0                	test   %eax,%eax
80107429:	78 15                	js     80107440 <setupkvm+0x60>
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
8010742b:	83 c3 10             	add    $0x10,%ebx
8010742e:	81 fb e0 b4 10 80    	cmp    $0x8010b4e0,%ebx
80107434:	75 d6                	jne    8010740c <setupkvm+0x2c>
}
80107436:	8d 65 f8             	lea    -0x8(%ebp),%esp
...
80107467:	83 ec 08             	sub    $0x8,%esp
  kpgdir = setupkvm();
8010746a:	e8 71 ff ff ff       	call   801073e0 <setupkvm>
8010746f:	a3 04 76 11 80       	mov    %eax,0x80117604
  lcr3(V2P(kpgdir));   // switch to the kernel page table
80107474:	05 00 00 00 80       	add    $0x80000000,%eax
...
80107492:	e8 99 f8 ff ff       	call   80106d30 <walkpgdir>
  if(pte == 0)
80107497:	85 c0                	test   %eax,%eax
80107499:	74 05                	je     801074a0 <clearpteu+0x20>
    panic("clearpteu");
  *pte &= ~PTE_U;
8010749b:	83 20 fb             	andl   $0xfffffffb,(%eax)
}
8010749e:	c9                   	leave  
8010749f:	c3                   	ret    
    panic("clearpteu");
801074a0:	83 ec 0c             	sub    $0xc,%esp
801074a3:	68 96 80 10 80       	push   $0x80108096
801074a8:	e8 e3 8e ff ff       	call   80100390 <panic>
...
801074ba:	83 ec 1c             	sub    $0x1c,%esp
  ...
  if((d = setupkvm()) == 0)
801074bd:	e8 1e ff ff ff       	call   801073e0 <setupkvm>
801074c2:	89 45 e0             	mov    %eax,-0x20(%ebp)
801074c5:	85 c0                	test   %eax,%eax
801074c7:	0f 84 9b 00 00 00    	je     80107568 <copyuvm+0xb8>
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
801074cd:	8b 4d 0c             	mov    0xc(%ebp),%ecx
801074d0:	85 c9                	test   %ecx,%ecx
801074d2:	0f 84 90 00 00 00    	je     80107568 <copyuvm+0xb8>
801074d8:	31 f6                	xor    %esi,%esi
801074da:	eb 46                	jmp    80107522 <copyuvm+0x72>
...
80107527:	89 f2                	mov    %esi,%edx
80107529:	e8 02 f8 ff ff       	call   80106d30 <walkpgdir>
...
80107536:	74 4e                	je     80107586 <copyuvm+0xd6>
    pa = PTE_ADDR(*pte);
80107538:	89 c7                	mov    %eax,%edi
    flags = PTE_FLAGS(*pte);
8010753a:	25 ff 0f 00 00       	and    $0xfff,%eax
8010753f:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    pa = PTE_ADDR(*pte);
80107542:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
    if((mem = kalloc()) == 0)
80107548:	e8 e3 b0 ff ff       	call   80102630 <kalloc>
8010754d:	89 c3                	mov    %eax,%ebx
...
80107559:	e8 02 fe ff ff       	call   80107360 <freevm>
  return 0;
8010755e:	c7 45 e0 00 00 00 00 	movl   $0x0,-0x20(%ebp)
...
801075a9:	83 ec 08             	sub    $0x8,%esp
  pte = walkpgdir(pgdir, uva, 0);
801075ac:	8b 55 0c             	mov    0xc(%ebp),%edx
801075af:	8b 45 08             	mov    0x8(%ebp),%eax
801075b2:	e8 79 f7 ff ff       	call   80106d30 <walkpgdir>
  if((*pte & PTE_P) == 0)
801075b7:	8b 00                	mov    (%eax),%eax
    return 0;
  if((*pte & PTE_U) == 0)
    return 0;
...
801075b9:	c9                   	leave  
  if((*pte & PTE_U) == 0)
801075ba:	89 c2                	mov    %eax,%edx
  return (char*)P2V(PTE_ADDR(*pte));
801075bc:	25 00 f0 ff ff       	and    $0xfffff000,%eax
  if((*pte & PTE_U) == 0)
801075c1:	83 e2 05             	and    $0x5,%edx
  return (char*)P2V(PTE_ADDR(*pte));
801075c4:	05 00 00 00 80       	add    $0x80000000,%eax
801075c9:	83 fa 05             	cmp    $0x5,%edx
801075cc:	ba 00 00 00 00       	mov    $0x0,%edx
801075d1:	0f 45 c2             	cmovne %edx,%eax
}
801075d4:	c3                   	ret    
...
801075ed:	8b 75 14             	mov    0x14(%ebp),%esi
801075f0:	8b 55 0c             	mov    0xc(%ebp),%edx
  ...
  buf = (char*)p;
  while(len > 0){
801075f3:	85 f6                	test   %esi,%esi
801075f5:	75 3c                	jne    80107633 <copyout+0x53>
801075f7:	eb 67                	jmp    80107660 <copyout+0x80>
801075f9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    ...
    if(pa0 == 0)
      return -1;
    n = PGSIZE - (va - va0);
80107600:	8b 55 0c             	mov    0xc(%ebp),%edx
80107603:	89 fb                	mov    %edi,%ebx
80107605:	29 d3                	sub    %edx,%ebx
80107607:	81 c3 00 10 00 00    	add    $0x1000,%ebx
    if(n > len)
8010760d:	39 f3                	cmp    %esi,%ebx
8010760f:	0f 47 de             	cmova  %esi,%ebx
      n = len;
    memmove(pa0 + (va - va0), buf, n);
80107612:	29 fa                	sub    %edi,%edx
80107614:	83 ec 04             	sub    $0x4,%esp
80107617:	01 c2                	add    %eax,%edx
80107619:	53                   	push   %ebx
8010761a:	ff 75 10             	pushl  0x10(%ebp)
8010761d:	52                   	push   %edx
8010761e:	e8 5d d5 ff ff       	call   80104b80 <memmove>
    len -= n;
    buf += n;
80107623:	01 5d 10             	add    %ebx,0x10(%ebp)
    va = va0 + PGSIZE;
80107626:	8d 97 00 10 00 00    	lea    0x1000(%edi),%edx
  while(len > 0){
8010762c:	83 c4 10             	add    $0x10,%esp
8010762f:	29 de                	sub    %ebx,%esi
80107631:	74 2d                	je     80107660 <copyout+0x80>
    va0 = (uint)PGROUNDDOWN(va);
80107633:	89 d7                	mov    %edx,%edi
    pa0 = uva2ka(pgdir, (char*)va0);
80107635:	83 ec 08             	sub    $0x8,%esp
    va0 = (uint)PGROUNDDOWN(va);
80107638:	89 55 0c             	mov    %edx,0xc(%ebp)
8010763b:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
    pa0 = uva2ka(pgdir, (char*)va0);
80107641:	57                   	push   %edi
80107642:	ff 75 08             	pushl  0x8(%ebp)
80107645:	e8 56 ff ff ff       	call   801075a0 <uva2ka>
    if(pa0 == 0)
8010764a:	83 c4 10             	add    $0x10,%esp
8010764d:	85 c0                	test   %eax,%eax
8010764f:	75 af                	jne    80107600 <copyout+0x20>
  }
  return 0;
}
80107651:	8d 65 f4             	lea    -0xc(%ebp),%esp
      return -1;
80107654:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
}
80107659:	5b                   	pop    %ebx
8010765a:	5e                   	pop    %esi
8010765b:	5f                   	pop    %edi
