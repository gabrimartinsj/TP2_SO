...
int main(void){
   ...
   e:	83 ec 04             	sub    $0x4,%esp
    getpid();
  11:	e8 1c 03 00 00       	call   332 <getpid>

    trace(1);
  16:	83 ec 0c             	sub    $0xc,%esp
  19:	6a 01                	push   $0x1
  1b:	e8 32 03 00 00       	call   352 <trace>
    getpid();
  20:	e8 0d 03 00 00       	call   332 <getpid>

    trace(0);
  25:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  2c:	e8 21 03 00 00       	call   352 <trace>
    getpid();
  31:	e8 fc 02 00 00       	call   332 <getpid>
    
    trace(1);
  36:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  3d:	e8 10 03 00 00       	call   352 <trace>
    uptime();
  42:	e8 03 03 00 00       	call   34a <uptime>
    wait();
  47:	e8 6e 02 00 00       	call   2ba <wait>
    getpid();
  4c:	e8 e1 02 00 00       	call   332 <getpid>

    trace(0);
  51:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  58:	e8 f5 02 00 00       	call   352 <trace>
    getpid();
  5d:	e8 d0 02 00 00       	call   332 <getpid>
