...
int main(void){
  ...
  12:	83 ec 04             	sub    $0x4,%esp
    getpid();
  15:	e8 39 03 00 00       	call   353 <getpid>

    trace(1);
  1a:	83 ec 0c             	sub    $0xc,%esp
  1d:	6a 01                	push   $0x1
  1f:	e8 4f 03 00 00       	call   373 <trace>
    getpid();
  24:	e8 2a 03 00 00       	call   353 <getpid>

    trace(0);
  29:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  30:	e8 3e 03 00 00       	call   373 <trace>
    getpid();
  35:	e8 19 03 00 00       	call   353 <getpid>
    
    trace(1);
  3a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  41:	e8 2d 03 00 00       	call   373 <trace>
    uptime();
  46:	e8 20 03 00 00       	call   36b <uptime>
    wait();
  4b:	e8 8b 02 00 00       	call   2db <wait>
    getpid();
  50:	e8 fe 02 00 00       	call   353 <getpid>

    trace(0);
  55:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  5c:	e8 12 03 00 00       	call   373 <trace>
    getpid();
  61:	e8 ed 02 00 00       	call   353 <getpid>
